...
function setVoiceOutput(v){voiceOutput=!!v;localStorage.setItem("nanako_voice_output",voiceOutput?"true":"false");updateVoiceOutputUi();console.log(`[Nanako Omni] Voice output ${voiceOutput?"ON":"OFF"}`)}
