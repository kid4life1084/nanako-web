...
async function loadProductionBodyAnimations(){
  ...
  bodyAnimationsLoading=(async()=>{
    const result=await window.nanako3DRenderer.loadBodyAnimations({
      idle:"./static/animations/nanako_idle_default.fbx?v=12.0.63",
    ...
    console.log("[Nanako 3D] Step 2.29 body animations ready: animated idle neutral, angry, thinking, clapping");
    return true;
...
const CLIENT_BUILD="12.0.63",RELEASE_VERSION="2.29.1",API="https://nanako-web-pokbkohedy.ap-southeast-1.fcapp.run",CHAT=`${API}/api/chat`,VISION_IDENTIFY=`${API}/api/vision/identify`,RESET=`${API}/api/reset`,STARTUP_GREETING=`${API}/api/startup-greeting`,REALTIME_ENRICH=`${API}/api/realtime/enrich`;
const NANAKO_OUTFIT_MODELS=Object.freeze({
  neutral:"./static/models/nanako_sweater_jeans.vrm?v=12.0.63",
  sports:"./static/models/nanako_sports.vrm?v=12.0.63",
  casual:"./static/models/nanako_casual.vrm?v=12.0.63",
  ...
  elegant:"./static/models/nanako_elegant.vrm?v=12.0.63"
});
...
function revealInteractionSurface(){interactionStarted=true;document.body.classList.remove("preinteraction");document.documentElement.classList.remove("splash-active");lastHumanActivityAt=Date.now();idleQuestionDueAt=lastHumanActivityAt+randomIdleQuestionDelayMs();startIdleQuestionWatchdog();scheduleIdleQuestion();}
