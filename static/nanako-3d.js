...
`)}const qp={1:"Linear",2:"Reinhard",3:"Cineon",4:"ACESFilmic",6:"AgX",7:"Neutral",5:"Custom"};function Yp(i,e){const t=qp[e];return t===void 0?(ye("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const rs=new C;function Kp(){Ye.getLuminanceCoefficients(rs);const i=rs.x.toFixed(4),e=rs.y.toFixed(4),t=rs.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`)+`
`+m);const R=E+p+a,M=E+m+o,T=Ml(r,r.VERTEX_SHADER,R),y=Ml(r,r.FRAGMENT_SHADER,M);r.attachShader(v,T),r.attachShader(v,y),t.index0AttributeName!==void 0?r.bindAttribLocation(v,0,t.index0AttributeName):t.hasPositionAttribute===!0&&r.bindAttribLocation(v,0,"position"),r.linkProgram(v);function w(P){if(i.debug.checkShaderErrors){const U=r.getProgramInfoLog(v)||"",q=r.getShaderInfoLog(T)||"",$=r.getShaderInfoLog(y)||"",O=U.trim(),W=q.trim(),G=$.trim();let H=!0,Z=!0;if(r.getProgramParameter(v,r.LINK_STATUS)===!1)if(H=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,v,T,y);else{const j=yl(r,T,"vertex"),te=yl(r,y,"fragment");Ue("WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(v,r.VALIDATE_STATUS)+`
...
}`,Cm=[new C(1,0,0),new C(-1,0,0),new C(0,1,0),new C(0,-1,0),new C(0,0,1),new C(0,0,-1)],Pm=[new C(0,-1,0),new C(0,-1,0),new C(0,0,1),new C(0,0,-1),new C(0,-1,0),new C(0,-1,0)],Pl=new Ne,or=new C,ma=new C;function Lm(i,e,t){let n=new Qs;const r=new ke,s=new ke,a=new rt,o=new Yu,l=new Ku,c={},u=t.maxTextureSize,h={0:1,1:0,2:2},d=new sn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new ke},radius:{value:4}},vertexShader:Rm,fragmentShader:wm}),f=d.clone();f.defines.HORIZONTAL_PASS=1;const g=new gt;g.setAttribute("position",new Je(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const v=new Ut(g,d),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=1;let m=this.type;this.render=function(y,w,x){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||y.length===0)return;this.type===2&&(ye("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=1);const b=i.getRenderTarget(),L=i.getActiveCubeFace(),P=i.getActiveMipmapLevel(),U=i.state;U.setBlending(0),U.buffers.depth.getReversed()===!0?U.buffers.color.setClear(0,0,0,0):U.buffers.color.setClear(1,1,1,1),U.buffers.depth.setTest(!0),U.setScissorTest(!1);const q=m!==this.type;q&&w.traverse(function($){$.material&&(Array.isArray($.material)?$.material.forEach(O=>O.needsUpdate=!0):$.material.needsUpdate=!0)});for(let $=0,O=y.length;$<O;$++){const W=y[$],G=W.shadow;if(G===void 0){ye("WebGLShadowMap:",W,"has no shadow.");continue}if(G.autoUpdate===!1&&G.needsUpdate===!1)continue;r.copy(G.mapSize);const H=G.getFrameExtents();r.multiply(H),s.copy(G.mapSize),(r.x>u||r.y>u)&&(r.x>u&&(s.x=Math.floor(u/H.x),r.x=s.x*H.x,G.mapSize.x=s.x),r.y>u&&(s.y=Math.floor(u/H.y),r.y=s.y*H.y,G.mapSize.y=s.y));const Z=i.state.buffers.depth.getReversed();if(G.camera._reversedDepth=Z,G.map===null||q===!0){if(G.map!==null&&(G.map.depthTexture!==null&&(G.map.depthTexture.dispose(),G.map.depthTexture=null),G.map.dispose()),this.type===3){if(W.isPointLight){ye("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}G.map=new ln(r.x,r.y,{format:1030,type:1016,minFilter:1006,magFilter:1006,generateMipmaps:!1}),G.map.texture.name=W.name+".shadowMap",G.map.depthTexture=new Si(r.x,r.y,1015),G.map.depthTexture.name=W.name+".shadowMapDepth",G.map.depthTexture.format=1026,G.map.depthTexture.compareFunction=null,G.map.depthTexture.minFilter=1003,G.map.depthTexture.magFilter=1003}else W.isPointLight?(G.map=new cl(r.x),G.map.depthTexture=new Gu(r.x,1014)):(G.map=new ln(r.x,r.y),G.map.depthTexture=new Si(r.x,r.y,1014)),G.map.depthTexture.name=W.name+".shadowMap",G.map.depthTexture.format=1026,this.type===1?(G.map.depthTexture.compareFunction=Z?518:515,G.map.depthTexture.minFilter=1006,G.map.depthTexture.magFilter=1006):(G.map.depthTexture.compareFunction=null,G.map.depthTexture.minFilter=1003,G.map.depthTexture.magFilter=1003);G.camera.updateProjectionMatrix()}const j=G.map.isWebGLCubeRenderTarget?6:1;for(let te=0;te<j;te++){if(G.map.isWebGLCubeRenderTarget)i.setRenderTarget(G.map,te),i.clear();else{te===0&&(i.setRenderTarget(G.map),i.clear());const ne=G.getViewport(te);a.set(s.x*ne.x,s.y*ne.y,s.x*ne.z,s.y*ne.w),U.viewport(a)}if(W.isPointLight){const ne=G.camera,Ee=G.matrix,De=W.distance||ne.far;De!==ne.far&&(ne.far=De,ne.updateProjectionMatrix()),or.setFromMatrixPosition(W.matrixWorld),ne.position.copy(or),ma.copy(ne.position),ma.add(Cm[te]),ne.up.copy(Pm[te]),ne.lookAt(ma),ne.updateMatrixWorld(),Ee.makeTranslation(-or.x,-or.y,-or.z),Pl.multiplyMatrices(ne.projectionMatrix,ne.matrixWorldInverse),G._frustum.setFromProjectionMatrix(Pl,ne.coordinateSystem,ne.reversedDepth)}else G.updateMatrices(W);n=G.getFrustum(),M(w,x,G.camera,W,this.type)}G.isPointLightShadow!==!0&&this.type===3&&E(G,x),G.needsUpdate=!1}m=this.type,p.needsUpdate=!1,i.setRenderTarget(b,L,P)};function E(y,w){const x=e.update(v);d.defines.VSM_SAMPLES!==y.blurSamples&&(d.defines.VSM_SAMPLES=y.blurSamples,f.defines.VSM_SAMPLES=y.blurSamples,d.needsUpdate=!0,f.needsUpdate=!0),y.mapPass===null&&(y.mapPass=new ln(r.x,r.y,{format:1030,type:1016})),d.uniforms.shadow_pass.value=y.map.depthTexture,d.uniforms.resolution.value=y.mapSize,d.uniforms.radius.value=y.radius,i.setRenderTarget(y.mapPass),i.clear(),i.renderBufferDirect(w,null,x,d,v,null),f.uniforms.shadow_pass.value=y.mapPass.texture,f.uniforms.resolution.value=y.mapSize,f.uniforms.radius.value=y.radius,i.setRenderTarget(y.map),i.clear(),i.renderBufferDirect(w,null,x,f,v,null)}function R(y,w,x,b){let L=null;const P=x.isPointLight===!0?y.customDistanceMaterial:y.customDepthMaterial;if(P!==void 0)L=P;else if(L=x.isPointLight===!0?l:o,i.localClippingEnabled&&w.clipShadows===!0&&Array.isArray(w.clippingPlanes)&&w.clippingPlanes.length!==0||w.displacementMap&&w.displacementScale!==0||w.alphaMap&&w.alphaTest>0||w.map&&w.alphaTest>0||w.alphaToCoverage===!0){const U=L.uuid,q=w.uuid;let $=c[U];$===void 0&&($={},c[U]=$);let O=$[q];O===void 0&&(O=L.clone(),$[q]=O,w.addEventListener("dispose",T)),L=O}if(L.visible=w.visible,L.wireframe=w.wireframe,b===3?L.side=w.shadowSide!==null?w.shadowSide:w.side:L.side=w.shadowSide!==null?w.shadowSide:h[w.side],L.alphaMap=w.alphaMap,L.alphaTest=w.alphaToCoverage===!0?.5:w.alphaTest,L.map=w.map,L.clipShadows=w.clipShadows,L.clippingPlanes=w.clippingPlanes,L.clipIntersection=w.clipIntersection,L.displacementMap=w.displacementMap,L.displacementScale=w.displacementScale,L.displacementBias=w.displacementBias,L.wireframeLinewidth=w.wireframeLinewidth,L.linewidth=w.linewidth,x.isPointLight===!0&&L.isMeshDistanceMaterial===!0){const U=i.properties.get(L);U.light=x}return L}function M(y,w,x,b,L){if(y.visible===!1)return;if(y.layers.test(w.layers)&&(y.isMesh||y.isLine||y.isPoints)&&(y.castShadow||y.receiveShadow&&L===3)&&(!y.frustumCulled||n.intersectsObject(y))){y.modelViewMatrix.multiplyMatrices(x.matrixWorldInverse,y.matrixWorld);const q=e.update(y),$=y.material;if(Array.isArray($)){const O=q.groups;for(let W=0,G=O.length;W<G;W++){const H=O[W],Z=$[H.materialIndex];if(Z&&Z.visible){const j=R(y,Z,b,L);y.onBeforeShadow(i,y,w,x,q,j,H),i.renderBufferDirect(x,null,q,j,y,H),y.onAfterShadow(i,y,w,x,q,j,H)}}}else if($.visible){const O=R(y,$,b,L);y.onBeforeShadow(i,y,w,x,q,O,null),i.renderBufferDirect(x,null,q,O,y,null),y.onAfterShadow(i,y,w,x,q,O,null)}}const U=y.children;for(let q=0,$=U.length;q<$;q++)M(U[q],w,x,b,L)}function T(y){y.target.removeEventListener("dispose",T);for(const x in c){const b=c[x],L=y.target.uuid;L in b&&(b[L].dispose(),delete b[L])}}}function Im(i,e){function t(){let I=!1;const ae=new rt;let J=null;const he=new rt(0,0,0,0);return{setMask:function(fe){J!==fe&&!I&&(i.colorMask(fe,fe,fe,fe),J=fe)},setLocked:function(fe){I=fe},setClear:function(fe,ee,xe,ve,pt){pt===!0&&(fe*=ve,ee*=ve,xe*=ve),ae.set(fe,ee,xe,ve),he.equals(ae)===!1&&(i.clearColor(fe,ee,xe,ve),he.copy(ae))},reset:function(){I=!1,J=null,he.set(-1,0,0,0)}}}function n(){let I=!1,ae=!1,J=null,he=null,fe=null;return{setReversed:function(ee){if(ae!==ee){const xe=e.get("EXT_clip_control");ee?xe.clipControlEXT(xe.LOWER_LEFT_EXT,xe.ZERO_TO_ONE_EXT):xe.clipControlEXT(xe.LOWER_LEFT_EXT,xe.NEGATIVE_ONE_TO_ONE_EXT),ae=ee;const ve=fe;fe=null,this.setClear(ve)}},getReversed:function(){return ae},setTest:function(ee){ee?ie(i.DEPTH_TEST):Ce(i.DEPTH_TEST)},setMask:function(ee){J!==ee&&!I&&(i.depthMask(ee),J=ee)},setFunc:function(ee){if(ae&&(ee=Jc[ee]),he!==ee){switch(ee){case 0:i.depthFunc(i.NEVER);break;case 1:i.depthFunc(i.ALWAYS);break;case 2:i.depthFunc(i.LESS);break;case 3:i.depthFunc(i.LEQUAL);break;case 4:i.depthFunc(i.EQUAL);break;case 5:i.depthFunc(i.GEQUAL);break;case 6:i.depthFunc(i.GREATER);break;case 7:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}he=ee}},setLocked:function(ee){I=ee},setClear:function(ee){fe!==ee&&(fe=ee,ae&&(ee=1-ee),i.clearDepth(ee))},reset:function(){I=!1,J=null,he=null,fe=null,ae=!1}}}function r(){let I=!1,ae=null,J=null,he=null,fe=null,ee=null,xe=null,ve=null,pt=null;return{setTest:function(it){I||(it?ie(i.STENCIL_TEST):Ce(i.STENCIL_TEST))},setMask:function(it){ae!==it&&!I&&(i.stencilMask(it),ae=it)},setFunc:function(it,Kt,$t){(J!==it||he!==Kt||fe!==$t)&&(i.stencilFunc(it,Kt,$t),J=it,he=Kt,fe=$t)},setOp:function(it,Kt,$t){(ee!==it||xe!==Kt||ve!==$t)&&(i.stencilOp(it,Kt,$t),ee=it,xe=Kt,ve=$t)},setLocked:function(it){I=it},setClear:function(it){pt!==it&&(i.clearStencil(it),pt=it)},reset:function(){I=!1,ae=null,J=null,he=null,fe=null,ee=null,xe=null,ve=null,pt=null}}}const s=new t,a=new n,o=new r,l=new WeakMap,c=new WeakMap;let u={},h={},d={},f=new WeakMap,g=[],v=null,p=!1,m=null,E=null,R=null,M=null,T=null,y=null,w=null,x=new Te(0,0,0),b=0,L=!1,P=null,U=null,q=null,$=null,O=null;const W=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let G=!1,H=0;const Z=i.getParameter(i.VERSION);Z.indexOf("WebGL")!==-1?(H=parseFloat(/^WebGL (\d)/.exec(Z)[1]),G=H>=1):Z.indexOf("OpenGL ES")!==-1&&(H=parseFloat(/^OpenGL ES (\d)/.exec(Z)[1]),G=H>=2);let j=null,te={};const ne=i.getParameter(i.SCISSOR_BOX),Ee=i.getParameter(i.VIEWPORT),De=new rt().fromArray(ne),Oe=new rt().fromArray(Ee);function K(I,ae,J,he){const fe=new Uint8Array(4),ee=i.createTexture();i.bindTexture(I,ee),i.texParameteri(I,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(I,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let xe=0;xe<J;xe++)I===i.TEXTURE_3D||I===i.TEXTURE_2D_ARRAY?i.texImage3D(ae,0,i.RGBA,1,1,he,0,i.RGBA,i.UNSIGNED_BYTE,fe):i.texImage2D(ae+xe,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,fe);return ee}const re={};re[i.TEXTURE_2D]=K(i.TEXTURE_2D,i.TEXTURE_2D,1),re[i.TEXTURE_CUBE_MAP]=K(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),re[i.TEXTURE_2D_ARRAY]=K(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),re[i.TEXTURE_3D]=K(i.TEXTURE_3D,i.TEXTURE_3D,1,1),s.setClear(0,0,0,1),a.setClear(1),o.setClear(0),ie(i.DEPTH_TEST),a.setFunc(3),ut(!1),ft(1),ie(i.CULL_FACE),Ke(0);function ie(I){u[I]!==!0&&(i.enable(I),u[I]=!0)}function Ce(I){u[I]!==!1&&(i.disable(I),u[I]=!1)}function Ie(I,ae){return d[I]!==ae?(i.bindFramebuffer(I,ae),d[I]=ae,I===i.DRAW_FRAMEBUFFER&&(d[i.FRAMEBUFFER]=ae),I===i.FRAMEBUFFER&&(d[i.DRAW_FRAMEBUFFER]=ae),!0):!1}function be(I,ae){let J=g,he=!1;if(I){J=f.get(ae),J===void 0&&(J=[],f.set(ae,J));const fe=I.textures;if(J.length!==fe.length||J[0]!==i.COLOR_ATTACHMENT0){for(let ee=0,xe=fe.length;ee<xe;ee++)J[ee]=i.COLOR_ATTACHMENT0+ee;J.length=fe.length,he=!0}}else J[0]!==i.BACK&&(J[0]=i.BACK,he=!0);he&&i.drawBuffers(J)}function ot(I){return v!==I?(i.useProgram(I),v=I,!0):!1}const Ve={100:i.FUNC_ADD,101:i.FUNC_SUBTRACT,102:i.FUNC_REVERSE_SUBTRACT};Ve[103]=i.MIN,Ve[104]=i.MAX;const $e={200:i.ZERO,201:i.ONE,202:i.SRC_COLOR,204:i.SRC_ALPHA,210:i.SRC_ALPHA_SATURATE,208:i.DST_COLOR,206:i.DST_ALPHA,203:i.ONE_MINUS_SRC_COLOR,205:i.ONE_MINUS_SRC_ALPHA,209:i.ONE_MINUS_DST_COLOR,207:i.ONE_MINUS_DST_ALPHA,211:i.CONSTANT_COLOR,212:i.ONE_MINUS_CONSTANT_COLOR,213:i.CONSTANT_ALPHA,214:i.ONE_MINUS_CONSTANT_ALPHA};function Ke(I,ae,J,he,fe,ee,xe,ve,pt,it){if(I===0){p===!0&&(Ce(i.BLEND),p=!1);return}if(p===!1&&(ie(i.BLEND),p=!0),I!==5){if(I!==m||it!==L){if((E!==100||T!==100)&&(i.blendEquation(i.FUNC_ADD),E=100,T=100),it)switch(I){case 1:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case 2:i.blendFunc(i.ONE,i.ONE);break;case 3:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case 4:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:Ue("WebGLState: Invalid blending: ",I);break}else switch(I){case 1:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case 2:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case 3:Ue("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case 4:Ue("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Ue("WebGLState: Invalid blending: ",I);break}R=null,M=null,y=null,w=null,x.set(0,0,0),b=0,m=I,L=it}return}fe=fe||ae,ee=ee||J,xe=xe||he,(ae!==E||fe!==T)&&(i.blendEquationSeparate(Ve[ae],Ve[fe]),E=ae,T=fe),(J!==R||he!==M||ee!==y||xe!==w)&&(i.blendFuncSeparate($e[J],$e[he],$e[ee],$e[xe]),R=J,M=he,y=ee,w=xe),(ve.equals(x)===!1||pt!==b)&&(i.blendColor(ve.r,ve.g,ve.b,pt),x.copy(ve),b=pt),m=I,L=!1}function Xe(I,ae){I.side===2?Ce(i.CULL_FACE):ie(i.CULL_FACE);let J=I.side===1;ae&&(J=!J),ut(J),I.blending===1&&I.transparent===!1?Ke(0):Ke(I.blending,I.blendEquation,I.blendSrc,I.blendDst,I.blendEquationAlpha,I.blendSrcAlpha,I.blendDstAlpha,I.blendColor,I.blendAlpha,I.premultipliedAlpha),a.setFunc(I.depthFunc),a.setTest(I.depthTest),a.setMask(I.depthWrite),s.setMask(I.colorWrite);const he=I.stencilWrite;o.setTest(he),he&&(o.setMask(I.stencilWriteMask),o.setFunc(I.stencilFunc,I.stencilRef,I.stencilFuncMask),o.setOp(I.stencilFail,I.stencilZFail,I.stencilZPass)),Et(I.polygonOffset,I.polygonOffsetFactor,I.polygonOffsetUnits),I.alphaToCoverage===!0?ie(i.SAMPLE_ALPHA_TO_COVERAGE):Ce(i.SAMPLE_ALPHA_TO_COVERAGE)}function ut(I){P!==I&&(I?i.frontFace(i.CW):i.frontFace(i.CCW),P=I)}function ft(I){I!==0?(ie(i.CULL_FACE),I!==U&&(I===1?i.cullFace(i.BACK):I===2?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):Ce(i.CULL_FACE),U=I}function xt(I){I!==q&&(G&&i.lineWidth(I),q=I)}function Et(I,ae,J){I?(ie(i.POLYGON_OFFSET_FILL),($!==ae||O!==J)&&($=ae,O=J,a.getReversed()&&(ae=-ae),i.polygonOffset(ae,J))):Ce(i.POLYGON_OFFSET_FILL)}function dt(I){I?ie(i.SCISSOR_TEST):Ce(i.SCISSOR_TEST)}function Mt(I){I===void 0&&(I=i.TEXTURE0+W-1),j!==I&&(i.activeTexture(I),j=I)}function N(I,ae,J){J===void 0&&(j===null?J=i.TEXTURE0+W-1:J=j);let he=te[J];he===void 0&&(he={type:void 0,texture:void 0},te[J]=he),(he.type!==I||he.texture!==ae)&&(j!==J&&(i.activeTexture(J),j=J),i.bindTexture(I,ae||re[I]),he.type=I,he.texture=ae)}function It(){const I=te[j];I!==void 0&&I.type!==void 0&&(i.bindTexture(I.type,null),I.type=void 0,I.texture=void 0)}function je(){try{i.compressedTexImage2D(...arguments)}catch(I){Ue("WebGLState:",I)}}function A(){try{i.compressedTexImage3D(...arguments)}catch(I){Ue("WebGLState:",I)}}function _(){try{i.texSubImage2D(...arguments)}catch(I){Ue("WebGLState:",I)}}function F(){try{i.texSubImage3D(...arguments)}catch(I){Ue("WebGLState:",I)}}function k(){try{i.compressedTexSubImage2D(...arguments)}catch(I){Ue("WebGLState:",I)}}function X(){try{i.compressedTexSubImage3D(...arguments)}catch(I){Ue("WebGLState:",I)}}function se(){try{i.texStorage2D(...arguments)}catch(I){Ue("WebGLState:",I)}}function oe(){try{i.texStorage3D(...arguments)}catch(I){Ue("WebGLState:",I)}}function Y(){try{i.texImage2D(...arguments)}catch(I){Ue("WebGLState:",I)}}function Q(){try{i.texImage3D(...arguments)}catch(I){Ue("WebGLState:",I)}}function ce(I){return h[I]!==void 0?h[I]:i.getParameter(I)}function Se(I,ae){h[I]!==ae&&(i.pixelStorei(I,ae),h[I]=ae)}function de(I){De.equals(I)===!1&&(i.scissor(I.x,I.y,I.z,I.w),De.copy(I))}function ue(I){Oe.equals(I)===!1&&(i.viewport(I.x,I.y,I.z,I.w),Oe.copy(I))}function Re(I,ae){let J=c.get(ae);J===void 0&&(J=new WeakMap,c.set(ae,J));let he=J.get(I);he===void 0&&(he=i.getUniformBlockIndex(ae,I.name),J.set(I,he))}function Le(I,ae){const he=c.get(ae).get(I);l.get(ae)!==he&&(i.uniformBlockBinding(ae,he,I.__bindingPointIndex),l.set(ae,he))}function Fe(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),a.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),i.pixelStorei(i.PACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,!1),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,i.BROWSER_DEFAULT_WEBGL),i.pixelStorei(i.PACK_ROW_LENGTH,0),i.pixelStorei(i.PACK_SKIP_PIXELS,0),i.pixelStorei(i.PACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_ROW_LENGTH,0),i.pixelStorei(i.UNPACK_IMAGE_HEIGHT,0),i.pixelStorei(i.UNPACK_SKIP_PIXELS,0),i.pixelStorei(i.UNPACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_SKIP_IMAGES,0),u={},h={},j=null,te={},d={},f=new WeakMap,g=[],v=null,p=!1,m=null,E=null,R=null,M=null,T=null,y=null,w=null,x=new Te(0,0,0),b=0,L=!1,P=null,U=null,q=null,$=null,O=null,De.set(0,0,i.canvas.width,i.canvas.height),Oe.set(0,0,i.canvas.width,i.canvas.height),s.reset(),a.reset(),o.reset()}return{buffers:{color:s,depth:a,stencil:o},enable:ie,disable:Ce,bindFramebuffer:Ie,drawBuffers:be,useProgram:ot,setBlending:Ke,setMaterial:Xe,setFlipSided:ut,setCullFace:ft,setLineWidth:xt,setPolygonOffset:Et,setScissorTest:dt,activeTexture:Mt,bindTexture:N,unbindTexture:It,compressedTexImage2D:je,compressedTexImage3D:A,texImage2D:Y,texImage3D:Q,pixelStorei:Se,getParameter:ce,updateUBOMapping:Re,uniformBlockBinding:Le,texStorage2D:se,texStorage3D:oe,texSubImage2D:_,texSubImage3D:F,compressedTexSubImage2D:k,compressedTexSubImage3D:X,scissor:de,viewport:ue,reset:Fe}}function Nm(i,e,t,n,r,s,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new ke,u=new WeakMap,h=new Set;let d;const f=new WeakMap;let g=!1;try{g=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function v(A,_){return g?new OffscreenCanvas(A,_):Gi("canvas")}function p(A,_,F){let k=1;const X=je(A);if((X.width>F||X.height>F)&&(k=F/Math.max(X.width,X.height)),k<1)if(typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&A instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&A instanceof ImageBitmap||typeof VideoFrame<"u"&&A instanceof VideoFrame){const se=Math.floor(k*X.width),oe=Math.floor(k*X.height);d===void 0&&(d=v(se,oe));const Y=_?v(se,oe):d;return Y.width=se,Y.height=oe,Y.getContext("2d").drawImage(A,0,0,se,oe),ye("WebGLRenderer: Texture has been resized from ("+X.width+"x"+X.height+") to ("+se+"x"+oe+")."),Y}else return"data"in A&&ye("WebGLRenderer: Image in DataTexture is too big ("+X.width+"x"+X.height+")."),A;return A}function m(A){return A.generateMipmaps}function E(A){i.generateMipmap(A)}function R(A){return A.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:A.isWebGL3DRenderTarget?i.TEXTURE_3D:A.isWebGLArrayRenderTarget||A.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function M(A,_,F,k,X,se=!1){if(A!==null){if(i[A]!==void 0)return i[A];ye("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+A+"'")}let oe;k&&(oe=e.get("EXT_texture_norm16"),oe||ye("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let Y=_;if(_===i.RED&&(F===i.FLOAT&&(Y=i.R32F),F===i.HALF_FLOAT&&(Y=i.R16F),F===i.UNSIGNED_BYTE&&(Y=i.R8),F===i.UNSIGNED_SHORT&&oe&&(Y=oe.R16_EXT),F===i.SHORT&&oe&&(Y=oe.R16_SNORM_EXT)),_===i.RED_INTEGER&&(F===i.UNSIGNED_BYTE&&(Y=i.R8UI),F===i.UNSIGNED_SHORT&&(Y=i.R16UI),F===i.UNSIGNED_INT&&(Y=i.R32UI),F===i.BYTE&&(Y=i.R8I),F===i.SHORT&&(Y=i.R16I),F===i.INT&&(Y=i.R32I)),_===i.RG&&(F===i.FLOAT&&(Y=i.RG32F),F===i.HALF_FLOAT&&(Y=i.RG16F),F===i.UNSIGNED_BYTE&&(Y=i.RG8),F===i.UNSIGNED_SHORT&&oe&&(Y=oe.RG16_EXT),F===i.SHORT&&oe&&(Y=oe.RG16_SNORM_EXT)),_===i.RG_INTEGER&&(F===i.UNSIGNED_BYTE&&(Y=i.RG8UI),F===i.UNSIGNED_SHORT&&(Y=i.RG16UI),F===i.UNSIGNED_INT&&(Y=i.RG32UI),F===i.BYTE&&(Y=i.RG8I),F===i.SHORT&&(Y=i.RG16I),F===i.INT&&(Y=i.RG32I)),_===i.RGB_INTEGER&&(F===i.UNSIGNED_BYTE&&(Y=i.RGB8UI),F===i.UNSIGNED_SHORT&&(Y=i.RGB16UI),F===i.UNSIGNED_INT&&(Y=i.RGB32UI),F===i.BYTE&&(Y=i.RGB8I),F===i.SHORT&&(Y=i.RGB16I),F===i.INT&&(Y=i.RGB32I)),_===i.RGBA_INTEGER&&(F===i.UNSIGNED_BYTE&&(Y=i.RGBA8UI),F===i.UNSIGNED_SHORT&&(Y=i.RGBA16UI),F===i.UNSIGNED_INT&&(Y=i.RGBA32UI),F===i.BYTE&&(Y=i.RGBA8I),F===i.SHORT&&(Y=i.RGBA16I),F===i.INT&&(Y=i.RGBA32I)),_===i.RGB&&(F===i.UNSIGNED_SHORT&&oe&&(Y=oe.RGB16_EXT),F===i.SHORT&&oe&&(Y=oe.RGB16_SNORM_EXT),F===i.UNSIGNED_INT_5_9_9_9_REV&&(Y=i.RGB9_E5),F===i.UNSIGNED_INT_10F_11F_11F_REV&&(Y=i.R11F_G11F_B10F)),_===i.RGBA){const Q=se?vr:Ye.getTransfer(X);F===i.FLOAT&&(Y=i.RGBA32F),F===i.HALF_FLOAT&&(Y=i.RGBA16F),F===i.UNSIGNED_BYTE&&(Y=Q===et?i.SRGB8_ALPHA8:i.RGBA8),F===i.UNSIGNED_SHORT&&oe&&(Y=oe.RGBA16_EXT),F===i.SHORT&&oe&&(Y=oe.RGBA16_SNORM_EXT),F===i.UNSIGNED_SHORT_4_4_4_4&&(Y=i.RGBA4),F===i.UNSIGNED_SHORT_5_5_5_1&&(Y=i.RGB5_A1)}return(Y===i.R16F||Y===i.R32F||Y===i.RG16F||Y===i.RG32F||Y===i.RGBA16F||Y===i.RGBA32F)&&e.get("EXT_color_buffer_float"),Y}function T(A,_){let F;return A?_===null||_===1014||_===1020?F=i.DEPTH24_STENCIL8:_===1015?F=i.DEPTH32F_STENCIL8:_===1012&&(F=i.DEPTH24_STENCIL8,ye("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):_===null||_===1014||_===1020?F=i.DEPTH_COMPONENT24:_===1015?F=i.DEPTH_COMPONENT32F:_===1012&&(F=i.DEPTH_COMPONENT16),F}function y(A,_){return m(A)===!0||A.isFramebufferTexture&&A.minFilter!==1003&&A.minFilter!==1006?Math.log2(Math.max(_.width,_.height))+1:A.mipmaps!==void 0&&A.mipmaps.length>0?A.mipmaps.length:A.isCompressedTexture&&Array.isArray(A.image)?_.mipmaps.length:1}function w(A){const _=A.target;_.removeEventListener("dispose",w),b(_),_.isVideoTexture&&u.delete(_),_.isHTMLTexture&&h.delete(_)}function x(A){const _=A.target;_.removeEventListener("dispose",x),P(_)}function b(A){const _=n.get(A);if(_.__webglInit===void 0)return;const F=A.source,k=f.get(F);if(k){const X=k[_.__cacheKey];X.usedTimes--,X.usedTimes===0&&L(A),Object.keys(k).length===0&&f.delete(F)}n.remove(A)}function L(A){const _=n.get(A);i.deleteTexture(_.__webglTexture);const F=A.source,k=f.get(F);delete k[_.__cacheKey],a.memory.textures--}function P(A){const _=n.get(A);if(A.depthTexture&&(A.depthTexture.dispose(),n.remove(A.depthTexture)),A.isWebGLCubeRenderTarget)for(let k=0;k<6;k++){if(Array.isArray(_.__webglFramebuffer[k]))for(let X=0;X<_.__webglFramebuffer[k].length;X++)i.deleteFramebuffer(_.__webglFramebuffer[k][X]);else i.deleteFramebuffer(_.__webglFramebuffer[k]);_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer[k])}else{if(Array.isArray(_.__webglFramebuffer))for(let k=0;k<_.__webglFramebuffer.length;k++)i.deleteFramebuffer(_.__webglFramebuffer[k]);else i.deleteFramebuffer(_.__webglFramebuffer);if(_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer),_.__webglMultisampledFramebuffer&&i.deleteFramebuffer(_.__webglMultisampledFramebuffer),_.__webglColorRenderbuffer)for(let k=0;k<_.__webglColorRenderbuffer.length;k++)_.__webglColorRenderbuffer[k]&&i.deleteRenderbuffer(_.__webglColorRenderbuffer[k]);_.__webglDepthRenderbuffer&&i.deleteRenderbuffer(_.__webglDepthRenderbuffer)}const F=A.textures;for(let k=0,X=F.length;k<X;k++){const se=n.get(F[k]);se.__webglTexture&&(i.deleteTexture(se.__webglTexture),a.memory.textures--),n.remove(F[k])}n.remove(A)}let U=0;function q(){U=0}function $(){return U}function O(A){U=A}function W(){const A=U;return A>=r.maxTextures&&ye("WebGLTextures: Trying to use "+A+" texture units while this GPU supports only "+r.maxTextures),U+=1,A}function G(A){const _=[];return _.push(A.wrapS),_.push(A.wrapT),_.push(A.wrapR||0),_.push(A.magFilter),_.push(A.minFilter),_.push(A.anisotropy),_.push(A.internalFormat),_.push(A.format),_.push(A.type),_.push(A.generateMipmaps),_.push(A.premultiplyAlpha),_.push(A.flipY),_.push(A.unpackAlignment),_.push(A.colorSpace),_.join()}function H(A,_){const F=n.get(A);if(A.isVideoTexture&&N(A),A.isRenderTargetTexture===!1&&A.isExternalTexture!==!0&&A.version>0&&F.__version!==A.version){const k=A.image;if(k===null)ye("WebGLRenderer: Texture marked for update but no image data found.");else if(k.complete===!1)ye("WebGLRenderer: Texture marked for update but image is incomplete");else{Ce(F,A,_);return}}else A.isExternalTexture&&(F.__webglTexture=A.sourceTexture?A.sourceTexture:null);t.bindTexture(i.TEXTURE_2D,F.__webglTexture,i.TEXTURE0+_)}function Z(A,_){const F=n.get(A);if(A.isRenderTargetTexture===!1&&A.version>0&&F.__version!==A.version){Ce(F,A,_);return}else A.isExternalTexture&&(F.__webglTexture=A.sourceTexture?A.sourceTexture:null);t.bindTexture(i.TEXTURE_2D_ARRAY,F.__webglTexture,i.TEXTURE0+_)}function j(A,_){const F=n.get(A);if(A.isRenderTargetTexture===!1&&A.version>0&&F.__version!==A.version){Ce(F,A,_);return}t.bindTexture(i.TEXTURE_3D,F.__webglTexture,i.TEXTURE0+_)}function te(A,_){const F=n.get(A);if(A.isCubeDepthTexture!==!0&&A.version>0&&F.__version!==A.version){Ie(F,A,_);return}t.bindTexture(i.TEXTURE_CUBE_MAP,F.__webglTexture,i.TEXTURE0+_)}const ne={1e3:i.REPEAT,1001:i.CLAMP_TO_EDGE,1002:i.MIRRORED_REPEAT},Ee={1003:i.NEAREST,1004:i.NEAREST_MIPMAP_NEAREST,1005:i.NEAREST_MIPMAP_LINEAR,1006:i.LINEAR,1007:i.LINEAR_MIPMAP_NEAREST,1008:i.LINEAR_MIPMAP_LINEAR},De={512:i.NEVER,519:i.ALWAYS,513:i.LESS,515:i.LEQUAL,514:i.EQUAL,518:i.GEQUAL,516:i.GREATER,517:i.NOTEQUAL};function Oe(A,_){if(_.type===1015&&e.has("OES_texture_float_linear")===!1&&(_.magFilter===1006||_.magFilter===1007||_.magFilter===1005||_.magFilter===1008||_.minFilter===1006||_.minFilter===1007||_.minFilter===1005||_.minFilter===1008)&&ye("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(A,i.TEXTURE_WRAP_S,ne[_.wrapS]),i.texParameteri(A,i.TEXTURE_WRAP_T,ne[_.wrapT]),(A===i.TEXTURE_3D||A===i.TEXTURE_2D_ARRAY)&&i.texParameteri(A,i.TEXTURE_WRAP_R,ne[_.wrapR]),i.texParameteri(A,i.TEXTURE_MAG_FILTER,Ee[_.magFilter]),i.texParameteri(A,i.TEXTURE_MIN_FILTER,Ee[_.minFilter]),_.compareFunction&&(i.texParameteri(A,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(A,i.TEXTURE_COMPARE_FUNC,De[_.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(_.magFilter===1003||_.minFilter!==1005&&_.minFilter!==1008||_.type===1015&&e.has("OES_texture_float_linear")===!1)return;if(_.anisotropy>1||n.get(_).__currentAnisotropy){const F=e.get("EXT_texture_filter_anisotropic");i.texParameterf(A,F.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(_.anisotropy,r.getMaxAnisotropy())),n.get(_).__currentAnisotropy=_.anisotropy}}}function K(A,_){let F=!1;A.__webglInit===void 0&&(A.__webglInit=!0,_.addEventListener("dispose",w));const k=_.source;let X=f.get(k);X===void 0&&(X={},f.set(k,X));const se=G(_);if(se!==A.__cacheKey){X[se]===void 0&&(X[se]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,F=!0),X[se].usedTimes++;const oe=X[A.__cacheKey];oe!==void 0&&(X[A.__cacheKey].usedTimes--,oe.usedTimes===0&&L(_)),A.__cacheKey=se,A.__webglTexture=X[se].texture}return F}function re(A,_,F){return Math.floor(Math.floor(A/F)/_)}function ie(A,_,F,k){const se=A.updateRanges;if(se.length===0)t.texSubImage2D(i.TEXTURE_2D,0,0,0,_.width,_.height,F,k,_.data);else{se.sort((Se,de)=>Se.start-de.start);let oe=0;for(let Se=1;Se<se.length;Se++){const de=se[oe],ue=se[Se],Re=de.start+de.count,Le=re(ue.start,_.width,4),Fe=re(de.start,_.width,4);ue.start<=Re+1&&Le===Fe&&re(ue.start+ue.count-1,_.width,4)===Le?de.count=Math.max(de.count,ue.start+ue.count-de.start):(++oe,se[oe]=ue)}se.length=oe+1;const Y=t.getParameter(i.UNPACK_ROW_LENGTH),Q=t.getParameter(i.UNPACK_SKIP_PIXELS),ce=t.getParameter(i.UNPACK_SKIP_ROWS);t.pixelStorei(i.UNPACK_ROW_LENGTH,_.width);for(let Se=0,de=se.length;Se<de;Se++){const ue=se[Se],Re=Math.floor(ue.start/4),Le=Math.ceil(ue.count/4),Fe=Re%_.width,I=Math.floor(Re/_.width),ae=Le,J=1;t.pixelStorei(i.UNPACK_SKIP_PIXELS,Fe),t.pixelStorei(i.UNPACK_SKIP_ROWS,I),t.texSubImage2D(i.TEXTURE_2D,0,Fe,I,ae,J,F,k,_.data)}A.clearUpdateRanges(),t.pixelStorei(i.UNPACK_ROW_LENGTH,Y),t.pixelStorei(i.UNPACK_SKIP_PIXELS,Q),t.pixelStorei(i.UNPACK_SKIP_ROWS,ce)}}function Ce(A,_,F){let k=i.TEXTURE_2D;(_.isDataArrayTexture||_.isCompressedArrayTexture)&&(k=i.TEXTURE_2D_ARRAY),_.isData3DTexture&&(k=i.TEXTURE_3D);const X=K(A,_),se=_.source;t.bindTexture(k,A.__webglTexture,i.TEXTURE0+F);const oe=n.get(se);if(se.version!==oe.__version||X===!0){if(t.activeTexture(i.TEXTURE0+F),(typeof ImageBitmap<"u"&&_.image instanceof ImageBitmap)===!1){const J=Ye.getPrimaries(Ye.workingColorSpace),he=_.colorSpace===""?null:Ye.getPrimaries(_.colorSpace),fe=_.colorSpace===""||J===he?i.NONE:i.BROWSER_DEFAULT_WEBGL;t.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),t.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),t.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,fe)}t.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment);let Q=p(_.image,!1,r.maxTextureSize);Q=It(_,Q);const ce=s.convert(_.format,_.colorSpace),Se=s.convert(_.type);let de=M(_.internalFormat,ce,Se,_.normalized,_.colorSpace,_.isVideoTexture);Oe(k,_);let ue;const Re=_.mipmaps,Le=_.isVideoTexture!==!0,Fe=oe.__version===void 0||X===!0,I=se.dataReady,ae=y(_,Q);if(_.isDepthTexture)de=T(_.format===1027,_.type),Fe&&(Le?t.texStorage2D(i.TEXTURE_2D,1,de,Q.width,Q.height):t.texImage2D(i.TEXTURE_2D,0,de,Q.width,Q.height,0,ce,Se,null));else if(_.isDataTexture)if(Re.length>0){Le&&Fe&&t.texStorage2D(i.TEXTURE_2D,ae,de,Re[0].width,Re[0].height);for(let J=0,he=Re.length;J<he;J++)ue=Re[J],Le?I&&t.texSubImage2D(i.TEXTURE_2D,J,0,0,ue.width,ue.height,ce,Se,ue.data):t.texImage2D(i.TEXTURE_2D,J,de,ue.width,ue.height,0,ce,Se,ue.data);_.generateMipmaps=!1}else Le?(Fe&&t.texStorage2D(i.TEXTURE_2D,ae,de,Q.width,Q.height),I&&ie(_,Q,ce,Se)):t.texImage2D(i.TEXTURE_2D,0,de,Q.width,Q.height,0,ce,Se,Q.data);else if(_.isCompressedTexture)if(_.isCompressedArrayTexture){Le&&Fe&&t.texStorage3D(i.TEXTURE_2D_ARRAY,ae,de,Re[0].width,Re[0].height,Q.depth);for(let J=0,he=Re.length;J<he;J++)if(ue=Re[J],_.format!==1023)if(ce!==null)if(Le){if(I)if(_.layerUpdates.size>0){const fe=el(ue.width,ue.height,_.format,_.type);for(const ee of _.layerUpdates){const xe=ue.data.subarray(ee*fe/ue.data.BYTES_PER_ELEMENT,(ee+1)*fe/ue.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,J,0,0,ee,ue.width,ue.height,1,ce,xe)}_.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,J,0,0,0,ue.width,ue.height,Q.depth,ce,ue.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,J,de,ue.width,ue.height,Q.depth,0,ue.data,0,0);else ye("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Le?I&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,J,0,0,0,ue.width,ue.height,Q.depth,ce,Se,ue.data):t.texImage3D(i.TEXTURE_2D_ARRAY,J,de,ue.width,ue.height,Q.depth,0,ce,Se,ue.data)}else{Le&&Fe&&t.texStorage2D(i.TEXTURE_2D,ae,de,Re[0].width,Re[0].height);for(let J=0,he=Re.length;J<he;J++)ue=Re[J],_.format!==1023?ce!==null?Le?I&&t.compressedTexSubImage2D(i.TEXTURE_2D,J,0,0,ue.width,ue.height,ce,ue.data):t.compressedTexImage2D(i.TEXTURE_2D,J,de,ue.width,ue.height,0,ue.data):ye("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Le?I&&t.texSubImage2D(i.TEXTURE_2D,J,0,0,ue.width,ue.height,ce,Se,ue.data):t.texImage2D(i.TEXTURE_2D,J,de,ue.width,ue.height,0,ce,Se,ue.data)}else if(_.isDataArrayTexture)if(Le){if(Fe&&t.texStorage3D(i.TEXTURE_2D_ARRAY,ae,de,Q.width,Q.height,Q.depth),I)if(_.layerUpdates.size>0){const J=el(Q.width,Q.height,_.format,_.type);for(const he of _.layerUpdates){const fe=Q.data.subarray(he*J/Q.data.BYTES_PER_ELEMENT,(he+1)*J/Q.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,he,Q.width,Q.height,1,ce,Se,fe)}_.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,Q.width,Q.height,Q.depth,ce,Se,Q.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,de,Q.width,Q.height,Q.depth,0,ce,Se,Q.data);else if(_.isData3DTexture)Le?(Fe&&t.texStorage3D(i.TEXTURE_3D,ae,de,Q.width,Q.height,Q.depth),I&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,Q.width,Q.height,Q.depth,ce,Se,Q.data)):t.texImage3D(i.TEXTURE_3D,0,de,Q.width,Q.height,Q.depth,0,ce,Se,Q.data);else if(_.isFramebufferTexture){if(Fe)if(Le)t.texStorage2D(i.TEXTURE_2D,ae,de,Q.width,Q.height);else{let J=Q.width,he=Q.height;for(let fe=0;fe<ae;fe++)t.texImage2D(i.TEXTURE_2D,fe,de,J,he,0,ce,Se,null),J>>=1,he>>=1}}else if(_.isHTMLTexture){if("texElementImage2D"in i){const J=i.canvas;if(J.hasAttribute("layoutsubtree")||J.setAttribute("layoutsubtree","true"),Q.parentNode!==J){J.appendChild(Q),h.add(_),J.onpaint=he=>{const fe=he.changedElements;for(const ee of h)fe.includes(ee.image)&&(ee.needsUpdate=!0)},J.requestPaint();return}if(i.texElementImage2D.length===3)i.texElementImage2D(i.TEXTURE_2D,i.RGBA8,Q);else{const fe=i.RGBA,ee=i.RGBA,xe=i.UNSIGNED_BYTE;i.texElementImage2D(i.TEXTURE_2D,0,fe,ee,xe,Q)}i.texParameteri(i.TEXTURE_2D,i.TEXTURE_MIN_FILTER,i.LINEAR),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_S,i.CLAMP_TO_EDGE),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_T,i.CLAMP_TO_EDGE)}}else if(Re.length>0){if(Le&&Fe){const J=je(Re[0]);t.texStorage2D(i.TEXTURE_2D,ae,de,J.width,J.height)}for(let J=0,he=Re.length;J<he;J++)ue=Re[J],Le?I&&t.texSubImage2D(i.TEXTURE_2D,J,0,0,ce,Se,ue):t.texImage2D(i.TEXTURE_2D,J,de,ce,Se,ue);_.generateMipmaps=!1}else if(Le){if(Fe){const J=je(Q);t.texStorage2D(i.TEXTURE_2D,ae,de,J.width,J.height)}I&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,ce,Se,Q)}else t.texImage2D(i.TEXTURE_2D,0,de,ce,Se,Q);m(_)&&E(k),oe.__version=se.version,_.onUpdate&&_.onUpdate(_)}A.__version=_.version}function Ie(A,_,F){if(_.image.length!==6)return;const k=K(A,_),X=_.source;t.bindTexture(i.TEXTURE_CUBE_MAP,A.__webglTexture,i.TEXTURE0+F);const se=n.get(X);if(X.version!==se.__version||k===!0){t.activeTexture(i.TEXTURE0+F);const oe=Ye.getPrimaries(Ye.workingColorSpace),Y=_.colorSpace===""?null:Ye.getPrimaries(_.colorSpace),Q=_.colorSpace===""||oe===Y?i.NONE:i.BROWSER_DEFAULT_WEBGL;t.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),t.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),t.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment),t.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Q);const ce=_.isCompressedTexture||_.image[0].isCompressedTexture,Se=_.image[0]&&_.image[0].isDataTexture,de=[];for(let ee=0;ee<6;ee++)!ce&&!Se?de[ee]=p(_.image[ee],!0,r.maxCubemapSize):de[ee]=Se?_.image[ee].image:_.image[ee],de[ee]=It(_,de[ee]);const ue=de[0],Re=s.convert(_.format,_.colorSpace),Le=s.convert(_.type),Fe=M(_.internalFormat,Re,Le,_.normalized,_.colorSpace),I=_.isVideoTexture!==!0,ae=se.__version===void 0||k===!0,J=X.dataReady;let he=y(_,ue);Oe(i.TEXTURE_CUBE_MAP,_);let fe;if(ce){I&&ae&&t.texStorage2D(i.TEXTURE_CUBE_MAP,he,Fe,ue.width,ue.height);for(let ee=0;ee<6;ee++){fe=de[ee].mipmaps;for(let xe=0;xe<fe.length;xe++){const ve=fe[xe];_.format!==1023?Re!==null?I?J&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,xe,0,0,ve.width,ve.height,Re,ve.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,xe,Fe,ve.width,ve.height,0,ve.data):ye("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):I?J&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,xe,0,0,ve.width,ve.height,Re,Le,ve.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,xe,Fe,ve.width,ve.height,0,Re,Le,ve.data)}}}else{if(fe=_.mipmaps,I&&ae){fe.length>0&&he++;const ee=je(de[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,he,Fe,ee.width,ee.height)}for(let ee=0;ee<6;ee++)if(Se){I?J&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,0,0,de[ee].width,de[ee].height,Re,Le,de[ee].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,Fe,de[ee].width,de[ee].height,0,Re,Le,de[ee].data);for(let xe=0;xe<fe.length;xe++){const pt=fe[xe].image[ee].image;I?J&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,xe+1,0,0,pt.width,pt.height,Re,Le,pt.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,xe+1,Fe,pt.width,pt.height,0,Re,Le,pt.data)}}else{I?J&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,0,0,Re,Le,de[ee]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,Fe,Re,Le,de[ee]);for(let xe=0;xe<fe.length;xe++){const ve=fe[xe];I?J&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,xe+1,0,0,Re,Le,ve.image[ee]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,xe+1,Fe,Re,Le,ve.image[ee])}}}m(_)&&E(i.TEXTURE_CUBE_MAP),se.__version=X.version,_.onUpdate&&_.onUpdate(_)}A.__version=_.version}function be(A,_,F,k,X,se){const oe=s.convert(F.format,F.colorSpace),Y=s.convert(F.type),Q=M(F.internalFormat,oe,Y,F.normalized,F.colorSpace),ce=n.get(_),Se=n.get(F);if(Se.__renderTarget=_,!ce.__hasExternalTextures){const de=Math.max(1,_.width>>se),ue=Math.max(1,_.height>>se);X===i.TEXTURE_3D||X===i.TEXTURE_2D_ARRAY?t.texImage3D(X,se,Q,de,ue,_.depth,0,oe,Y,null):t.texImage2D(X,se,Q,de,ue,0,oe,Y,null)}t.bindFramebuffer(i.FRAMEBUFFER,A),Mt(_)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,k,X,Se.__webglTexture,0,dt(_)):(X===i.TEXTURE_2D||X>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&X<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,k,X,Se.__webglTexture,se),t.bindFramebuffer(i.FRAMEBUFFER,null)}function ot(A,_,F){if(i.bindRenderbuffer(i.RENDERBUFFER,A),_.depthBuffer){const k=_.depthTexture,X=k&&k.isDepthTexture?k.type:null,se=T(_.stencilBuffer,X),oe=_.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;Mt(_)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,dt(_),se,_.width,_.height):F?i.renderbufferStorageMultisample(i.RENDERBUFFER,dt(_),se,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,se,_.width,_.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,oe,i.RENDERBUFFER,A)}else{const k=_.textures;for(let X=0;X<k.length;X++){const se=k[X],oe=s.convert(se.format,se.colorSpace),Y=s.convert(se.type),Q=M(se.internalFormat,oe,Y,se.normalized,se.colorSpace);Mt(_)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,dt(_),Q,_.width,_.height):F?i.renderbufferStorageMultisample(i.RENDERBUFFER,dt(_),Q,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,Q,_.width,_.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function Ve(A,_,F){const k=_.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(i.FRAMEBUFFER,A),!(_.depthTexture&&_.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");const X=n.get(_.depthTexture);if(X.__renderTarget=_,(!X.__webglTexture||_.depthTexture.image.width!==_.width||_.depthTexture.image.height!==_.height)&&(_.depthTexture.image.width=_.width,_.depthTexture.image.height=_.height,_.depthTexture.needsUpdate=!0),k){if(X.__webglInit===void 0&&(X.__webglInit=!0,_.depthTexture.addEventListener("dispose",w)),X.__webglTexture===void 0){X.__webglTexture=i.createTexture(),t.bindTexture(i.TEXTURE_CUBE_MAP,X.__webglTexture),Oe(i.TEXTURE_CUBE_MAP,_.depthTexture);const ce=s.convert(_.depthTexture.format),Se=s.convert(_.depthTexture.type);let de;_.depthTexture.format===1026?de=i.DEPTH_COMPONENT24:_.depthTexture.format===1027&&(de=i.DEPTH24_STENCIL8);for(let ue=0;ue<6;ue++)i.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ue,0,de,_.width,_.height,0,ce,Se,null)}}else H(_.depthTexture,0);const se=X.__webglTexture,oe=dt(_),Y=k?i.TEXTURE_CUBE_MAP_POSITIVE_X+F:i.TEXTURE_2D,Q=_.depthTexture.format===1027?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;if(_.depthTexture.format===1026)Mt(_)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Q,Y,se,0,oe):i.framebufferTexture2D(i.FRAMEBUFFER,Q,Y,se,0);else if(_.depthTexture.format===1027)Mt(_)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Q,Y,se,0,oe):i.framebufferTexture2D(i.FRAMEBUFFER,Q,Y,se,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function $e(A){const _=n.get(A),F=A.isWebGLCubeRenderTarget===!0;if(_.__boundDepthTexture!==A.depthTexture){const k=A.depthTexture;if(_.__depthDisposeCallback&&_.__depthDisposeCallback(),k){const X=()=>{delete _.__boundDepthTexture,delete _.__depthDisposeCallback,k.removeEventListener("dispose",X)};k.addEventListener("dispose",X),_.__depthDisposeCallback=X}_.__boundDepthTexture=k}if(A.depthTexture&&!_.__autoAllocateDepthBuffer)if(F)for(let k=0;k<6;k++)Ve(_.__webglFramebuffer[k],A,k);else{const k=A.texture.mipmaps;k&&k.length>0?Ve(_.__webglFramebuffer[0],A,0):Ve(_.__webglFramebuffer,A,0)}else if(F){_.__webglDepthbuffer=[];for(let k=0;k<6;k++)if(t.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer[k]),_.__webglDepthbuffer[k]===void 0)_.__webglDepthbuffer[k]=i.createRenderbuffer(),ot(_.__webglDepthbuffer[k],A,!1);else{const X=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,se=_.__webglDepthbuffer[k];i.bindRenderbuffer(i.RENDERBUFFER,se),i.framebufferRenderbuffer(i.FRAMEBUFFER,X,i.RENDERBUFFER,se)}}else{const k=A.texture.mipmaps;if(k&&k.length>0?t.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer[0]):t.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer),_.__webglDepthbuffer===void 0)_.__webglDepthbuffer=i.createRenderbuffer(),ot(_.__webglDepthbuffer,A,!1);else{const X=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,se=_.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,se),i.framebufferRenderbuffer(i.FRAMEBUFFER,X,i.RENDERBUFFER,se)}}t.bindFramebuffer(i.FRAMEBUFFER,null)}function Ke(A,_,F){const k=n.get(A);_!==void 0&&be(k.__webglFramebuffer,A,A.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),F!==void 0&&$e(A)}function Xe(A){const _=A.texture,F=n.get(A),k=n.get(_);A.addEventListener("dispose",x);const X=A.textures,se=A.isWebGLCubeRenderTarget===!0,oe=X.length>1;if(oe||(k.__webglTexture===void 0&&(k.__webglTexture=i.createTexture()),k.__version=_.version,a.memory.textures++),se){F.__webglFramebuffer=[];for(let Y=0;Y<6;Y++)if(_.mipmaps&&_.mipmaps.length>0){F.__webglFramebuffer[Y]=[];for(let Q=0;Q<_.mipmaps.length;Q++)F.__webglFramebuffer[Y][Q]=i.createFramebuffer()}else F.__webglFramebuffer[Y]=i.createFramebuffer()}else{if(_.mipmaps&&_.mipmaps.length>0){F.__webglFramebuffer=[];for(let Y=0;Y<_.mipmaps.length;Y++)F.__webglFramebuffer[Y]=i.createFramebuffer()}else F.__webglFramebuffer=i.createFramebuffer();if(oe)for(let Y=0,Q=X.length;Y<Q;Y++){const ce=n.get(X[Y]);ce.__webglTexture===void 0&&(ce.__webglTexture=i.createTexture(),a.memory.textures++)}if(A.samples>0&&Mt(A)===!1){F.__webglMultisampledFramebuffer=i.createFramebuffer(),F.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,F.__webglMultisampledFramebuffer);for(let Y=0;Y<X.length;Y++){const Q=X[Y];F.__webglColorRenderbuffer[Y]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,F.__webglColorRenderbuffer[Y]);const ce=s.convert(Q.format,Q.colorSpace),Se=s.convert(Q.type),de=M(Q.internalFormat,ce,Se,Q.normalized,Q.colorSpace,A.isXRRenderTarget===!0),ue=dt(A);i.renderbufferStorageMultisample(i.RENDERBUFFER,ue,de,A.width,A.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Y,i.RENDERBUFFER,F.__webglColorRenderbuffer[Y])}i.bindRenderbuffer(i.RENDERBUFFER,null),A.depthBuffer&&(F.__webglDepthRenderbuffer=i.createRenderbuffer(),ot(F.__webglDepthRenderbuffer,A,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(se){t.bindTexture(i.TEXTURE_CUBE_MAP,k.__webglTexture),Oe(i.TEXTURE_CUBE_MAP,_);for(let Y=0;Y<6;Y++)if(_.mipmaps&&_.mipmaps.length>0)for(let Q=0;Q<_.mipmaps.length;Q++)be(F.__webglFramebuffer[Y][Q],A,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+Y,Q);else be(F.__webglFramebuffer[Y],A,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+Y,0);m(_)&&E(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(oe){for(let Y=0,Q=X.length;Y<Q;Y++){const ce=X[Y],Se=n.get(ce);let de=i.TEXTURE_2D;(A.isWebGL3DRenderTarget||A.isWebGLArrayRenderTarget)&&(de=A.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(de,Se.__webglTexture),Oe(de,ce),be(F.__webglFramebuffer,A,ce,i.COLOR_ATTACHMENT0+Y,de,0),m(ce)&&E(de)}t.unbindTexture()}else{let Y=i.TEXTURE_2D;if((A.isWebGL3DRenderTarget||A.isWebGLArrayRenderTarget)&&(Y=A.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(Y,k.__webglTexture),Oe(Y,_),_.mipmaps&&_.mipmaps.length>0)for(let Q=0;Q<_.mipmaps.length;Q++)be(F.__webglFramebuffer[Q],A,_,i.COLOR_ATTACHMENT0,Y,Q);else be(F.__webglFramebuffer,A,_,i.COLOR_ATTACHMENT0,Y,0);m(_)&&E(Y),t.unbindTexture()}A.depthBuffer&&$e(A)}function ut(A){const _=A.textures;for(let F=0,k=_.length;F<k;F++){const X=_[F];if(m(X)){const se=R(A),oe=n.get(X).__webglTexture;t.bindTexture(se,oe),E(se),t.unbindTexture()}}}const ft=[],xt=[];function Et(A){if(A.samples>0){if(Mt(A)===!1){const _=A.textures,F=A.width,k=A.height;let X=i.COLOR_BUFFER_BIT;const se=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,oe=n.get(A),Y=_.length>1;if(Y)for(let ce=0;ce<_.length;ce++)t.bindFramebuffer(i.FRAMEBUFFER,oe.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ce,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,oe.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+ce,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,oe.__webglMultisampledFramebuffer);const Q=A.texture.mipmaps;Q&&Q.length>0?t.bindFramebuffer(i.DRAW_FRAMEBUFFER,oe.__webglFramebuffer[0]):t.bindFramebuffer(i.DRAW_FRAMEBUFFER,oe.__webglFramebuffer);for(let ce=0;ce<_.length;ce++){if(A.resolveDepthBuffer&&(A.depthBuffer&&(X|=i.DEPTH_BUFFER_BIT),A.stencilBuffer&&A.resolveStencilBuffer&&(X|=i.STENCIL_BUFFER_BIT)),Y){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,oe.__webglColorRenderbuffer[ce]);const Se=n.get(_[ce]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,Se,0)}i.blitFramebuffer(0,0,F,k,0,0,F,k,X,i.NEAREST),l===!0&&(ft.length=0,xt.length=0,ft.push(i.COLOR_ATTACHMENT0+ce),A.depthBuffer&&A.resolveDepthBuffer===!1&&(ft.push(se),xt.push(se),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,xt)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,ft))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),Y)for(let ce=0;ce<_.length;ce++){t.bindFramebuffer(i.FRAMEBUFFER,oe.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ce,i.RENDERBUFFER,oe.__webglColorRenderbuffer[ce]);const Se=n.get(_[ce]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,oe.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+ce,i.TEXTURE_2D,Se,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,oe.__webglMultisampledFramebuffer)}else if(A.depthBuffer&&A.resolveDepthBuffer===!1&&l){const _=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[_])}}}function dt(A){return Math.min(r.maxSamples,A.samples)}function Mt(A){const _=n.get(A);return A.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&_.__useRenderToTexture!==!1}function N(A){const _=a.render.frame;u.get(A)!==_&&(u.set(A,_),A.update())}function It(A,_){const F=A.colorSpace,k=A.format,X=A.type;return A.isCompressedTexture===!0||A.isVideoTexture===!0||F!==Bt&&F!==""&&(Ye.getTransfer(F)===et?(k!==1023||X!==1009)&&ye("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Ue("WebGLTextures: Unsupported texture color space:",F)),_}function je(A){return typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement?(c.width=A.naturalWidth||A.width,c.height=A.naturalHeight||A.height):typeof VideoFrame<"u"&&A instanceof VideoFrame?(c.width=A.displayWidth,c.height=A.displayHeight):(c.width=A.width,c.height=A.height),c}this.allocateTextureUnit=W,this.resetTextureUnits=q,this.getTextureUnits=$,this.setTextureUnits=O,this.setTexture2D=H,this.setTexture2DArray=Z,this.setTexture3D=j,this.setTextureCube=te,this.rebindTextures=Ke,this.setupRenderTarget=Xe,this.updateRenderTargetMipmap=ut,this.updateMultisampleRenderTarget=Et,this.setupDepthRenderbuffer=$e,this.setupFrameBufferTexture=be,this.useMultisampledRTT=Mt,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function Dm(i,e){function t(n,r=""){let s;const a=Ye.getTransfer(r);if(n===1009)return i.UNSIGNED_BYTE;if(n===1017)return i.UNSIGNED_SHORT_4_4_4_4;if(n===1018)return i.UNSIGNED_SHORT_5_5_5_1;if(n===35902)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===35899)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===1010)return i.BYTE;if(n===1011)return i.SHORT;if(n===1012)return i.UNSIGNED_SHORT;if(n===1013)return i.INT;if(n===1014)return i.UNSIGNED_INT;if(n===1015)return i.FLOAT;if(n===1016)return i.HALF_FLOAT;if(n===1021)return i.ALPHA;if(n===1022)return i.RGB;if(n===1023)return i.RGBA;if(n===1026)return i.DEPTH_COMPONENT;if(n===1027)return i.DEPTH_STENCIL;if(n===1028)return i.RED;if(n===1029)return i.RED_INTEGER;if(n===1030)return i.RG;if(n===1031)return i.RG_INTEGER;if(n===1033)return i.RGBA_INTEGER;if(n===33776||n===33777||n===33778||n===33779)if(a===et)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===33776)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===33777)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===33778)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===33779)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===33776)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===33777)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===33778)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===33779)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===35840||n===35841||n===35842||n===35843)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===35840)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===35841)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===35842)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===35843)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===36196||n===37492||n===37496||n===37488||n===37489||n===37490||n===37491)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(n===36196||n===37492)return a===et?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===37496)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC;if(n===37488)return s.COMPRESSED_R11_EAC;if(n===37489)return s.COMPRESSED_SIGNED_R11_EAC;if(n===37490)return s.COMPRESSED_RG11_EAC;if(n===37491)return s.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===37808||n===37809||n===37810||n===37811||n===37812||n===37813||n===37814||n===37815||n===37816||n===37817||n===37818||n===37819||n===37820||n===37821)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(n===37808)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===37809)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===37810)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===37811)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===37812)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===37813)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===37814)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===37815)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===37816)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===37817)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===37818)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===37819)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===37820)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===37821)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===36492||n===36494||n===36495)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(n===36492)return a===et?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===36494)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===36495)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===36283||n===36284||n===36285||n===36286)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(n===36283)return s.COMPRESSED_RED_RGTC1_EXT;if(n===36284)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===36285)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===36286)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===1020?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}const Um=`
void main() {
...
}`;class Om{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){const n=new Bo(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,n=new sn({vertexShader:Um,fragmentShader:Fm,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new Ut(new Yr(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class Bm extends zn{constructor(e,t){super();const n=this;let r=null,s=1,a=null,o="local-floor",l=1,c=null,u=null,h=null,d=null,f=null,g=null;const v=typeof XRWebGLBinding<"u",p=new Om,m={},E=t.getContextAttributes();let R=null,M=null;const T=[],y=[],w=new ke;let x=null;const b=new Ot;b.viewport=new rt;const L=new Ot;L.viewport=new rt;const P=[b,L],U=new _h;let q=null,$=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(K){let re=T[K];return re===void 0&&(re=new Ps,T[K]=re),re.getTargetRaySpace()},this.getControllerGrip=function(K){let re=T[K];return re===void 0&&(re=new Ps,T[K]=re),re.getGripSpace()},this.getHand=function(K){let re=T[K];return re===void 0&&(re=new Ps,T[K]=re),re.getHandSpace()};function O(K){const re=y.indexOf(K.inputSource);if(re===-1)return;const ie=T[re];ie!==void 0&&(ie.update(K.inputSource,K.frame,c||a),ie.dispatchEvent({type:K.type,data:K.inputSource}))}function W(){r.removeEventListener("select",O),r.removeEventListener("selectstart",O),r.removeEventListener("selectend",O),r.removeEventListener("squeeze",O),r.removeEventListener("squeezestart",O),r.removeEventListener("squeezeend",O),r.removeEventListener("end",W),r.removeEventListener("inputsourceschange",G);for(let K=0;K<T.length;K++){const re=y[K];re!==null&&(y[K]=null,T[K].disconnect(re))}q=null,$=null,p.reset();for(const K in m)delete m[K];e.setRenderTarget(R),f=null,d=null,h=null,r=null,M=null,Oe.stop(),n.isPresenting=!1,e.setPixelRatio(x),e.setSize(w.width,w.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(K){s=K,n.isPresenting===!0&&ye("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(K){o=K,n.isPresenting===!0&&ye("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(K){c=K},this.getBaseLayer=function(){return d!==null?d:f},this.getBinding=function(){return h===null&&v&&(h=new XRWebGLBinding(r,t)),h},this.getFrame=function(){return g},this.getSession=function(){return r},this.setSession=async function(K){if(r=K,r!==null){if(R=e.getRenderTarget(),r.addEventListener("select",O),r.addEventListener("selectstart",O),r.addEventListener("selectend",O),r.addEventListener("squeeze",O),r.addEventListener("squeezestart",O),r.addEventListener("squeezeend",O),r.addEventListener("end",W),r.addEventListener("inputsourceschange",G),E.xrCompatible!==!0&&await t.makeXRCompatible(),x=e.getPixelRatio(),e.getSize(w),v&&"createProjectionLayer"in XRWebGLBinding.prototype){let ie=null,Ce=null,Ie=null;E.depth&&(Ie=E.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,ie=E.stencil?1027:1026,Ce=E.stencil?1020:1014);const be={colorFormat:t.RGBA8,depthFormat:Ie,scaleFactor:s};h=this.getBinding(),d=h.createProjectionLayer(be),r.updateRenderState({layers:[d]}),e.setPixelRatio(1),e.setSize(d.textureWidth,d.textureHeight,!1),M=new ln(d.textureWidth,d.textureHeight,{format:1023,type:1009,depthTexture:new Si(d.textureWidth,d.textureHeight,Ce,void 0,void 0,void 0,void 0,void 0,void 0,ie),stencilBuffer:E.stencil,colorSpace:e.outputColorSpace,samples:E.antialias?4:0,resolveDepthBuffer:d.ignoreDepthValues===!1,resolveStencilBuffer:d.ignoreDepthValues===!1})}else{const ie={antialias:E.antialias,alpha:!0,depth:E.depth,stencil:E.stencil,framebufferScaleFactor:s};f=new XRWebGLLayer(r,t,ie),r.updateRenderState({baseLayer:f}),e.setPixelRatio(1),e.setSize(f.framebufferWidth,f.framebufferHeight,!1),M=new ln(f.framebufferWidth,f.framebufferHeight,{format:1023,type:1009,colorSpace:e.outputColorSpace,stencilBuffer:E.stencil,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}M.isXRRenderTarget=!0,this.setFoveation(l),c=null,a=await r.requestReferenceSpace(o),Oe.setContext(r),Oe.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return p.getDepthTexture()};function G(K){for(let re=0;re<K.removed.length;re++){const ie=K.removed[re],Ce=y.indexOf(ie);Ce>=0&&(y[Ce]=null,T[Ce].disconnect(ie))}for(let re=0;re<K.added.length;re++){const ie=K.added[re];let Ce=y.indexOf(ie);if(Ce===-1){for(let be=0;be<T.length;be++)if(be>=y.length){y.push(ie),Ce=be;break}else if(y[be]===null){y[be]=ie,Ce=be;break}if(Ce===-1)break}const Ie=T[Ce];Ie&&Ie.connect(ie)}}const H=new C,Z=new C;function j(K,re,ie){H.setFromMatrixPosition(re.matrixWorld),Z.setFromMatrixPosition(ie.matrixWorld);const Ce=H.distanceTo(Z),Ie=re.projectionMatrix.elements,be=ie.projectionMatrix.elements,ot=Ie[14]/(Ie[10]-1),Ve=Ie[14]/(Ie[10]+1),$e=(Ie[9]+1)/Ie[5],Ke=(Ie[9]-1)/Ie[5],Xe=(Ie[8]-1)/Ie[0],ut=(be[8]+1)/be[0],ft=ot*Xe,xt=ot*ut,Et=Ce/(-Xe+ut),dt=Et*-Xe;if(re.matrixWorld.decompose(K.position,K.quaternion,K.scale),K.translateX(dt),K.translateZ(Et),K.matrixWorld.compose(K.position,K.quaternion,K.scale),K.matrixWorldInverse.copy(K.matrixWorld).invert(),Ie[10]===-1)K.projectionMatrix.copy(re.projectionMatrix),K.projectionMatrixInverse.copy(re.projectionMatrixInverse);else{const Mt=ot+Et,N=Ve+Et,It=ft-dt,je=xt+(Ce-dt),A=$e*Ve/N*Mt,_=Ke*Ve/N*Mt;K.projectionMatrix.makePerspective(It,je,A,_,Mt,N),K.projectionMatrixInverse.copy(K.projectionMatrix).invert()}}function te(K,re){re===null?K.matrixWorld.copy(K.matrix):K.matrixWorld.multiplyMatrices(re.matrixWorld,K.matrix),K.matrixWorldInverse.copy(K.matrixWorld).invert()}this.updateCamera=function(K){if(r===null)return;let re=K.near,ie=K.far;p.texture!==null&&(p.depthNear>0&&(re=p.depthNear),p.depthFar>0&&(ie=p.depthFar)),U.near=L.near=b.near=re,U.far=L.far=b.far=ie,(q!==U.near||$!==U.far)&&(r.updateRenderState({depthNear:U.near,depthFar:U.far}),q=U.near,$=U.far),U.layers.mask=K.layers.mask|6,b.layers.mask=U.layers.mask&-5,L.layers.mask=U.layers.mask&-3;const Ce=K.parent,Ie=U.cameras;te(U,Ce);for(let be=0;be<Ie.length;be++)te(Ie[be],Ce);Ie.length===2?j(U,b,L):U.projectionMatrix.copy(b.projectionMatrix),ne(K,U,Ce)};function ne(K,re,ie){ie===null?K.matrix.copy(re.matrixWorld):(K.matrix.copy(ie.matrixWorld),K.matrix.invert(),K.matrix.multiply(re.matrixWorld)),K.matrix.decompose(K.position,K.quaternion,K.scale),K.updateMatrixWorld(!0),K.projectionMatrix.copy(re.projectionMatrix),K.projectionMatrixInverse.copy(re.projectionMatrixInverse),K.isPerspectiveCamera&&(K.fov=oi*2*Math.atan(1/K.projectionMatrix.elements[5]),K.zoom=1)}this.getCamera=function(){return U},this.getFoveation=function(){if(!(d===null&&f===null))return l},this.setFoveation=function(K){l=K,d!==null&&(d.fixedFoveation=K),f!==null&&f.fixedFoveation!==void 0&&(f.fixedFoveation=K)},this.hasDepthSensing=function(){return p.texture!==null},this.getDepthSensingMesh=function(){return p.getMesh(U)},this.getCameraTexture=function(K){return m[K]};let Ee=null;function De(K,re){if(u=re.getViewerPose(c||a),g=re,u!==null){const ie=u.views;f!==null&&(e.setRenderTargetFramebuffer(M,f.framebuffer),e.setRenderTarget(M));let Ce=!1;ie.length!==U.cameras.length&&(U.cameras.length=0,Ce=!0);for(let Ve=0;Ve<ie.length;Ve++){const $e=ie[Ve];let Ke=null;if(f!==null)Ke=f.getViewport($e);else{const ut=h.getViewSubImage(d,$e);Ke=ut.viewport,Ve===0&&(e.setRenderTargetTextures(M,ut.colorTexture,ut.depthStencilTexture),e.setRenderTarget(M))}let Xe=P[Ve];Xe===void 0&&(Xe=new Ot,Xe.layers.enable(Ve),Xe.viewport=new rt,P[Ve]=Xe),Xe.matrix.fromArray($e.transform.matrix),Xe.matrix.decompose(Xe.position,Xe.quaternion,Xe.scale),Xe.projectionMatrix.fromArray($e.projectionMatrix),Xe.projectionMatrixInverse.copy(Xe.projectionMatrix).invert(),Xe.viewport.set(Ke.x,Ke.y,Ke.width,Ke.height),Ve===0&&(U.matrix.copy(Xe.matrix),U.matrix.decompose(U.position,U.quaternion,U.scale)),Ce===!0&&U.cameras.push(Xe)}const Ie=r.enabledFeatures;if(Ie&&Ie.includes("depth-sensing")&&r.depthUsage=="gpu-optimized"&&v){h=n.getBinding();const Ve=h.getDepthInformation(ie[0]);Ve&&Ve.isValid&&Ve.texture&&p.init(Ve,r.renderState)}if(Ie&&Ie.includes("camera-access")&&v){e.state.unbindTexture(),h=n.getBinding();for(let Ve=0;Ve<ie.length;Ve++){const $e=ie[Ve].camera;if($e){let Ke=m[$e];Ke||(Ke=new Bo,m[$e]=Ke);const Xe=h.getCameraImage($e);Ke.sourceTexture=Xe}}}}for(let ie=0;ie<T.length;ie++){const Ce=y[ie],Ie=T[ie];Ce!==null&&Ie!==void 0&&Ie.update(Ce,re,c||a)}Ee&&Ee(K,re),re.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:re}),g=null}const Oe=new tl;Oe.setAnimationLoop(De),this.setAnimationLoop=function(K){Ee=K},this.dispose=function(){}}}const Vm=new Ne,Ll=new Pe;Ll.set(-1,0,0,0,1,0,0,0,1);function km(i,e){function t(p,m){p.matrixAutoUpdate===!0&&p.updateMatrix(),m.value.copy(p.matrix)}function n(p,m){m.color.getRGB(p.fogColor.value,ko(i)),m.isFog?(p.fogNear.value=m.near,p.fogFar.value=m.far):m.isFogExp2&&(p.fogDensity.value=m.density)}function r(p,m,E,R,M){m.isNodeMaterial?m.uniformsNeedUpdate=!1:m.isMeshBasicMaterial?s(p,m):m.isMeshLambertMaterial?(s(p,m),m.envMap&&(p.envMapIntensity.value=m.envMapIntensity)):m.isMeshToonMaterial?(s(p,m),h(p,m)):m.isMeshPhongMaterial?(s(p,m),u(p,m),m.envMap&&(p.envMapIntensity.value=m.envMapIntensity)):m.isMeshStandardMaterial?(s(p,m),d(p,m),m.isMeshPhysicalMaterial&&f(p,m,M)):m.isMeshMatcapMaterial?(s(p,m),g(p,m)):m.isMeshDepthMaterial?s(p,m):m.isMeshDistanceMaterial?(s(p,m),v(p,m)):m.isMeshNormalMaterial?s(p,m):m.isLineBasicMaterial?(a(p,m),m.isLineDashedMaterial&&o(p,m)):m.isPointsMaterial?l(p,m,E,R):m.isSpriteMaterial?c(p,m):m.isShadowMaterial?(p.color.value.copy(m.color),p.opacity.value=m.opacity):m.isShaderMaterial&&(m.uniformsNeedUpdate=!1)}function s(p,m){p.opacity.value=m.opacity,m.color&&p.diffuse.value.copy(m.color),m.emissive&&p.emissive.value.copy(m.emissive).multiplyScalar(m.emissiveIntensity),m.map&&(p.map.value=m.map,t(m.map,p.mapTransform)),m.alphaMap&&(p.alphaMap.value=m.alphaMap,t(m.alphaMap,p.alphaMapTransform)),m.bumpMap&&(p.bumpMap.value=m.bumpMap,t(m.bumpMap,p.bumpMapTransform),p.bumpScale.value=m.bumpScale,m.side===1&&(p.bumpScale.value*=-1)),m.normalMap&&(p.normalMap.value=m.normalMap,t(m.normalMap,p.normalMapTransform),p.normalScale.value.copy(m.normalScale),m.side===1&&p.normalScale.value.negate()),m.displacementMap&&(p.displacementMap.value=m.displacementMap,t(m.displacementMap,p.displacementMapTransform),p.displacementScale.value=m.displacementScale,p.displacementBias.value=m.displacementBias),m.emissiveMap&&(p.emissiveMap.value=m.emissiveMap,t(m.emissiveMap,p.emissiveMapTransform)),m.specularMap&&(p.specularMap.value=m.specularMap,t(m.specularMap,p.specularMapTransform)),m.alphaTest>0&&(p.alphaTest.value=m.alphaTest);const E=e.get(m),R=E.envMap,M=E.envMapRotation;R&&(p.envMap.value=R,p.envMapRotation.value.setFromMatrix4(Vm.makeRotationFromEuler(M)).transpose(),R.isCubeTexture&&R.isRenderTargetTexture===!1&&p.envMapRotation.value.premultiply(Ll),p.reflectivity.value=m.reflectivity,p.ior.value=m.ior,p.refractionRatio.value=m.refractionRatio),m.lightMap&&(p.lightMap.value=m.lightMap,p.lightMapIntensity.value=m.lightMapIntensity,t(m.lightMap,p.lightMapTransform)),m.aoMap&&(p.aoMap.value=m.aoMap,p.aoMapIntensity.value=m.aoMapIntensity,t(m.aoMap,p.aoMapTransform))}function a(p,m){p.diffuse.value.copy(m.color),p.opacity.value=m.opacity,m.map&&(p.map.value=m.map,t(m.map,p.mapTransform))}function o(p,m){p.dashSize.value=m.dashSize,p.totalSize.value=m.dashSize+m.gapSize,p.scale.value=m.scale}function l(p,m,E,R){p.diffuse.value.copy(m.color),p.opacity.value=m.opacity,p.size.value=m.size*E,p.scale.value=R*.5,m.map&&(p.map.value=m.map,t(m.map,p.uvTransform)),m.alphaMap&&(p.alphaMap.value=m.alphaMap,t(m.alphaMap,p.alphaMapTransform)),m.alphaTest>0&&(p.alphaTest.value=m.alphaTest)}function c(p,m){p.diffuse.value.copy(m.color),p.opacity.value=m.opacity,p.rotation.value=m.rotation,m.map&&(p.map.value=m.map,t(m.map,p.mapTransform)),m.alphaMap&&(p.alphaMap.value=m.alphaMap,t(m.alphaMap,p.alphaMapTransform)),m.alphaTest>0&&(p.alphaTest.value=m.alphaTest)}function u(p,m){p.specular.value.copy(m.specular),p.shininess.value=Math.max(m.shininess,1e-4)}function h(p,m){m.gradientMap&&(p.gradientMap.value=m.gradientMap)}function d(p,m){p.metalness.value=m.metalness,m.metalnessMap&&(p.metalnessMap.value=m.metalnessMap,t(m.metalnessMap,p.metalnessMapTransform)),p.roughness.value=m.roughness,m.roughnessMap&&(p.roughnessMap.value=m.roughnessMap,t(m.roughnessMap,p.roughnessMapTransform)),m.envMap&&(p.envMapIntensity.value=m.envMapIntensity)}function f(p,m,E){p.ior.value=m.ior,m.sheen>0&&(p.sheenColor.value.copy(m.sheenColor).multiplyScalar(m.sheen),p.sheenRoughness.value=m.sheenRoughness,m.sheenColorMap&&(p.sheenColorMap.value=m.sheenColorMap,t(m.sheenColorMap,p.sheenColorMapTransform)),m.sheenRoughnessMap&&(p.sheenRoughnessMap.value=m.sheenRoughnessMap,t(m.sheenRoughnessMap,p.sheenRoughnessMapTransform))),m.clearcoat>0&&(p.clearcoat.value=m.clearcoat,p.clearcoatRoughness.value=m.clearcoatRoughness,m.clearcoatMap&&(p.clearcoatMap.value=m.clearcoatMap,t(m.clearcoatMap,p.clearcoatMapTransform)),m.clearcoatRoughnessMap&&(p.clearcoatRoughnessMap.value=m.clearcoatRoughnessMap,t(m.clearcoatRoughnessMap,p.clearcoatRoughnessMapTransform)),m.clearcoatNormalMap&&(p.clearcoatNormalMap.value=m.clearcoatNormalMap,t(m.clearcoatNormalMap,p.clearcoatNormalMapTransform),p.clearcoatNormalScale.value.copy(m.clearcoatNormalScale),m.side===1&&p.clearcoatNormalScale.value.negate())),m.dispersion>0&&(p.dispersion.value=m.dispersion),m.iridescence>0&&(p.iridescence.value=m.iridescence,p.iridescenceIOR.value=m.iridescenceIOR,p.iridescenceThicknessMinimum.value=m.iridescenceThicknessRange[0],p.iridescenceThicknessMaximum.value=m.iridescenceThicknessRange[1],m.iridescenceMap&&(p.iridescenceMap.value=m.iridescenceMap,t(m.iridescenceMap,p.iridescenceMapTransform)),m.iridescenceThicknessMap&&(p.iridescenceThicknessMap.value=m.iridescenceThicknessMap,t(m.iridescenceThicknessMap,p.iridescenceThicknessMapTransform))),m.transmission>0&&(p.transmission.value=m.transmission,p.transmissionSamplerMap.value=E.texture,p.transmissionSamplerSize.value.set(E.width,E.height),m.transmissionMap&&(p.transmissionMap.value=m.transmissionMap,t(m.transmissionMap,p.transmissionMapTransform)),p.thickness.value=m.thickness,m.thicknessMap&&(p.thicknessMap.value=m.thicknessMap,t(m.thicknessMap,p.thicknessMapTransform)),p.attenuationDistance.value=m.attenuationDistance,p.attenuationColor.value.copy(m.attenuationColor)),m.anisotropy>0&&(p.anisotropyVector.value.set(m.anisotropy*Math.cos(m.anisotropyRotation),m.anisotropy*Math.sin(m.anisotropyRotation)),m.anisotropyMap&&(p.anisotropyMap.value=m.anisotropyMap,t(m.anisotropyMap,p.anisotropyMapTransform))),p.specularIntensity.value=m.specularIntensity,p.specularColor.value.copy(m.specularColor),m.specularColorMap&&(p.specularColorMap.value=m.specularColorMap,t(m.specularColorMap,p.specularColorMapTransform)),m.specularIntensityMap&&(p.specularIntensityMap.value=m.specularIntensityMap,t(m.specularIntensityMap,p.specularIntensityMapTransform))}function g(p,m){m.matcap&&(p.matcap.value=m.matcap)}function v(p,m){const E=e.get(m).light;p.referencePosition.value.setFromMatrixPosition(E.matrixWorld),p.nearDistance.value=E.shadow.camera.near,p.farDistance.value=E.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:r}}function Hm(i,e,t,n){let r={},s={},a=[];const o=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function l(M,T){const y=T.program;n.uniformBlockBinding(M,y)}function c(M,T){let y=r[M.id];y===void 0&&(p(M),y=u(M),r[M.id]=y,M.addEventListener("dispose",E));const w=T.program;n.updateUBOMapping(M,w);const x=e.render.frame;s[M.id]!==x&&(d(M),s[M.id]=x)}function u(M){const T=h();M.__bindingPointIndex=T;const y=i.createBuffer(),w=M.__size,x=M.usage;return i.bindBuffer(i.UNIFORM_BUFFER,y),i.bufferData(i.UNIFORM_BUFFER,w,x),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,T,y),y}function h(){for(let M=0;M<o;M++)if(a.indexOf(M)===-1)return a.push(M),M;return Ue("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function d(M){const T=r[M.id],y=M.uniforms,w=M.__cache;i.bindBuffer(i.UNIFORM_BUFFER,T);for(let x=0,b=y.length;x<b;x++){const L=y[x];if(Array.isArray(L))for(let P=0,U=L.length;P<U;P++)f(L[P],x,P,w);else f(L,x,0,w)}i.bindBuffer(i.UNIFORM_BUFFER,null)}function f(M,T,y,w){if(v(M,T,y,w)===!0){const x=M.__offset,b=M.value;if(Array.isArray(b)){let L=0;for(let P=0;P<b.length;P++){const U=b[P],q=m(U);g(U,M.__data,L),typeof U!="number"&&typeof U!="boolean"&&!U.isMatrix3&&!ArrayBuffer.isView(U)&&(L+=q.storage/Float32Array.BYTES_PER_ELEMENT)}}else g(b,M.__data,0);i.bufferSubData(i.UNIFORM_BUFFER,x,M.__data)}}function g(M,T,y){typeof M=="number"||typeof M=="boolean"?T[0]=M:M.isMatrix3?(T[0]=M.elements[0],T[1]=M.elements[1],T[2]=M.elements[2],T[3]=0,T[4]=M.elements[3],T[5]=M.elements[4],T[6]=M.elements[5],T[7]=0,T[8]=M.elements[6],T[9]=M.elements[7],T[10]=M.elements[8],T[11]=0):ArrayBuffer.isView(M)?T.set(new M.constructor(M.buffer,M.byteOffset,T.length)):M.toArray(T,y)}function v(M,T,y,w){const x=M.value,b=T+"_"+y;if(w[b]===void 0)return typeof x=="number"||typeof x=="boolean"?w[b]=x:ArrayBuffer.isView(x)?w[b]=x.slice():w[b]=x.clone(),!0;{const L=w[b];if(typeof x=="number"||typeof x=="boolean"){if(L!==x)return w[b]=x,!0}else{if(ArrayBuffer.isView(x))return!0;if(L.equals(x)===!1)return L.copy(x),!0}}return!1}function p(M){const T=M.uniforms;let y=0;const w=16;for(let b=0,L=T.length;b<L;b++){const P=Array.isArray(T[b])?T[b]:[T[b]];for(let U=0,q=P.length;U<q;U++){const $=P[U],O=Array.isArray($.value)?$.value:[$.value];for(let W=0,G=O.length;W<G;W++){const H=O[W],Z=m(H),j=y%w,te=j%Z.boundary,ne=j+te;y+=te,ne!==0&&w-ne<Z.storage&&(y+=w-ne),$.__data=new Float32Array(Z.storage/Float32Array.BYTES_PER_ELEMENT),$.__offset=y,y+=Z.storage}}}const x=y%w;return x>0&&(y+=w-x),M.__size=y,M.__cache={},this}function m(M){const T={boundary:0,storage:0};return typeof M=="number"||typeof M=="boolean"?(T.boundary=4,T.storage=4):M.isVector2?(T.boundary=8,T.storage=8):M.isVector3||M.isColor?(T.boundary=16,T.storage=12):M.isVector4?(T.boundary=16,T.storage=16):M.isMatrix3?(T.boundary=48,T.storage=48):M.isMatrix4?(T.boundary=64,T.storage=64):M.isTexture?ye("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ArrayBuffer.isView(M)?(T.boundary=16,T.storage=M.byteLength):ye("WebGLRenderer: Unsupported uniform value type.",M),T}function E(M){const T=M.target;T.removeEventListener("dispose",E);const y=a.indexOf(T.__bindingPointIndex);a.splice(y,1),i.deleteBuffer(r[T.id]),delete r[T.id],delete s[T.id]}function R(){for(const M in r)i.deleteBuffer(r[M]);a=[],r={},s={}}return{bind:l,update:c,dispose:R}}const Gm=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let pn=null;function zm(){return pn===null&&(pn=new $s(Gm,16,16,1030,1016),pn.name="DFG_LUT",pn.minFilter=1006,pn.magFilter=1006,pn.wrapS=1001,pn.wrapT=1001,pn.generateMipmaps=!1,pn.needsUpdate=!0),pn}class Wm{constructor(e={}){const{canvas:t=$c(),context:n=null,depth:r=!0,stencil:s=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:h=!1,reversedDepthBuffer:d=!1,outputBufferType:f=1009}=e;this.isWebGLRenderer=!0;let g;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");g=n.getContextAttributes().alpha}else g=a;const v=f,p=new Set([1033,1031,1029]),m=new Set([1009,1014,1012,1020,1017,1018]),E=new Uint32Array(4),R=new Int32Array(4),M=new C;let T=null,y=null;const w=[],x=[];let b=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=0,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const L=this;let P=!1,U=null,q=null,$=null,O=null;this._outputColorSpace=Rt;let W=0,G=0,H=null,Z=-1,j=null;const te=new rt,ne=new rt;let Ee=null;const De=new Te(0);let Oe=0,K=t.width,re=t.height,ie=1,Ce=null,Ie=null;const be=new rt(0,0,K,re),ot=new rt(0,0,K,re);let Ve=!1;const $e=new Qs;let Ke=!1,Xe=!1;const ut=new Ne,ft=new C,xt=new rt,Et={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let dt=!1;function Mt(){return H===null?ie:1}let N=n;function It(S,D){return t.getContext(S,D)}try{const S={alpha:!0,depth:r,stencil:s,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:u,failIfMajorPerformanceCaveat:h};if("setAttribute"in t&&t.setAttribute("data-engine","three.js r185"),t.addEventListener("webglcontextlost",pt,!1),t.addEventListener("webglcontextrestored",it,!1),t.addEventListener("webglcontextcreationerror",Kt,!1),N===null){const D="webgl2";if(N=It(D,S),N===null)throw It(D)?new Error("THREE.WebGLRenderer: Error creating WebGL context with your selected attributes."):new Error("THREE.WebGLRenderer: Error creating WebGL context.")}}catch(S){throw Ue("WebGLRenderer: "+S.message),S}let je,A,_,F,k,X,se,oe,Y,Q,ce,Se,de,ue,Re,Le,Fe,I,ae,J,he,fe,ee;function xe(){je=new zf(N),je.init(),he=new Dm(N,je),A=new Uf(N,je,e,he),_=new Im(N,je),A.reversedDepthBuffer&&d&&_.buffers.depth.setReversed(!0),q=N.createFramebuffer(),$=N.createFramebuffer(),O=N.createFramebuffer(),F=new qf(N),k=new vm,X=new Nm(N,je,_,k,A,he,F),se=new Gf(L),oe=new Ch(N),fe=new Nf(N,oe),Y=new Wf(N,oe,F,fe),Q=new Kf(N,Y,oe,fe,F),I=new Yf(N,A,X),Re=new Ff(k),ce=new _m(L,se,je,A,fe,Re),Se=new km(L,k),de=new Mm,ue=new Am(je),Fe=new If(L,se,_,Q,g,l),Le=new Lm(L,Q,A),ee=new Hm(N,F,A,_),ae=new Df(N,je,F),J=new Xf(N,je,F),F.programs=ce.programs,L.capabilities=A,L.extensions=je,L.properties=k,L.renderLists=de,L.shadowMap=Le,L.state=_,L.info=F}xe(),v!==1009&&(b=new Zf(v,t.width,t.height,o,r,s));const ve=new Bm(L,N);this.xr=ve,this.getContext=function(){return N},this.getContextAttributes=function(){return N.getContextAttributes()},this.forceContextLoss=function(){const S=je.get("WEBGL_lose_context");S&&S.loseContext()},this.forceContextRestore=function(){const S=je.get("WEBGL_lose_context");S&&S.restoreContext()},this.getPixelRatio=function(){return ie},this.setPixelRatio=function(S){S!==void 0&&(ie=S,this.setSize(K,re,!1))},this.getSize=function(S){return S.set(K,re)},this.setSize=function(S,D,z=!0){if(ve.isPresenting){ye("WebGLRenderer: Can't change size while VR device is presenting.");return}K=S,re=D,t.width=Math.floor(S*ie),t.height=Math.floor(D*ie),z===!0&&(t.style.width=S+"px",t.style.height=D+"px"),b!==null&&b.setSize(t.width,t.height),this.setViewport(0,0,S,D)},this.getDrawingBufferSize=function(S){return S.set(K*ie,re*ie).floor()},this.setDrawingBufferSize=function(S,D,z){K=S,re=D,ie=z,t.width=Math.floor(S*z),t.height=Math.floor(D*z),this.setViewport(0,0,S,D)},this.setEffects=function(S){if(v===1009){Ue("WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(S){for(let D=0;D<S.length;D++)if(S[D].isOutputPass===!0){ye("WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}b.setEffects(S||[])},this.getCurrentViewport=function(S){return S.copy(te)},this.getViewport=function(S){return S.copy(be)},this.setViewport=function(S,D,z,B){S.isVector4?be.set(S.x,S.y,S.z,S.w):be.set(S,D,z,B),_.viewport(te.copy(be).multiplyScalar(ie).round())},this.getScissor=function(S){return S.copy(ot)},this.setScissor=function(S,D,z,B){S.isVector4?ot.set(S.x,S.y,S.z,S.w):ot.set(S,D,z,B),_.scissor(ne.copy(ot).multiplyScalar(ie).round())},this.getScissorTest=function(){return Ve},this.setScissorTest=function(S){_.setScissorTest(Ve=S)},this.setOpaqueSort=function(S){Ce=S},this.setTransparentSort=function(S){Ie=S},this.getClearColor=function(S){return S.copy(Fe.getClearColor())},this.setClearColor=function(){Fe.setClearColor(...arguments)},this.getClearAlpha=function(){return Fe.getClearAlpha()},this.setClearAlpha=function(){Fe.setClearAlpha(...arguments)},this.clear=function(S=!0,D=!0,z=!0){let B=0;if(S){let V=!1;if(H!==null){const me=H.texture.format;V=p.has(me)}if(V){const me=H.texture.type,_e=m.has(me),pe=Fe.getClearColor(),Me=Fe.getClearAlpha(),Ae=pe.r,He=pe.g,ze=pe.b;_e?(E[0]=Ae,E[1]=He,E[2]=ze,E[3]=Me,N.clearBufferuiv(N.COLOR,0,E)):(R[0]=Ae,R[1]=He,R[2]=ze,R[3]=Me,N.clearBufferiv(N.COLOR,0,R))}else B|=N.COLOR_BUFFER_BIT}D&&(B|=N.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),z&&(B|=N.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),B!==0&&N.clear(B)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(S){S.setRenderer(this),U=S},this.dispose=function(){t.removeEventListener("webglcontextlost",pt,!1),t.removeEventListener("webglcontextrestored",it,!1),t.removeEventListener("webglcontextcreationerror",Kt,!1),Fe.dispose(),de.dispose(),ue.dispose(),k.dispose(),se.dispose(),Q.dispose(),fe.dispose(),ee.dispose(),ce.dispose(),ve.dispose(),ve.removeEventListener("sessionstart",vs),ve.removeEventListener("sessionend",xs),Vn.stop()};function pt(S){S.preventDefault(),xr("WebGLRenderer: Context Lost."),P=!0}function it(){xr("WebGLRenderer: Context Restored."),P=!1;const S=F.autoReset,D=Le.enabled,z=Le.autoUpdate,B=Le.needsUpdate,V=Le.type;xe(),F.autoReset=S,Le.enabled=D,Le.autoUpdate=z,Le.needsUpdate=B,Le.type=V}function Kt(S){Ue("WebGLRenderer: A WebGL context could not be created. Reason: ",S.statusMessage)}function $t(S){const D=S.target;D.removeEventListener("dispose",$t),qa(D)}function qa(S){Ya(S),k.remove(S)}function Ya(S){const D=k.get(S).programs;D!==void 0&&(D.forEach(function(z){ce.releaseProgram(z)}),S.isShaderMaterial&&ce.releaseShaderCache(S))}this.renderBufferDirect=function(S,D,z,B,V,me){D===null&&(D=Et);const _e=V.isMesh&&V.matrixWorld.determinantAffine()<0,pe=O0(S,D,z,B,V);_.setMaterial(B,_e);let Me=z.index,Ae=1;if(B.wireframe===!0){if(Me=Y.getWireframeAttribute(z),Me===void 0)return;Ae=2}const He=z.drawRange,ze=z.attributes.position;let we=He.start*Ae,at=(He.start+He.count)*Ae;me!==null&&(we=Math.max(we,me.start*Ae),at=Math.min(at,(me.start+me.count)*Ae)),Me!==null?(we=Math.max(we,0),at=Math.min(at,Me.count)):ze!=null&&(we=Math.max(we,0),at=Math.min(at,ze.count));const St=at-we;if(St<0||St===1/0)return;fe.setup(V,B,pe,z,Me);let _t,lt=ae;if(Me!==null&&(_t=oe.get(Me),lt=J,lt.setIndex(_t)),V.isMesh)B.wireframe===!0?(_.setLineWidth(B.wireframeLinewidth*Mt()),lt.setMode(N.LINES)):lt.setMode(N.TRIANGLES);else if(V.isLine){let Nt=B.linewidth;Nt===void 0&&(Nt=1),_.setLineWidth(Nt*Mt()),V.isLineSegments?lt.setMode(N.LINES):V.isLineLoop?lt.setMode(N.LINE_LOOP):lt.setMode(N.LINE_STRIP)}else V.isPoints?lt.setMode(N.POINTS):V.isSprite&&lt.setMode(N.TRIANGLES);if(V.isBatchedMesh)if(je.get("WEBGL_multi_draw"))lt.renderMultiDraw(V._multiDrawStarts,V._multiDrawCounts,V._multiDrawCount);else{const Nt=V._multiDrawStarts,ge=V._multiDrawCounts,zt=V._multiDrawCount,Ze=Me?oe.get(Me).bytesPerElement:1,Zt=k.get(B).currentProgram.getUniforms();for(let xn=0;xn<zt;xn++)Zt.setValue(N,"_gl_DrawID",xn),lt.render(Nt[xn]/Ze,ge[xn])}else if(V.isInstancedMesh)lt.renderInstances(we,St,V.count);else if(z.isInstancedBufferGeometry){const Nt=z._maxInstanceCount!==void 0?z._maxInstanceCount:1/0,ge=Math.min(z.instanceCount,Nt);lt.renderInstances(we,St,ge)}else lt.render(we,St)};function gs(S,D,z){S.transparent===!0&&S.side===2&&S.forceSinglePass===!1?(S.side=1,S.needsUpdate=!0,Oi(S,D,z),S.side=0,S.needsUpdate=!0,Oi(S,D,z),S.side=2):Oi(S,D,z)}this.compile=function(S,D,z=null){z===null&&(z=S),y=ue.get(z),y.init(D),x.push(y),z.traverseVisible(function(V){V.isLight&&V.layers.test(D.layers)&&(y.pushLight(V),V.castShadow&&y.pushShadow(V))}),S!==z&&S.traverseVisible(function(V){V.isLight&&V.layers.test(D.layers)&&(y.pushLight(V),V.castShadow&&y.pushShadow(V))}),y.setupLights();const B=new Set;return S.traverse(function(V){if(!(V.isMesh||V.isPoints||V.isLine||V.isSprite))return;const me=V.material;if(me)if(Array.isArray(me))for(let _e=0;_e<me.length;_e++){const pe=me[_e];gs(pe,z,V),B.add(pe)}else gs(me,z,V),B.add(me)}),y=x.pop(),B},this.compileAsync=function(S,D,z=null){const B=this.compile(S,D,z);return new Promise(V=>{function me(){if(B.forEach(function(_e){k.get(_e).currentProgram.isReady()&&B.delete(_e)}),B.size===0){V(S);return}setTimeout(me,10)}je.get("KHR_parallel_shader_compile")!==null?me():setTimeout(me,10)})};let ri=null;function _s(S){ri&&ri(S)}function vs(){Vn.stop()}function xs(){Vn.start()}const Vn=new tl;Vn.setAnimationLoop(_s),typeof self<"u"&&Vn.setContext(self),this.setAnimationLoop=function(S){ri=S,ve.setAnimationLoop(S),S===null?Vn.stop():Vn.start()},ve.addEventListener("sessionstart",vs),ve.addEventListener("sessionend",xs),this.render=function(S,D){if(D!==void 0&&D.isCamera!==!0){Ue("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(P===!0)return;U!==null&&U.renderStart(S,D);const z=ve.enabled===!0&&ve.isPresenting===!0,B=b!==null&&(H===null||z)&&b.begin(L,H);if(S.matrixWorldAutoUpdate===!0&&S.updateMatrixWorld(),D.parent===null&&D.matrixWorldAutoUpdate===!0&&D.updateMatrixWorld(),ve.enabled===!0&&ve.isPresenting===!0&&(b===null||b.isCompositing()===!1)&&(ve.cameraAutoUpdate===!0&&ve.updateCamera(D),D=ve.getCamera()),S.isScene===!0&&S.onBeforeRender(L,S,D,H),y=ue.get(S,x.length),y.init(D),y.state.textureUnits=X.getTextureUnits(),x.push(y),ut.multiplyMatrices(D.projectionMatrix,D.matrixWorldInverse),$e.setFromProjectionMatrix(ut,2e3,D.reversedDepth),Xe=this.localClippingEnabled,Ke=Re.init(this.clippingPlanes,Xe),T=de.get(S,w.length),T.init(),w.push(T),ve.enabled===!0&&ve.isPresenting===!0){const _e=L.xr.getDepthSensingMesh();_e!==null&&pr(_e,D,-1/0,L.sortObjects)}pr(S,D,0,L.sortObjects),T.finish(),L.sortObjects===!0&&T.sort(Ce,Ie,D.reversedDepth),dt=ve.enabled===!1||ve.isPresenting===!1||ve.hasDepthSensing()===!1,dt&&Fe.addToRenderList(T,S),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),Ke===!0&&Re.beginShadows();const V=y.state.shadowsArray;if(Le.render(V,S,D),Ke===!0&&Re.endShadows(),(B&&b.hasRenderPass())===!1){const _e=T.opaque,pe=T.transmissive;if(y.setupLights(),D.isArrayCamera){const Me=D.cameras;if(pe.length>0)for(let Ae=0,He=Me.length;Ae<He;Ae++){const ze=Me[Ae];Ms(_e,pe,S,ze)}dt&&Fe.render(S);for(let Ae=0,He=Me.length;Ae<He;Ae++){const ze=Me[Ae];mr(T,S,ze,ze.viewport)}}else pe.length>0&&Ms(_e,pe,S,D),dt&&Fe.render(S),mr(T,S,D)}H!==null&&G===0&&(X.updateMultisampleRenderTarget(H),X.updateRenderTargetMipmap(H)),B&&b.end(L),S.isScene===!0&&S.onAfterRender(L,S,D),fe.resetDefaultState(),Z=-1,j=null,x.pop(),x.length>0?(y=x[x.length-1],X.setTextureUnits(y.state.textureUnits),Ke===!0&&Re.setGlobalState(L.clippingPlanes,y.state.camera)):y=null,w.pop(),w.length>0?T=w[w.length-1]:T=null,U!==null&&U.renderEnd()};function pr(S,D,z,B){if(S.visible===!1)return;if(S.layers.test(D.layers)){if(S.isGroup)z=S.renderOrder;else if(S.isLOD)S.autoUpdate===!0&&S.update(D);else if(S.isLightProbeGrid)y.pushLightProbeGrid(S);else if(S.isLight)y.pushLight(S),S.castShadow&&y.pushShadow(S);else if(S.isSprite){if(!S.frustumCulled||$e.intersectsSprite(S)){B&&xt.setFromMatrixPosition(S.matrixWorld).applyMatrix4(ut);const _e=Q.update(S),pe=S.material;pe.visible&&T.push(S,_e,pe,z,xt.z,null)}}else if((S.isMesh||S.isLine||S.isPoints)&&(!S.frustumCulled||$e.intersectsObject(S))){const _e=Q.update(S),pe=S.material;if(B&&(S.boundingSphere!==void 0?(S.boundingSphere===null&&S.computeBoundingSphere(),xt.copy(S.boundingSphere.center)):(_e.boundingSphere===null&&_e.computeBoundingSphere(),xt.copy(_e.boundingSphere.center)),xt.applyMatrix4(S.matrixWorld).applyMatrix4(ut)),Array.isArray(pe)){const Me=_e.groups;for(let Ae=0,He=Me.length;Ae<He;Ae++){const ze=Me[Ae],we=pe[ze.materialIndex];we&&we.visible&&T.push(S,_e,we,z,xt.z,ze)}}else pe.visible&&T.push(S,_e,pe,z,xt.z,null)}}const me=S.children;for(let _e=0,pe=me.length;_e<pe;_e++)pr(me[_e],D,z,B)}function mr(S,D,z,B){const{opaque:V,transmissive:me,transparent:_e}=S;y.setupLightsView(z),Ke===!0&&Re.setGlobalState(L.clippingPlanes,z),B&&_.viewport(te.copy(B)),V.length>0&&Fi(V,D,z),me.length>0&&Fi(me,D,z),_e.length>0&&Fi(_e,D,z),_.buffers.depth.setTest(!0),_.buffers.depth.setMask(!0),_.buffers.color.setMask(!0),_.setPolygonOffset(!1)}function Ms(S,D,z,B){if((z.isScene===!0?z.overrideMaterial:null)!==null)return;if(y.state.transmissionRenderTarget[B.id]===void 0){const we=je.has("EXT_color_buffer_half_float")||je.has("EXT_color_buffer_float");y.state.transmissionRenderTarget[B.id]=new ln(1,1,{generateMipmaps:!0,type:we?1016:1009,minFilter:1008,samples:Math.max(4,A.samples),stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Ye.workingColorSpace})}const me=y.state.transmissionRenderTarget[B.id],_e=B.viewport||te;me.setSize(_e.z*L.transmissionResolutionScale,_e.w*L.transmissionResolutionScale);const pe=L.getRenderTarget(),Me=L.getActiveCubeFace(),Ae=L.getActiveMipmapLevel();L.setRenderTarget(me),L.getClearColor(De),Oe=L.getClearAlpha(),Oe<1&&L.setClearColor(16777215,.5),L.clear(),dt&&Fe.render(z);const He=L.toneMapping;L.toneMapping=0;const ze=B.viewport;if(B.viewport!==void 0&&(B.viewport=void 0),y.setupLightsView(B),Ke===!0&&Re.setGlobalState(L.clippingPlanes,B),Fi(S,z,B),X.updateMultisampleRenderTarget(me),X.updateRenderTargetMipmap(me),je.has("WEBGL_multisampled_render_to_texture")===!1){let we=!1;for(let at=0,St=D.length;at<St;at++){const _t=D[at],{object:lt,geometry:Nt,material:ge,group:zt}=_t;if(ge.side===2&&lt.layers.test(B.layers)){const Ze=ge.side;ge.side=1,ge.needsUpdate=!0,si(lt,z,B,Nt,ge,zt),ge.side=Ze,ge.needsUpdate=!0,we=!0}}we===!0&&(X.updateMultisampleRenderTarget(me),X.updateRenderTargetMipmap(me))}L.setRenderTarget(pe,Me,Ae),L.setClearColor(De,Oe),ze!==void 0&&(B.viewport=ze),L.toneMapping=He}function Fi(S,D,z){const B=D.isScene===!0?D.overrideMaterial:null;for(let V=0,me=S.length;V<me;V++){const _e=S[V],{object:pe,geometry:Me,group:Ae}=_e;let He=_e.material;He.allowOverride===!0&&B!==null&&(He=B),pe.layers.test(z.layers)&&si(pe,D,z,Me,He,Ae)}}function si(S,D,z,B,V,me){S.onBeforeRender(L,D,z,B,V,me),S.modelViewMatrix.multiplyMatrices(z.matrixWorldInverse,S.matrixWorld),S.normalMatrix.getNormalMatrix(S.modelViewMatrix),V.onBeforeRender(L,D,z,B,S,me),V.transparent===!0&&V.side===2&&V.forceSinglePass===!1?(V.side=1,V.needsUpdate=!0,L.renderBufferDirect(z,D,B,V,S,me),V.side=0,V.needsUpdate=!0,L.renderBufferDirect(z,D,B,V,S,me),V.side=2):L.renderBufferDirect(z,D,B,V,S,me),S.onAfterRender(L,D,z,B,V,me)}function Oi(S,D,z){D.isScene!==!0&&(D=Et);const B=k.get(S),V=y.state.lights,me=y.state.shadowsArray,_e=V.state.version,pe=ce.getParameters(S,V.state,me,D,z,y.state.lightProbeGridArray),Me=ce.getProgramCacheKey(pe);let Ae=B.programs;B.environment=S.isMeshStandardMaterial||S.isMeshLambertMaterial||S.isMeshPhongMaterial?D.environment:null,B.fog=D.fog;const He=S.isMeshStandardMaterial||S.isMeshLambertMaterial&&!S.envMap||S.isMeshPhongMaterial&&!S.envMap;B.envMap=se.get(S.envMap||B.environment,He),B.envMapRotation=B.environment!==null&&S.envMap===null?D.environmentRotation:S.envMapRotation,Ae===void 0&&(S.addEventListener("dispose",$t),Ae=new Map,B.programs=Ae);let ze=Ae.get(Me);if(ze!==void 0){if(B.currentProgram===ze&&B.lightsStateVersion===_e)return gr(S,pe),ze}else pe.uniforms=ce.getUniforms(S),U!==null&&S.isNodeMaterial&&U.build(S,z,pe),S.onBeforeCompile(pe,L),ze=ce.acquireProgram(pe,Me),Ae.set(Me,ze),B.uniforms=pe.uniforms;const we=B.uniforms;return(!S.isShaderMaterial&&!S.isRawShaderMaterial||S.clipping===!0)&&(we.clippingPlanes=Re.uniform),gr(S,pe),B.needsLights=V0(S),B.lightsStateVersion=_e,B.needsLights&&(we.ambientLightColor.value=V.state.ambient,we.lightProbe.value=V.state.probe,we.directionalLights.value=V.state.directional,we.directionalLightShadows.value=V.state.directionalShadow,we.spotLights.value=V.state.spot,we.spotLightShadows.value=V.state.spotShadow,we.rectAreaLights.value=V.state.rectArea,we.ltc_1.value=V.state.rectAreaLTC1,we.ltc_2.value=V.state.rectAreaLTC2,we.pointLights.value=V.state.point,we.pointLightShadows.value=V.state.pointShadow,we.hemisphereLights.value=V.state.hemi,we.directionalShadowMatrix.value=V.state.directionalShadowMatrix,we.spotLightMatrix.value=V.state.spotLightMatrix,we.spotLightMap.value=V.state.spotLightMap,we.pointShadowMatrix.value=V.state.pointShadowMatrix),B.lightProbeGrid=y.state.lightProbeGridArray.length>0,B.currentProgram=ze,B.uniformsList=null,ze}function Ss(S){if(S.uniformsList===null){const D=S.currentProgram.getUniforms();S.uniformsList=is.seqWithValue(D.seq,S.uniforms)}return S.uniformsList}function gr(S,D){const z=k.get(S);z.outputColorSpace=D.outputColorSpace,z.batching=D.batching,z.batchingColor=D.batchingColor,z.instancing=D.instancing,z.instancingColor=D.instancingColor,z.instancingMorph=D.instancingMorph,z.skinning=D.skinning,z.morphTargets=D.morphTargets,z.morphNormals=D.morphNormals,z.morphColors=D.morphColors,z.morphTargetsCount=D.morphTargetsCount,z.numClippingPlanes=D.numClippingPlanes,z.numIntersection=D.numClipIntersection,z.vertexAlphas=D.vertexAlphas,z.vertexTangents=D.vertexTangents,z.toneMapping=D.toneMapping}function Ka(S,D){if(S.length===0)return null;if(S.length===1)return S[0].texture!==null?S[0]:null;M.setFromMatrixPosition(D.matrixWorld);for(let z=0,B=S.length;z<B;z++){const V=S[z];if(V.texture!==null&&V.boundingBox.containsPoint(M))return V}return null}function O0(S,D,z,B,V){D.isScene!==!0&&(D=Et),X.resetTextureUnits();const me=D.fog,_e=B.isMeshStandardMaterial||B.isMeshLambertMaterial||B.isMeshPhongMaterial?D.environment:null,pe=H===null?L.outputColorSpace:H.isXRRenderTarget===!0?H.texture.colorSpace:Ye.workingColorSpace,Me=B.isMeshStandardMaterial||B.isMeshLambertMaterial&&!B.envMap||B.isMeshPhongMaterial&&!B.envMap,Ae=se.get(B.envMap||_e,Me),He=B.vertexColors===!0&&!!z.attributes.color&&z.attributes.color.itemSize===4,ze=!!z.attributes.tangent&&(!!B.normalMap||B.anisotropy>0),we=!!z.morphAttributes.position,at=!!z.morphAttributes.normal,St=!!z.morphAttributes.color;let _t=0;B.toneMapped&&(H===null||H.isXRRenderTarget===!0)&&(_t=L.toneMapping);const lt=z.morphAttributes.position||z.morphAttributes.normal||z.morphAttributes.color,Nt=lt!==void 0?lt.length:0,ge=k.get(B),zt=y.state.lights;if(Ke===!0&&(Xe===!0||S!==j)){const ht=S===j&&B.id===Z;Re.setState(B,S,ht)}let Ze=!1;B.version===ge.__version?(ge.needsLights&&ge.lightsStateVersion!==zt.state.version||ge.outputColorSpace!==pe||V.isBatchedMesh&&ge.batching===!1||!V.isBatchedMesh&&ge.batching===!0||V.isBatchedMesh&&ge.batchingColor===!0&&V.colorTexture===null||V.isBatchedMesh&&ge.batchingColor===!1&&V.colorTexture!==null||V.isInstancedMesh&&ge.instancing===!1||!V.isInstancedMesh&&ge.instancing===!0||V.isSkinnedMesh&&ge.skinning===!1||!V.isSkinnedMesh&&ge.skinning===!0||V.isInstancedMesh&&ge.instancingColor===!0&&V.instanceColor===null||V.isInstancedMesh&&ge.instancingColor===!1&&V.instanceColor!==null||V.isInstancedMesh&&ge.instancingMorph===!0&&V.morphTexture===null||V.isInstancedMesh&&ge.instancingMorph===!1&&V.morphTexture!==null||ge.envMap!==Ae||B.fog===!0&&ge.fog!==me||ge.numClippingPlanes!==void 0&&(ge.numClippingPlanes!==Re.numPlanes||ge.numIntersection!==Re.numIntersection)||ge.vertexAlphas!==He||ge.vertexTangents!==ze||ge.morphTargets!==we||ge.morphNormals!==at||ge.morphColors!==St||ge.toneMapping!==_t||ge.morphTargetsCount!==Nt||!!ge.lightProbeGrid!=y.state.lightProbeGridArray.length>0)&&(Ze=!0):(Ze=!0,ge.__version=B.version);let Zt=ge.currentProgram;Ze===!0&&(Zt=Oi(B,D,V),U&&B.isNodeMaterial&&U.onUpdateProgram(B,Zt,ge));let xn=!1,kn=!1,Bi=!1;const ct=Zt.getUniforms(),yt=ge.uniforms;if(_.useProgram(Zt.program)&&(xn=!0,kn=!0,Bi=!0),B.id!==Z&&(Z=B.id,kn=!0),ge.needsLights){const ht=Ka(y.state.lightProbeGridArray,V);ge.lightProbeGrid!==ht&&(ge.lightProbeGrid=ht,kn=!0)}if(xn||j!==S){_.buffers.depth.getReversed()&&S.reversedDepth!==!0&&(S._reversedDepth=!0,S.updateProjectionMatrix()),ct.setValue(N,"projectionMatrix",S.projectionMatrix),ct.setValue(N,"viewMatrix",S.matrixWorldInverse);const Gn=ct.map.cameraPosition;Gn!==void 0&&Gn.setValue(N,ft.setFromMatrixPosition(S.matrixWorld)),A.logarithmicDepthBuffer&&ct.setValue(N,"logDepthBufFC",2/(Math.log(S.far+1)/Math.LN2)),(B.isMeshPhongMaterial||B.isMeshToonMaterial||B.isMeshLambertMaterial||B.isMeshBasicMaterial||B.isMeshStandardMaterial||B.isShaderMaterial)&&ct.setValue(N,"isOrthographic",S.isOrthographicCamera===!0),j!==S&&(j=S,kn=!0,Bi=!0)}if(ge.needsLights&&(zt.state.directionalShadowMap.length>0&&ct.setValue(N,"directionalShadowMap",zt.state.directionalShadowMap,X),zt.state.spotShadowMap.length>0&&ct.setValue(N,"spotShadowMap",zt.state.spotShadowMap,X),zt.state.pointShadowMap.length>0&&ct.setValue(N,"pointShadowMap",zt.state.pointShadowMap,X)),V.isSkinnedMesh){ct.setOptional(N,V,"bindMatrix"),ct.setOptional(N,V,"bindMatrixInverse");const ht=V.skeleton;ht&&(ht.boneTexture===null&&ht.computeBoneTexture(),ct.setValue(N,"boneTexture",ht.boneTexture,X))}V.isBatchedMesh&&(ct.setOptional(N,V,"batchingTexture"),ct.setValue(N,"batchingTexture",V._matricesTexture,X),ct.setOptional(N,V,"batchingIdTexture"),ct.setValue(N,"batchingIdTexture",V._indirectTexture,X),ct.setOptional(N,V,"batchingColorTexture"),V._colorsTexture!==null&&ct.setValue(N,"batchingColorTexture",V._colorsTexture,X));const Hn=z.morphAttributes;if((Hn.position!==void 0||Hn.normal!==void 0||Hn.color!==void 0)&&I.update(V,z,Zt),(kn||ge.receiveShadow!==V.receiveShadow)&&(ge.receiveShadow=V.receiveShadow,ct.setValue(N,"receiveShadow",V.receiveShadow)),(B.isMeshStandardMaterial||B.isMeshLambertMaterial||B.isMeshPhongMaterial)&&B.envMap===null&&D.environment!==null&&(yt.envMapIntensity.value=D.environmentIntensity),yt.dfgLUT!==void 0&&(yt.dfgLUT.value=zm()),kn){if(ct.setValue(N,"toneMappingExposure",L.toneMappingExposure),ge.needsLights&&B0(yt,Bi),me&&B.fog===!0&&Se.refreshFogUniforms(yt,me),Se.refreshMaterialUniforms(yt,B,ie,re,y.state.transmissionRenderTarget[S.id]),ge.needsLights&&ge.lightProbeGrid){const ht=ge.lightProbeGrid;yt.probesSH.value=ht.texture,yt.probesMin.value.copy(ht.boundingBox.min),yt.probesMax.value.copy(ht.boundingBox.max),yt.probesResolution.value.copy(ht.resolution)}is.upload(N,Ss(ge),yt,X)}if(B.isShaderMaterial&&B.uniformsNeedUpdate===!0&&(is.upload(N,Ss(ge),yt,X),B.uniformsNeedUpdate=!1),B.isSpriteMaterial&&ct.setValue(N,"center",V.center),ct.setValue(N,"modelViewMatrix",V.modelViewMatrix),ct.setValue(N,"normalMatrix",V.normalMatrix),ct.setValue(N,"modelMatrix",V.matrixWorld),B.uniformsGroups!==void 0){const ht=B.uniformsGroups;for(let Gn=0,Vi=ht.length;Gn<Vi;Gn++){const Bc=ht[Gn];ee.update(Bc,Zt),ee.bind(Bc,Zt)}}return Zt}function B0(S,D){S.ambientLightColor.needsUpdate=D,S.lightProbe.needsUpdate=D,S.directionalLights.needsUpdate=D,S.directionalLightShadows.needsUpdate=D,S.pointLights.needsUpdate=D,S.pointLightShadows.needsUpdate=D,S.spotLights.needsUpdate=D,S.spotLightShadows.needsUpdate=D,S.rectAreaLights.needsUpdate=D,S.hemisphereLights.needsUpdate=D}function V0(S){return S.isMeshLambertMaterial||S.isMeshToonMaterial||S.isMeshPhongMaterial||S.isMeshStandardMaterial||S.isShadowMaterial||S.isShaderMaterial&&S.lights===!0}this.getActiveCubeFace=function(){return W},this.getActiveMipmapLevel=function(){return G},this.getRenderTarget=function(){return H},this.setRenderTargetTextures=function(S,D,z){const B=k.get(S);B.__autoAllocateDepthBuffer=S.resolveDepthBuffer===!1,B.__autoAllocateDepthBuffer===!1&&(B.__useRenderToTexture=!1),k.get(S.texture).__webglTexture=D,k.get(S.depthTexture).__webglTexture=B.__autoAllocateDepthBuffer?void 0:z,B.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(S,D){const z=k.get(S);z.__webglFramebuffer=D,z.__useDefaultFramebuffer=D===void 0},this.setRenderTarget=function(S,D=0,z=0){H=S,W=D,G=z;let B=null,V=!1,me=!1;if(S){const pe=k.get(S);if(pe.__useDefaultFramebuffer!==void 0){_.bindFramebuffer(N.FRAMEBUFFER,pe.__webglFramebuffer),te.copy(S.viewport),ne.copy(S.scissor),Ee=S.scissorTest,_.viewport(te),_.scissor(ne),_.setScissorTest(Ee),Z=-1;return}else if(pe.__webglFramebuffer===void 0)X.setupRenderTarget(S);else if(pe.__hasExternalTextures)X.rebindTextures(S,k.get(S.texture).__webglTexture,k.get(S.depthTexture).__webglTexture);else if(S.depthBuffer){const He=S.depthTexture;if(pe.__boundDepthTexture!==He){if(He!==null&&k.has(He)&&(S.width!==He.image.width||S.height!==He.image.height))throw new Error("THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.");X.setupDepthRenderbuffer(S)}}const Me=S.texture;(Me.isData3DTexture||Me.isDataArrayTexture||Me.isCompressedArrayTexture)&&(me=!0);const Ae=k.get(S).__webglFramebuffer;S.isWebGLCubeRenderTarget?(Array.isArray(Ae[D])?B=Ae[D][z]:B=Ae[D],V=!0):S.samples>0&&X.useMultisampledRTT(S)===!1?B=k.get(S).__webglMultisampledFramebuffer:Array.isArray(Ae)?B=Ae[z]:B=Ae,te.copy(S.viewport),ne.copy(S.scissor),Ee=S.scissorTest}else te.copy(be).multiplyScalar(ie).floor(),ne.copy(ot).multiplyScalar(ie).floor(),Ee=Ve;if(z!==0&&(B=q),_.bindFramebuffer(N.FRAMEBUFFER,B)&&_.drawBuffers(S,B),_.viewport(te),_.scissor(ne),_.setScissorTest(Ee),V){const pe=k.get(S.texture);N.framebufferTexture2D(N.FRAMEBUFFER,N.COLOR_ATTACHMENT0,N.TEXTURE_CUBE_MAP_POSITIVE_X+D,pe.__webglTexture,z)}else if(me){const pe=D;for(let Me=0;Me<S.textures.length;Me++){const Ae=k.get(S.textures[Me]);N.framebufferTextureLayer(N.FRAMEBUFFER,N.COLOR_ATTACHMENT0+Me,Ae.__webglTexture,z,pe)}}else if(S!==null&&z!==0){const pe=k.get(S.texture);N.framebufferTexture2D(N.FRAMEBUFFER,N.COLOR_ATTACHMENT0,N.TEXTURE_2D,pe.__webglTexture,z)}Z=-1},this.readRenderTargetPixels=function(S,D,z,B,V,me,_e,pe=0){if(!(S&&S.isWebGLRenderTarget)){Ue("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Me=k.get(S).__webglFramebuffer;if(S.isWebGLCubeRenderTarget&&_e!==void 0&&(Me=Me[_e]),Me){_.bindFramebuffer(N.FRAMEBUFFER,Me);try{const Ae=S.textures[pe],He=Ae.format,ze=Ae.type;if(S.textures.length>1&&N.readBuffer(N.COLOR_ATTACHMENT0+pe),!A.textureFormatReadable(He)){Ue("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!A.textureTypeReadable(ze)){Ue("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}D>=0&&D<=S.width-B&&z>=0&&z<=S.height-V&&N.readPixels(D,z,B,V,he.convert(He),he.convert(ze),me)}finally{const Ae=H!==null?k.get(H).__webglFramebuffer:null;_.bindFramebuffer(N.FRAMEBUFFER,Ae)}}},this.readRenderTargetPixelsAsync=async function(S,D,z,B,V,me,_e,pe=0){if(!(S&&S.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Me=k.get(S).__webglFramebuffer;if(S.isWebGLCubeRenderTarget&&_e!==void 0&&(Me=Me[_e]),Me)if(D>=0&&D<=S.width-B&&z>=0&&z<=S.height-V){_.bindFramebuffer(N.FRAMEBUFFER,Me);const Ae=S.textures[pe],He=Ae.format,ze=Ae.type;if(S.textures.length>1&&N.readBuffer(N.COLOR_ATTACHMENT0+pe),!A.textureFormatReadable(He))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!A.textureTypeReadable(ze))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const we=N.createBuffer();N.bindBuffer(N.PIXEL_PACK_BUFFER,we),N.bufferData(N.PIXEL_PACK_BUFFER,me.byteLength,N.STREAM_READ),N.readPixels(D,z,B,V,he.convert(He),he.convert(ze),0);const at=H!==null?k.get(H).__webglFramebuffer:null;_.bindFramebuffer(N.FRAMEBUFFER,at);const St=N.fenceSync(N.SYNC_GPU_COMMANDS_COMPLETE,0);return N.flush(),await Zc(N,St,4),N.bindBuffer(N.PIXEL_PACK_BUFFER,we),N.getBufferSubData(N.PIXEL_PACK_BUFFER,0,me),N.deleteBuffer(we),N.deleteSync(St),me}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(S,D=null,z=0){const B=Math.pow(2,-z),V=Math.floor(S.image.width*B),me=Math.floor(S.image.height*B),_e=D!==null?D.x:0,pe=D!==null?D.y:0;X.setTexture2D(S,0),N.copyTexSubImage2D(N.TEXTURE_2D,z,0,0,_e,pe,V,me),_.unbindTexture()},this.copyTextureToTexture=function(S,D,z=null,B=null,V=0,me=0){let _e,pe,Me,Ae,He,ze,we,at,St;const _t=S.isCompressedTexture?S.mipmaps[me]:S.image;if(z!==null)_e=z.max.x-z.min.x,pe=z.max.y-z.min.y,Me=z.isBox3?z.max.z-z.min.z:1,Ae=z.min.x,He=z.min.y,ze=z.isBox3?z.min.z:0;else{const yt=Math.pow(2,-V);_e=Math.floor(_t.width*yt),pe=Math.floor(_t.height*yt),S.isDataArrayTexture?Me=_t.depth:S.isData3DTexture?Me=Math.floor(_t.depth*yt):Me=1,Ae=0,He=0,ze=0}B!==null?(we=B.x,at=B.y,St=B.z):(we=0,at=0,St=0);const lt=he.convert(D.format),Nt=he.convert(D.type);let ge;D.isData3DTexture?(X.setTexture3D(D,0),ge=N.TEXTURE_3D):D.isDataArrayTexture||D.isCompressedArrayTexture?(X.setTexture2DArray(D,0),ge=N.TEXTURE_2D_ARRAY):(X.setTexture2D(D,0),ge=N.TEXTURE_2D),_.activeTexture(N.TEXTURE0),_.pixelStorei(N.UNPACK_FLIP_Y_WEBGL,D.flipY),_.pixelStorei(N.UNPACK_PREMULTIPLY_ALPHA_WEBGL,D.premultiplyAlpha),_.pixelStorei(N.UNPACK_ALIGNMENT,D.unpackAlignment);const zt=_.getParameter(N.UNPACK_ROW_LENGTH),Ze=_.getParameter(N.UNPACK_IMAGE_HEIGHT),Zt=_.getParameter(N.UNPACK_SKIP_PIXELS),xn=_.getParameter(N.UNPACK_SKIP_ROWS),kn=_.getParameter(N.UNPACK_SKIP_IMAGES);_.pixelStorei(N.UNPACK_ROW_LENGTH,_t.width),_.pixelStorei(N.UNPACK_IMAGE_HEIGHT,_t.height),_.pixelStorei(N.UNPACK_SKIP_PIXELS,Ae),_.pixelStorei(N.UNPACK_SKIP_ROWS,He),_.pixelStorei(N.UNPACK_SKIP_IMAGES,ze);const Bi=S.isDataArrayTexture||S.isData3DTexture,ct=D.isDataArrayTexture||D.isData3DTexture;if(S.isDepthTexture){const yt=k.get(S),Hn=k.get(D),ht=k.get(yt.__renderTarget),Gn=k.get(Hn.__renderTarget);_.bindFramebuffer(N.READ_FRAMEBUFFER,ht.__webglFramebuffer),_.bindFramebuffer(N.DRAW_FRAMEBUFFER,Gn.__webglFramebuffer);for(let Vi=0;Vi<Me;Vi++)Bi&&(N.framebufferTextureLayer(N.READ_FRAMEBUFFER,N.COLOR_ATTACHMENT0,k.get(S).__webglTexture,V,ze+Vi),N.framebufferTextureLayer(N.DRAW_FRAMEBUFFER,N.COLOR_ATTACHMENT0,k.get(D).__webglTexture,me,St+Vi)),N.blitFramebuffer(Ae,He,_e,pe,we,at,_e,pe,N.DEPTH_BUFFER_BIT,N.NEAREST);_.bindFramebuffer(N.READ_FRAMEBUFFER,null),_.bindFramebuffer(N.DRAW_FRAMEBUFFER,null)}else if(V!==0||S.isRenderTargetTexture||k.has(S)){const yt=k.get(S),Hn=k.get(D);_.bindFramebuffer(N.READ_FRAMEBUFFER,$),_.bindFramebuffer(N.DRAW_FRAMEBUFFER,O);for(let ht=0;ht<Me;ht++)Bi?N.framebufferTextureLayer(N.READ_FRAMEBUFFER,N.COLOR_ATTACHMENT0,yt.__webglTexture,V,ze+ht):N.framebufferTexture2D(N.READ_FRAMEBUFFER,N.COLOR_ATTACHMENT0,N.TEXTURE_2D,yt.__webglTexture,V),ct?N.framebufferTextureLayer(N.DRAW_FRAMEBUFFER,N.COLOR_ATTACHMENT0,Hn.__webglTexture,me,St+ht):N.framebufferTexture2D(N.DRAW_FRAMEBUFFER,N.COLOR_ATTACHMENT0,N.TEXTURE_2D,Hn.__webglTexture,me),V!==0?N.blitFramebuffer(Ae,He,_e,pe,we,at,_e,pe,N.COLOR_BUFFER_BIT,N.NEAREST):ct?N.copyTexSubImage3D(ge,me,we,at,St+ht,Ae,He,_e,pe):N.copyTexSubImage2D(ge,me,we,at,Ae,He,_e,pe);_.bindFramebuffer(N.READ_FRAMEBUFFER,null),_.bindFramebuffer(N.DRAW_FRAMEBUFFER,null)}else ct?S.isDataTexture||S.isData3DTexture?N.texSubImage3D(ge,me,we,at,St,_e,pe,Me,lt,Nt,_t.data):D.isCompressedArrayTexture?N.compressedTexSubImage3D(ge,me,we,at,St,_e,pe,Me,lt,_t.data):N.texSubImage3D(ge,me,we,at,St,_e,pe,Me,lt,Nt,_t):S.isDataTexture?N.texSubImage2D(N.TEXTURE_2D,me,we,at,_e,pe,lt,Nt,_t.data):S.isCompressedTexture?N.compressedTexSubImage2D(N.TEXTURE_2D,me,we,at,_t.width,_t.height,lt,_t.data):N.texSubImage2D(N.TEXTURE_2D,me,we,at,_e,pe,lt,Nt,_t);_.pixelStorei(N.UNPACK_ROW_LENGTH,zt),_.pixelStorei(N.UNPACK_IMAGE_HEIGHT,Ze),_.pixelStorei(N.UNPACK_SKIP_PIXELS,Zt),_.pixelStorei(N.UNPACK_SKIP_ROWS,xn),_.pixelStorei(N.UNPACK_SKIP_IMAGES,kn),me===0&&D.generateMipmaps&&N.generateMipmap(ge),_.unbindTexture()},this.initRenderTarget=function(S){k.get(S).__webglFramebuffer===void 0&&X.setupRenderTarget(S)},this.initTexture=function(S){S.isCubeTexture?X.setTextureCube(S,0):S.isData3DTexture?X.setTexture3D(S,0):S.isDataArrayTexture||S.isCompressedArrayTexture?X.setTexture2DArray(S,0):X.setTexture2D(S,0),_.unbindTexture()},this.resetState=function(){W=0,G=0,H=null,_.reset(),fe.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return 2e3}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=Ye._getDrawingBufferColorSpace(e),t.unpackColorSpace=Ye._getUnpackColorSpace()}}function Il(i,e){if(e===0)return console.warn("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Geometry already defined as triangles."),i;if(e===2||e===1){let t=i.getIndex();if(t===null){const a=[],o=i.getAttribute("position");if(o!==void 0){for(let l=0;l<o.count;l++)a.push(l);i.setIndex(a),t=i.getIndex()}else return console.error("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Undefined position attribute. Processing not possible."),i}const n=t.count-2,r=[];if(e===2)for(let a=1;a<=n;a++)r.push(t.getX(0)),r.push(t.getX(a)),r.push(t.getX(a+1));else for(let a=0;a<n;a++)a%2===0?(r.push(t.getX(a)),r.push(t.getX(a+1)),r.push(t.getX(a+2))):(r.push(t.getX(a+2)),r.push(t.getX(a+1)),r.push(t.getX(a)));r.length/3!==n&&console.error("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Unable to generate correct amount of triangles.");const s=i.clone();return s.setIndex(r),s.clearGroups(),s}else return console.error("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Unknown draw mode:",e),i}function Xm(i){const e=new Map,t=new Map,n=i.clone();return Nl(i,n,function(r,s){e.set(s,r),t.set(r,s)}),n.traverse(function(r){if(!r.isSkinnedMesh)return;const s=r,a=e.get(r),o=a.skeleton.bones;s.skeleton=a.skeleton.clone(),s.bindMatrix.copy(a.bindMatrix),s.skeleton.bones=o.map(function(l){return t.get(l)}),s.bind(s.skeleton,s.bindMatrix)}),n}function Nl(i,e,t){t(i,e);for(let n=0;n<i.children.length;n++)Nl(i.children[n],e.children[n],t)}class qm extends Ai{constructor(e){super(e),this.dracoLoader=null,this.ktx2Loader=null,this.meshoptDecoder=null,this.pluginCallbacks=[],this.register(function(t){return new Jm(t)}),this.register(function(t){return new Qm(t)}),this.register(function(t){return new og(t)}),this.register(function(t){return new lg(t)}),this.register(function(t){return new cg(t)}),this.register(function(t){return new eg(t)}),this.register(function(t){return new tg(t)}),this.register(function(t){return new ng(t)}),this.register(function(t){return new ig(t)}),this.register(function(t){return new Zm(t)}),this.register(function(t){return new rg(t)}),this.register(function(t){return new jm(t)}),this.register(function(t){return new ag(t)}),this.register(function(t){return new sg(t)}),this.register(function(t){return new Km(t)}),this.register(function(t){return new Dl(t,We.EXT_MESHOPT_COMPRESSION)}),this.register(function(t){return new Dl(t,We.KHR_MESHOPT_COMPRESSION)}),this.register(function(t){return new ug(t)})}load(e,t,n,r){const s=this;let a;if(this.resourcePath!=="")a=this.resourcePath;else if(this.path!==""){const c=rr.extractUrlBase(e);a=rr.resolveURL(c,this.path)}else a=rr.extractUrlBase(e);this.manager.itemStart(e);const o=function(c){r?r(c):console.error(c),s.manager.itemError(e),s.manager.itemEnd(e)},l=new Xo(this.manager);l.setPath(this.path),l.setResponseType("arraybuffer"),l.setRequestHeader(this.requestHeader),l.setWithCredentials(this.withCredentials),l.load(e,function(c){try{s.parse(c,a,function(u){t(u),s.manager.itemEnd(e)},o)}catch(u){o(u)}},n,o)}setDRACOLoader(e){return this.dracoLoader=e,this}setKTX2Loader(e){return this.ktx2Loader=e,this}setMeshoptDecoder(e){return this.meshoptDecoder=e,this}register(e){return this.pluginCallbacks.indexOf(e)===-1&&this.pluginCallbacks.push(e),this}unregister(e){return this.pluginCallbacks.indexOf(e)!==-1&&this.pluginCallbacks.splice(this.pluginCallbacks.indexOf(e),1),this}parse(e,t,n,r){let s;const a={},o={},l=new TextDecoder;if(typeof e=="string")s=JSON.parse(e);else if(e instanceof ArrayBuffer)if(l.decode(new Uint8Array(e,0,4))===Ul){try{a[We.KHR_BINARY_GLTF]=new hg(e)}catch(h){r&&r(h);return}s=JSON.parse(a[We.KHR_BINARY_GLTF].content)}else s=JSON.parse(l.decode(e));else s=e;if(s.asset===void 0||s.asset.version[0]<2){r&&r(new Error("THREE.GLTFLoader: Unsupported asset. glTF versions >=2.0 are supported."));return}const c=new Eg(s,{path:t||this.resourcePath||"",crossOrigin:this.crossOrigin,requestHeader:this.requestHeader,manager:this.manager,ktx2Loader:this.ktx2Loader,meshoptDecoder:this.meshoptDecoder});c.fileLoader.setRequestHeader(this.requestHeader);for(let u=0;u<this.pluginCallbacks.length;u++){const h=this.pluginCallbacks[u](c);h.name||console.error("THREE.GLTFLoader: Invalid plugin found: missing name"),o[h.name]=h,a[h.name]=!0}if(s.extensionsUsed)for(let u=0;u<s.extensionsUsed.length;++u){const h=s.extensionsUsed[u],d=s.extensionsRequired||[];switch(h){case We.KHR_MATERIALS_UNLIT:a[h]=new $m;break;case We.KHR_DRACO_MESH_COMPRESSION:a[h]=new dg(s,this.dracoLoader);break;case We.KHR_TEXTURE_TRANSFORM:a[h]=new fg;break;case We.KHR_MESH_QUANTIZATION:a[h]=new pg;break;default:d.indexOf(h)>=0&&o[h]===void 0&&console.warn('THREE.GLTFLoader: Unknown extension "'+h+'".')}}c.setExtensions(a),c.setPlugins(o),c.parse(n,r)}parseAsync(e,t){const n=this;return new Promise(function(r,s){n.parse(e,t,r,s)})}}function Ym(){let i={};return{get:function(e){return i[e]},add:function(e,t){i[e]=t},remove:function(e){delete i[e]},removeAll:function(){i={}}}}function vt(i,e,t){const n=i.json.materials[e];return n.extensions&&n.extensions[t]?n.extensions[t]:null}const We={KHR_BINARY_GLTF:"KHR_binary_glTF",KHR_DRACO_MESH_COMPRESSION:"KHR_draco_mesh_compression",KHR_LIGHTS_PUNCTUAL:"KHR_lights_punctual",KHR_MATERIALS_CLEARCOAT:"KHR_materials_clearcoat",KHR_MATERIALS_DISPERSION:"KHR_materials_dispersion",KHR_MATERIALS_IOR:"KHR_materials_ior",KHR_MATERIALS_SHEEN:"KHR_materials_sheen",KHR_MATERIALS_SPECULAR:"KHR_materials_specular",KHR_MATERIALS_TRANSMISSION:"KHR_materials_transmission",KHR_MATERIALS_IRIDESCENCE:"KHR_materials_iridescence",KHR_MATERIALS_ANISOTROPY:"KHR_materials_anisotropy",KHR_MATERIALS_UNLIT:"KHR_materials_unlit",KHR_MATERIALS_VOLUME:"KHR_materials_volume",KHR_TEXTURE_BASISU:"KHR_texture_basisu",KHR_TEXTURE_TRANSFORM:"KHR_texture_transform",KHR_MESH_QUANTIZATION:"KHR_mesh_quantization",KHR_MATERIALS_EMISSIVE_STRENGTH:"KHR_materials_emissive_strength",EXT_MATERIALS_BUMP:"EXT_materials_bump",EXT_TEXTURE_WEBP:"EXT_texture_webp",EXT_TEXTURE_AVIF:"EXT_texture_avif",EXT_MESHOPT_COMPRESSION:"EXT_meshopt_compression",KHR_MESHOPT_COMPRESSION:"KHR_meshopt_compression",EXT_MESH_GPU_INSTANCING:"EXT_mesh_gpu_instancing"};class Km{constructor(e){this.parser=e,this.name=We.KHR_LIGHTS_PUNCTUAL,this.cache={refs:{},uses:{}}}_markDefs(){const e=this.parser,t=this.parser.json.nodes||[];for(let n=0,r=t.length;n<r;n++){const s=t[n];s.extensions&&s.extensions[this.name]&&s.extensions[this.name].light!==void 0&&e._addNodeRef(this.cache,s.extensions[this.name].light)}}_loadLight(e){const t=this.parser,n="light:"+e;let r=t.cache.get(n);if(r)return r;const s=t.json,l=((s.extensions&&s.extensions[this.name]||{}).lights||[])[e];let c;const u=new Te(16777215);l.color!==void 0&&u.setRGB(l.color[0],l.color[1],l.color[2],Bt);const h=l.range!==void 0?l.range:0;switch(l.type){case"directional":c=new ra(u),c.target.position.set(0,0,-1),c.add(c.target);break;case"point":c=new fh(u),c.distance=h;break;case"spot":c=new hh(u),c.distance=h,l.spot=l.spot||{},l.spot.innerConeAngle=l.spot.innerConeAngle!==void 0?l.spot.innerConeAngle:0,l.spot.outerConeAngle=l.spot.outerConeAngle!==void 0?l.spot.outerConeAngle:Math.PI/4,c.angle=l.spot.outerConeAngle,c.penumbra=1-l.spot.innerConeAngle/l.spot.outerConeAngle,c.target.position.set(0,0,-1),c.add(c.target);break;default:throw new Error("THREE.GLTFLoader: Unexpected light type: "+l.type)}return c.position.set(0,0,0),mn(c,l),l.intensity!==void 0&&(c.intensity=l.intensity),c.name=t.createUniqueName(l.name||"light_"+e),r=Promise.resolve(c),t.cache.add(n,r),r}getDependency(e,t){if(e==="light")return this._loadLight(t)}createNodeAttachment(e){const t=this,n=this.parser,s=n.json.nodes[e],o=(s.extensions&&s.extensions[this.name]||{}).light;return o===void 0?null:this._loadLight(o).then(function(l){return n._getNodeRef(t.cache,o,l)})}}class $m{constructor(){this.name=We.KHR_MATERIALS_UNLIT}getMaterialType(){return An}extendParams(e,t,n){const r=[];e.color=new Te(1,1,1),e.opacity=1;const s=t.pbrMetallicRoughness;if(s){if(Array.isArray(s.baseColorFactor)){const a=s.baseColorFactor;e.color.setRGB(a[0],a[1],a[2],Bt),e.opacity=a[3]}s.baseColorTexture!==void 0&&r.push(n.assignTexture(e,"map",s.baseColorTexture,Rt))}return Promise.all(r)}}class Zm{constructor(e){this.parser=e,this.name=We.KHR_MATERIALS_EMISSIVE_STRENGTH}extendMaterialParams(e,t){const n=vt(this.parser,e,this.name);return n===null||n.emissiveStrength!==void 0&&(t.emissiveIntensity=n.emissiveStrength),Promise.resolve()}}class Jm{constructor(e){this.parser=e,this.name=We.KHR_MATERIALS_CLEARCOAT}getMaterialType(e){return vt(this.parser,e,this.name)!==null?hn:null}extendMaterialParams(e,t){const n=vt(this.parser,e,this.name);if(n===null)return Promise.resolve();const r=[];if(n.clearcoatFactor!==void 0&&(t.clearcoat=n.clearcoatFactor),n.clearcoatTexture!==void 0&&r.push(this.parser.assignTexture(t,"clearcoatMap",n.clearcoatTexture)),n.clearcoatRoughnessFactor!==void 0&&(t.clearcoatRoughness=n.clearcoatRoughnessFactor),n.clearcoatRoughnessTexture!==void 0&&r.push(this.parser.assignTexture(t,"clearcoatRoughnessMap",n.clearcoatRoughnessTexture)),n.clearcoatNormalTexture!==void 0&&(r.push(this.parser.assignTexture(t,"clearcoatNormalMap",n.clearcoatNormalTexture)),n.clearcoatNormalTexture.scale!==void 0)){const s=n.clearcoatNormalTexture.scale;t.clearcoatNormalScale=new ke(s,s)}return Promise.all(r)}}class Qm{constructor(e){this.parser=e,this.name=We.KHR_MATERIALS_DISPERSION}getMaterialType(e){return vt(this.parser,e,this.name)!==null?hn:null}extendMaterialParams(e,t){const n=vt(this.parser,e,this.name);return n===null||(t.dispersion=n.dispersion!==void 0?n.dispersion:0),Promise.resolve()}}class jm{constructor(e){this.parser=e,this.name=We.KHR_MATERIALS_IRIDESCENCE}getMaterialType(e){return vt(this.parser,e,this.name)!==null?hn:null}extendMaterialParams(e,t){const n=vt(this.parser,e,this.name);if(n===null)return Promise.resolve();const r=[];return n.iridescenceFactor!==void 0&&(t.iridescence=n.iridescenceFactor),n.iridescenceTexture!==void 0&&r.push(this.parser.assignTexture(t,"iridescenceMap",n.iridescenceTexture)),n.iridescenceIor!==void 0&&(t.iridescenceIOR=n.iridescenceIor),t.iridescenceThicknessRange===void 0&&(t.iridescenceThicknessRange=[100,400]),n.iridescenceThicknessMinimum!==void 0&&(t.iridescenceThicknessRange[0]=n.iridescenceThicknessMinimum),n.iridescenceThicknessMaximum!==void 0&&(t.iridescenceThicknessRange[1]=n.iridescenceThicknessMaximum),n.iridescenceThicknessTexture!==void 0&&r.push(this.parser.assignTexture(t,"iridescenceThicknessMap",n.iridescenceThicknessTexture)),Promise.all(r)}}class eg{constructor(e){this.parser=e,this.name=We.KHR_MATERIALS_SHEEN}getMaterialType(e){return vt(this.parser,e,this.name)!==null?hn:null}extendMaterialParams(e,t){const n=vt(this.parser,e,this.name);if(n===null)return Promise.resolve();const r=[];if(t.sheenColor=new Te(0,0,0),t.sheenRoughness=0,t.sheen=1,n.sheenColorFactor!==void 0){const s=n.sheenColorFactor;t.sheenColor.setRGB(s[0],s[1],s[2],Bt)}return n.sheenRoughnessFactor!==void 0&&(t.sheenRoughness=n.sheenRoughnessFactor),n.sheenColorTexture!==void 0&&r.push(this.parser.assignTexture(t,"sheenColorMap",n.sheenColorTexture,Rt)),n.sheenRoughnessTexture!==void 0&&r.push(this.parser.assignTexture(t,"sheenRoughnessMap",n.sheenRoughnessTexture)),Promise.all(r)}}class tg{constructor(e){this.parser=e,this.name=We.KHR_MATERIALS_TRANSMISSION}getMaterialType(e){return vt(this.parser,e,this.name)!==null?hn:null}extendMaterialParams(e,t){const n=vt(this.parser,e,this.name);if(n===null)return Promise.resolve();const r=[];return n.transmissionFactor!==void 0&&(t.transmission=n.transmissionFactor),n.transmissionTexture!==void 0&&r.push(this.parser.assignTexture(t,"transmissionMap",n.transmissionTexture)),Promise.all(r)}}class ng{constructor(e){this.parser=e,this.name=We.KHR_MATERIALS_VOLUME}getMaterialType(e){return vt(this.parser,e,this.name)!==null?hn:null}extendMaterialParams(e,t){const n=vt(this.parser,e,this.name);if(n===null)return Promise.resolve();const r=[];t.thickness=n.thicknessFactor!==void 0?n.thicknessFactor:0,n.thicknessTexture!==void 0&&r.push(this.parser.assignTexture(t,"thicknessMap",n.thicknessTexture)),t.attenuationDistance=n.attenuationDistance||1/0;const s=n.attenuationColor||[1,1,1];return t.attenuationColor=new Te().setRGB(s[0],s[1],s[2],Bt),Promise.all(r)}}class ig{constructor(e){this.parser=e,this.name=We.KHR_MATERIALS_IOR}getMaterialType(e){return vt(this.parser,e,this.name)!==null?hn:null}extendMaterialParams(e,t){const n=vt(this.parser,e,this.name);return n===null||(t.ior=n.ior!==void 0?n.ior:1.5,t.ior===0&&(t.ior=1e3)),Promise.resolve()}}class rg{constructor(e){this.parser=e,this.name=We.KHR_MATERIALS_SPECULAR}getMaterialType(e){return vt(this.parser,e,this.name)!==null?hn:null}extendMaterialParams(e,t){const n=vt(this.parser,e,this.name);if(n===null)return Promise.resolve();const r=[];t.specularIntensity=n.specularFactor!==void 0?n.specularFactor:1,n.specularTexture!==void 0&&r.push(this.parser.assignTexture(t,"specularIntensityMap",n.specularTexture));const s=n.specularColorFactor||[1,1,1];return t.specularColor=new Te().setRGB(s[0],s[1],s[2],Bt),n.specularColorTexture!==void 0&&r.push(this.parser.assignTexture(t,"specularColorMap",n.specularColorTexture,Rt)),Promise.all(r)}}class sg{constructor(e){this.parser=e,this.name=We.EXT_MATERIALS_BUMP}getMaterialType(e){return vt(this.parser,e,this.name)!==null?hn:null}extendMaterialParams(e,t){const n=vt(this.parser,e,this.name);if(n===null)return Promise.resolve();const r=[];return t.bumpScale=n.bumpFactor!==void 0?n.bumpFactor:1,n.bumpTexture!==void 0&&r.push(this.parser.assignTexture(t,"bumpMap",n.bumpTexture)),Promise.all(r)}}class ag{constructor(e){this.parser=e,this.name=We.KHR_MATERIALS_ANISOTROPY}getMaterialType(e){return vt(this.parser,e,this.name)!==null?hn:null}extendMaterialParams(e,t){const n=vt(this.parser,e,this.name);if(n===null)return Promise.resolve();const r=[];return n.anisotropyStrength!==void 0&&(t.anisotropy=n.anisotropyStrength),n.anisotropyRotation!==void 0&&(t.anisotropyRotation=n.anisotropyRotation),n.anisotropyTexture!==void 0&&r.push(this.parser.assignTexture(t,"anisotropyMap",n.anisotropyTexture)),Promise.all(r)}}class og{constructor(e){this.parser=e,this.name=We.KHR_TEXTURE_BASISU}loadTexture(e){const t=this.parser,n=t.json,r=n.textures[e];if(!r.extensions||!r.extensions[this.name])return null;const s=r.extensions[this.name],a=t.options.ktx2Loader;if(!a){if(n.extensionsRequired&&n.extensionsRequired.indexOf(this.name)>=0)throw new Error("THREE.GLTFLoader: setKTX2Loader must be called before loading KTX2 textures");return null}return t.loadTextureImage(e,s.source,a)}}class lg{constructor(e){this.parser=e,this.name=We.EXT_TEXTURE_WEBP}loadTexture(e){const t=this.name,n=this.parser,r=n.json,s=r.textures[e];if(!s.extensions||!s.extensions[t])return null;const a=s.extensions[t],o=r.images[a.source];let l=n.textureLoader;if(o.uri){const c=n.options.manager.getHandler(o.uri);c!==null&&(l=c)}return n.loadTextureImage(e,a.source,l)}}class cg{constructor(e){this.parser=e,this.name=We.EXT_TEXTURE_AVIF}loadTexture(e){const t=this.name,n=this.parser,r=n.json,s=r.textures[e];if(!s.extensions||!s.extensions[t])return null;const a=s.extensions[t],o=r.images[a.source];let l=n.textureLoader;if(o.uri){const c=n.options.manager.getHandler(o.uri);c!==null&&(l=c)}return n.loadTextureImage(e,a.source,l)}}class Dl{constructor(e,t){this.name=t,this.parser=e}loadBufferView(e){const t=this.parser.json,n=t.bufferViews[e];if(n.extensions&&n.extensions[this.name]){const r=n.extensions[this.name],s=this.parser.getDependency("buffer",r.buffer),a=this.parser.options.meshoptDecoder;if(!a||!a.supported){if(t.extensionsRequired&&t.extensionsRequired.indexOf(this.name)>=0)throw new Error("THREE.GLTFLoader: setMeshoptDecoder must be called before loading compressed files");return null}return s.then(function(o){const l=r.byteOffset||0,c=r.byteLength||0,u=r.count,h=r.byteStride,d=new Uint8Array(o,l,c);return a.decodeGltfBufferAsync?a.decodeGltfBufferAsync(u,h,d,r.mode,r.filter).then(function(f){return f.buffer}):a.ready.then(function(){const f=new ArrayBuffer(u*h);return a.decodeGltfBuffer(new Uint8Array(f),u,h,d,r.mode,r.filter),f})})}else return null}}class ug{constructor(e){this.name=We.EXT_MESH_GPU_INSTANCING,this.parser=e}createNodeMesh(e){const t=this.parser.json,n=t.nodes[e];if(!n.extensions||!n.extensions[this.name]||n.mesh===void 0)return null;const r=t.meshes[n.mesh];for(const c of r.primitives)if(c.mode!==qt.TRIANGLES&&c.mode!==qt.TRIANGLE_STRIP&&c.mode!==qt.TRIANGLE_FAN&&c.mode!==void 0)return null;const a=n.extensions[this.name].attributes,o=[],l={};for(const c in a)o.push(this.parser.getDependency("accessor",a[c]).then(u=>(l[c]=u,l[c])));return o.length<1?null:(o.push(this.parser.createNodeMesh(e)),Promise.all(o).then(c=>{const u=c.pop(),h=u.isGroup?u.children:[u],d=c[0].count,f=[];for(const g of h){const v=new Ne,p=new C,m=new Be,E=new C(1,1,1),R=new Fu(g.geometry,g.material,d);for(let M=0;M<d;M++)l.TRANSLATION&&p.fromBufferAttribute(l.TRANSLATION,M),l.ROTATION&&m.fromBufferAttribute(l.ROTATION,M),l.SCALE&&E.fromBufferAttribute(l.SCALE,M),R.setMatrixAt(M,v.compose(p,m,E));for(const M in l)if(M==="_COLOR_0"){const T=l[M];R.instanceColor=new Zs(T.array,T.itemSize,T.normalized)}else M!=="TRANSLATION"&&M!=="ROTATION"&&M!=="SCALE"&&g.geometry.setAttribute(M,l[M]);st.prototype.copy.call(R,g),this.parser.assignFinalMaterial(R),f.push(R)}return u.isGroup?(u.clear(),u.add(...f),u):f[0]}))}}const Ul="glTF",lr=12,Fl={JSON:1313821514,BIN:5130562};class hg{constructor(e){this.name=We.KHR_BINARY_GLTF,this.content=null,this.body=null;const t=new DataView(e,0,lr),n=new TextDecoder;if(this.header={magic:n.decode(new Uint8Array(e.slice(0,4))),version:t.getUint32(4,!0),length:t.getUint32(8,!0)},this.header.magic!==Ul)throw new Error("THREE.GLTFLoader: Unsupported glTF-Binary header.");if(this.header.version<2)throw new Error("THREE.GLTFLoader: Legacy binary file detected.");const r=this.header.length-lr,s=new DataView(e,lr);let a=0;for(;a<r;){const o=s.getUint32(a,!0);a+=4;const l=s.getUint32(a,!0);if(a+=4,l===Fl.JSON){const c=new Uint8Array(e,lr+a,o);this.content=n.decode(c)}else if(l===Fl.BIN){const c=lr+a;this.body=e.slice(c,c+o)}a+=o}if(this.content===null)throw new Error("THREE.GLTFLoader: JSON content not found.")}}class dg{constructor(e,t){if(!t)throw new Error("THREE.GLTFLoader: No DRACOLoader instance provided.");this.name=We.KHR_DRACO_MESH_COMPRESSION,this.json=e,this.dracoLoader=t,this.dracoLoader.preload()}decodePrimitive(e,t){const n=this.json,r=this.dracoLoader,s=e.extensions[this.name].bufferView,a=e.extensions[this.name].attributes,o={},l={},c={};for(const u in a){const h=_a[u]||u.toLowerCase();o[h]=a[u]}for(const u in e.attributes){const h=_a[u]||u.toLowerCase();if(a[u]!==void 0){const d=n.accessors[e.attributes[u]],f=Ii[d.componentType];c[h]=f.name,l[h]=d.normalized===!0}}return t.getDependency("bufferView",s).then(function(u){return new Promise(function(h,d){r.decodeDracoFile(u,function(f){for(const g in f.attributes){const v=f.attributes[g],p=l[g];p!==void 0&&(v.normalized=p)}h(f)},o,c,Bt,d)})})}}class fg{constructor(){this.name=We.KHR_TEXTURE_TRANSFORM}extendTexture(e,t){return(t.texCoord===void 0||t.texCoord===e.channel)&&t.offset===void 0&&t.rotation===void 0&&t.scale===void 0||(e=e.clone(),t.texCoord!==void 0&&(e.channel=t.texCoord),t.offset!==void 0&&e.offset.fromArray(t.offset),t.rotation!==void 0&&(e.rotation=t.rotation),t.scale!==void 0&&e.repeat.fromArray(t.scale),e.needsUpdate=!0),e}}class pg{constructor(){this.name=We.KHR_MESH_QUANTIZATION}}class Ol extends Ti{constructor(e,t,n,r){super(e,t,n,r)}copySampleValue_(e){const t=this.resultBuffer,n=this.sampleValues,r=this.valueSize,s=e*r*3+r;for(let a=0;a!==r;a++)t[a]=n[s+a];return t}interpolate_(e,t,n,r){const s=this.resultBuffer,a=this.sampleValues,o=this.valueSize,l=o*2,c=o*3,u=r-t,h=(n-t)/u,d=h*h,f=d*h,g=e*c,v=g-c,p=-2*f+3*d,m=f-d,E=1-p,R=m-d+h;for(let M=0;M!==o;M++){const T=a[v+M+o],y=a[v+M+l]*u,w=a[g+M+o],x=a[g+M]*u;s[M]=E*T+R*y+p*w+m*x}return s}}const mg=new Be;class gg extends Ol{interpolate_(e,t,n,r){const s=super.interpolate_(e,t,n,r);return mg.fromArray(s).normalize().toArray(s),s}}const qt={POINTS:0,LINES:1,LINE_LOOP:2,LINE_STRIP:3,TRIANGLES:4,TRIANGLE_STRIP:5,TRIANGLE_FAN:6},Ii={5120:Int8Array,5121:Uint8Array,5122:Int16Array,5123:Uint16Array,5125:Uint32Array,5126:Float32Array},Bl={9728:1003,9729:1006,9984:1004,9985:1007,9986:1005,9987:1008},Vl={33071:1001,33648:1002,10497:1e3},ga={SCALAR:1,VEC2:2,VEC3:3,VEC4:4,MAT2:4,MAT3:9,MAT4:16},_a={POSITION:"position",NORMAL:"normal",TANGENT:"tangent",TEXCOORD_0:"uv",TEXCOORD_1:"uv1",TEXCOORD_2:"uv2",TEXCOORD_3:"uv3",COLOR_0:"color",WEIGHTS_0:"skinWeight",JOINTS_0:"skinIndex"},Fn={scale:"scale",translation:"position",rotation:"quaternion",weights:"morphTargetInfluences"},_g={CUBICSPLINE:void 0,LINEAR:2301,STEP:2300},va={OPAQUE:"OPAQUE",MASK:"MASK",BLEND:"BLEND"};function vg(i){return i.DefaultMaterial===void 0&&(i.DefaultMaterial=new ta({color:16777215,emissive:0,metalness:1,roughness:1,transparent:!1,depthTest:!0,side:0})),i.DefaultMaterial}function Jn(i,e,t){for(const n in t.extensions)i[n]===void 0&&(e.userData.gltfExtensions=e.userData.gltfExtensions||{},e.userData.gltfExtensions[n]=t.extensions[n])}function mn(i,e){e.extras!==void 0&&(typeof e.extras=="object"?Object.assign(i.userData,e.extras):console.warn("THREE.GLTFLoader: Ignoring primitive type .extras, "+e.extras))}function xg(i,e,t){let n=!1,r=!1,s=!1;for(let c=0,u=e.length;c<u;c++){const h=e[c];if(h.POSITION!==void 0&&(n=!0),h.NORMAL!==void 0&&(r=!0),h.COLOR_0!==void 0&&(s=!0),n&&r&&s)break}if(!n&&!r&&!s)return Promise.resolve(i);const a=[],o=[],l=[];for(let c=0,u=e.length;c<u;c++){const h=e[c];if(n){const d=h.POSITION!==void 0?t.getDependency("accessor",h.POSITION):i.attributes.position;a.push(d)}if(r){const d=h.NORMAL!==void 0?t.getDependency("accessor",h.NORMAL):i.attributes.normal;o.push(d)}if(s){const d=h.COLOR_0!==void 0?t.getDependency("accessor",h.COLOR_0):i.attributes.color;l.push(d)}}return Promise.all([Promise.all(a),Promise.all(o),Promise.all(l)]).then(function(c){const u=c[0],h=c[1],d=c[2];return n&&(i.morphAttributes.position=u),r&&(i.morphAttributes.normal=h),s&&(i.morphAttributes.color=d),i.morphTargetsRelative=!0,i})}function Mg(i,e){if(i.updateMorphTargets(),e.weights!==void 0)for(let t=0,n=e.weights.length;t<n;t++)i.morphTargetInfluences[t]=e.weights[t];if(e.extras&&Array.isArray(e.extras.targetNames)){const t=e.extras.targetNames;if(i.morphTargetInfluences.length===t.length){i.morphTargetDictionary={};for(let n=0,r=t.length;n<r;n++)i.morphTargetDictionary[t[n]]=n}else console.warn("THREE.GLTFLoader: Invalid extras.targetNames length. Ignoring names.")}}function Sg(i){let e;const t=i.extensions&&i.extensions[We.KHR_DRACO_MESH_COMPRESSION];if(t?e="draco:"+t.bufferView+":"+t.indices+":"+xa(t.attributes):e=i.indices+":"+xa(i.attributes)+":"+i.mode,i.targets!==void 0)for(let n=0,r=i.targets.length;n<r;n++)e+=":"+xa(i.targets[n]);return e}function xa(i){let e="";const t=Object.keys(i).sort();for(let n=0,r=t.length;n<r;n++)e+=t[n]+":"+i[t[n]]+";";return e}function Ma(i){switch(i){case Int8Array:return 1/127;case Uint8Array:return 1/255;case Int16Array:return 1/32767;case Uint16Array:return 1/65535;default:throw new Error("THREE.GLTFLoader: Unsupported normalized accessor component type.")}}function yg(i){return i.search(/\.jpe?g($|\?)/i)>0||i.search(/^data\:image\/jpeg/)===0?"image/jpeg":i.search(/\.webp($|\?)/i)>0||i.search(/^data\:image\/webp/)===0?"image/webp":i.search(/\.ktx2($|\?)/i)>0||i.search(/^data\:image\/ktx2/)===0?"image/ktx2":"image/png"}const Tg=new Ne;class Eg{constructor(e={},t={}){this.json=e,this.extensions={},this.plugins={},this.options=t,this.cache=new Ym,this.associations=new Map,this.primitiveCache={},this.nodeCache={},this.meshCache={refs:{},uses:{}},this.cameraCache={refs:{},uses:{}},this.lightCache={refs:{},uses:{}},this.sourceCache={},this.textureCache={},this.nodeNamesUsed={};let n=!1,r=-1,s=!1,a=-1;if(typeof navigator<"u"&&typeof navigator.userAgent<"u"){const o=navigator.userAgent;n=/^((?!chrome|android).)*safari/i.test(o)===!0;const l=o.match(/Version\/(\d+)/);r=n&&l?parseInt(l[1],10):-1,s=o.indexOf("Firefox")>-1,a=s?o.match(/Firefox\/([0-9]+)\./)[1]:-1}typeof createImageBitmap>"u"||n&&r<17||s&&a<98?this.textureLoader=new lh(this.options.manager):this.textureLoader=new mh(this.options.manager),this.textureLoader.setCrossOrigin(this.options.crossOrigin),this.textureLoader.setRequestHeader(this.options.requestHeader),this.fileLoader=new Xo(this.options.manager),this.fileLoader.setResponseType("arraybuffer"),this.options.crossOrigin==="use-credentials"&&this.fileLoader.setWithCredentials(!0)}setExtensions(e){this.extensions=e}setPlugins(e){this.plugins=e}parse(e,t){const n=this,r=this.json,s=this.extensions;this.cache.removeAll(),this.nodeCache={},this._invokeAll(function(a){return a._markDefs&&a._markDefs()}),Promise.all(this._invokeAll(function(a){return a.beforeRoot&&a.beforeRoot()})).then(function(){return Promise.all([n.getDependencies("scene"),n.getDependencies("animation"),n.getDependencies("camera")])}).then(function(a){const o={scene:a[0][r.scene||0],scenes:a[0],animations:a[1],cameras:a[2],asset:r.asset,parser:n,userData:{}};return Jn(s,o,r),mn(o,r),Promise.all(n._invokeAll(function(l){return l.afterRoot&&l.afterRoot(o)})).then(function(){for(const l of o.scenes)l.updateMatrixWorld();e(o)})}).catch(t)}_markDefs(){const e=this.json.nodes||[],t=this.json.skins||[],n=this.json.meshes||[];for(let r=0,s=t.length;r<s;r++){const a=t[r].joints;for(let o=0,l=a.length;o<l;o++)e[a[o]].isBone=!0}for(let r=0,s=e.length;r<s;r++){const a=e[r];a.mesh!==void 0&&(this._addNodeRef(this.meshCache,a.mesh),a.skin!==void 0&&(n[a.mesh].isSkinnedMesh=!0)),a.camera!==void 0&&this._addNodeRef(this.cameraCache,a.camera)}}_addNodeRef(e,t){t!==void 0&&(e.refs[t]===void 0&&(e.refs[t]=e.uses[t]=0),e.refs[t]++)}_getNodeRef(e,t,n){if(e.refs[t]<=1)return n;const r=n.clone(),s=(a,o)=>{const l=this.associations.get(a);l!=null&&this.associations.set(o,l);for(const[c,u]of a.children.entries())s(u,o.children[c])};return s(n,r),r.name+="_instance_"+e.uses[t]++,r}_invokeOne(e){const t=Object.values(this.plugins);t.push(this);for(let n=0;n<t.length;n++){const r=e(t[n]);if(r)return r}return null}_invokeAll(e){const t=Object.values(this.plugins);t.unshift(this);const n=[];for(let r=0;r<t.length;r++){const s=e(t[r]);s&&n.push(s)}return n}getDependency(e,t){const n=e+":"+t;let r=this.cache.get(n);if(!r){switch(e){case"scene":r=this.loadScene(t);break;case"node":r=this._invokeOne(function(s){return s.loadNode&&s.loadNode(t)});break;case"mesh":r=this._invokeOne(function(s){return s.loadMesh&&s.loadMesh(t)});break;case"accessor":r=this.loadAccessor(t);break;case"bufferView":r=this._invokeOne(function(s){return s.loadBufferView&&s.loadBufferView(t)});break;case"buffer":r=this.loadBuffer(t);break;case"material":r=this._invokeOne(function(s){return s.loadMaterial&&s.loadMaterial(t)});break;case"texture":r=this._invokeOne(function(s){return s.loadTexture&&s.loadTexture(t)});break;case"skin":r=this.loadSkin(t);break;case"animation":r=this._invokeOne(function(s){return s.loadAnimation&&s.loadAnimation(t)});break;case"camera":r=this.loadCamera(t);break;default:if(r=this._invokeOne(function(s){return s!=this&&s.getDependency&&s.getDependency(e,t)}),!r)throw new Error("Unknown type: "+e);break}this.cache.add(n,r)}return r}getDependencies(e){let t=this.cache.get(e);if(!t){const n=this,r=this.json[e+(e==="mesh"?"es":"s")]||[];t=Promise.all(r.map(function(s,a){return n.getDependency(e,a)})),this.cache.add(e,t)}return t}loadBuffer(e){const t=this.json.buffers[e],n=this.fileLoader;if(t.type&&t.type!=="arraybuffer")throw new Error("THREE.GLTFLoader: "+t.type+" buffer type is not supported.");if(t.uri===void 0&&e===0)return Promise.resolve(this.extensions[We.KHR_BINARY_GLTF].body);const r=this.options;return new Promise(function(s,a){n.load(rr.resolveURL(t.uri,r.path),s,void 0,function(){a(new Error('THREE.GLTFLoader: Failed to load buffer "'+t.uri+'".'))})})}loadBufferView(e){const t=this.json.bufferViews[e];return this.getDependency("buffer",t.buffer).then(function(n){const r=t.byteLength||0,s=t.byteOffset||0;return n.slice(s,s+r)})}loadAccessor(e){const t=this,n=this.json,r=this.json.accessors[e];if(r.bufferView===void 0&&r.sparse===void 0){const a=ga[r.type],o=Ii[r.componentType],l=r.normalized===!0,c=new o(r.count*a);return Promise.resolve(new Je(c,a,l))}const s=[];return r.bufferView!==void 0?s.push(this.getDependency("bufferView",r.bufferView)):s.push(null),r.sparse!==void 0&&(s.push(this.getDependency("bufferView",r.sparse.indices.bufferView)),s.push(this.getDependency("bufferView",r.sparse.values.bufferView))),Promise.all(s).then(function(a){const o=a[0],l=ga[r.type],c=Ii[r.componentType],u=c.BYTES_PER_ELEMENT,h=u*l,d=r.byteOffset||0,f=r.bufferView!==void 0?n.bufferViews[r.bufferView].byteStride:void 0,g=r.normalized===!0;let v,p;if(f&&f!==h){const m=Math.floor(d/f),E="InterleavedBuffer:"+r.bufferView+":"+r.componentType+":"+m+":"+r.count;let R=t.cache.get(E);R||(v=new c(o,m*f,r.count*f/u),R=new Gs(v,f/u),t.cache.add(E,R)),p=new $i(R,l,d%f/u,g)}else o===null?v=new c(r.count*l):v=new c(o,d,r.count*l),p=new Je(v,l,g);if(r.sparse!==void 0){const m=ga.SCALAR,E=Ii[r.sparse.indices.componentType],R=r.sparse.indices.byteOffset||0,M=r.sparse.values.byteOffset||0,T=new E(a[1],R,r.sparse.count*m),y=new c(a[2],M,r.sparse.count*l);o!==null&&(p=new Je(p.array.slice(),p.itemSize,p.normalized)),p.normalized=!1;for(let w=0,x=T.length;w<x;w++){const b=T[w];if(p.setX(b,y[w*l]),l>=2&&p.setY(b,y[w*l+1]),l>=3&&p.setZ(b,y[w*l+2]),l>=4&&p.setW(b,y[w*l+3]),l>=5)throw new Error("THREE.GLTFLoader: Unsupported itemSize in sparse BufferAttribute.")}p.normalized=g}return p})}loadTexture(e){const t=this.json,n=this.options,s=t.textures[e].source,a=t.images[s];let o=this.textureLoader;if(a.uri){const l=n.manager.getHandler(a.uri);l!==null&&(o=l)}return this.loadTextureImage(e,s,o)}loadTextureImage(e,t,n){const r=this,s=this.json,a=s.textures[e],o=s.images[t],l=(o.uri||o.bufferView)+":"+a.sampler;if(this.textureCache[l])return this.textureCache[l];const c=this.loadImageSource(t,n).then(function(u){u.flipY=!1,u.name=a.name||o.name||"",u.name===""&&typeof o.uri=="string"&&o.uri.startsWith("data:image/")===!1&&(u.name=o.uri);const d=(s.samplers||{})[a.sampler]||{};return u.magFilter=Bl[d.magFilter]||1006,u.minFilter=Bl[d.minFilter]||1008,u.wrapS=Vl[d.wrapS]||1e3,u.wrapT=Vl[d.wrapT]||1e3,u.generateMipmaps=!u.isCompressedTexture&&u.minFilter!==1003&&u.minFilter!==1006,r.associations.set(u,{textures:e}),u}).catch(function(){return null});return this.textureCache[l]=c,c}loadImageSource(e,t){const n=this,r=this.json,s=this.options;if(this.sourceCache[e]!==void 0)return this.sourceCache[e].then(h=>h.clone());const a=r.images[e],o=self.URL||self.webkitURL;let l=a.uri||"",c=!1;if(a.bufferView!==void 0)l=n.getDependency("bufferView",a.bufferView).then(function(h){c=!0;const d=new Blob([h],{type:a.mimeType});return l=o.createObjectURL(d),l});else if(a.uri===void 0)throw new Error("THREE.GLTFLoader: Image "+e+" is missing URI and bufferView");const u=Promise.resolve(l).then(function(h){return new Promise(function(d,f){let g=d;t.isImageBitmapLoader===!0&&(g=function(v){const p=new wt(v);p.needsUpdate=!0,d(p)}),t.load(rr.resolveURL(h,s.path),g,void 0,f)})}).then(function(h){return c===!0&&o.revokeObjectURL(l),mn(h,a),h.userData.mimeType=a.mimeType||yg(a.uri),h}).catch(function(h){throw console.error("THREE.GLTFLoader: Couldn't load texture",l),h});return this.sourceCache[e]=u,u}assignTexture(e,t,n,r){const s=this;return this.getDependency("texture",n.index).then(function(a){if(!a)return null;if(n.texCoord!==void 0&&n.texCoord>0&&(a=a.clone(),a.channel=n.texCoord),s.extensions[We.KHR_TEXTURE_TRANSFORM]){const o=n.extensions!==void 0?n.extensions[We.KHR_TEXTURE_TRANSFORM]:void 0;if(o){const l=s.associations.get(a);a=s.extensions[We.KHR_TEXTURE_TRANSFORM].extendTexture(a,o),s.associations.set(a,l)}}return r!==void 0&&(a.colorSpace=r),e[t]=a,a})}assignFinalMaterial(e){const t=e.geometry;let n=e.material;const r=t.attributes.tangent===void 0,s=t.attributes.color!==void 0,a=t.attributes.normal===void 0;if(e.isPoints){const o="PointsMaterial:"+n.uuid;let l=this.cache.get(o);l||(l=new Do,rn.prototype.copy.call(l,n),l.color.copy(n.color),l.map=n.map,l.sizeAttenuation=!1,this.cache.add(o,l)),n=l}else if(e.isLine){const o="LineBasicMaterial:"+n.uuid;let l=this.cache.get(o);l||(l=new $n,rn.prototype.copy.call(l,n),l.color.copy(n.color),l.map=n.map,this.cache.add(o,l)),n=l}if(r||s||a){let o="ClonedMaterial:"+n.uuid+":";r&&(o+="derivative-tangents:"),s&&(o+="vertex-colors:"),a&&(o+="flat-shading:");let l=this.cache.get(o);l||(l=n.clone(),s&&(l.vertexColors=!0),a&&(l.flatShading=!0),r&&(l.normalScale&&(l.normalScale.y*=-1),l.clearcoatNormalScale&&(l.clearcoatNormalScale.y*=-1)),this.cache.add(o,l),this.associations.set(l,this.associations.get(n))),n=l}e.material=n}getMaterialType(){return ta}loadMaterial(e){const t=this,n=this.json,r=this.extensions,s=n.materials[e];let a;const o={},l=s.extensions||{},c=[];if(l[We.KHR_MATERIALS_UNLIT]){const h=r[We.KHR_MATERIALS_UNLIT];a=h.getMaterialType(),c.push(h.extendParams(o,s,t))}else{const h=s.pbrMetallicRoughness||{};if(o.color=new Te(1,1,1),o.opacity=1,Array.isArray(h.baseColorFactor)){const d=h.baseColorFactor;o.color.setRGB(d[0],d[1],d[2],Bt),o.opacity=d[3]}h.baseColorTexture!==void 0&&c.push(t.assignTexture(o,"map",h.baseColorTexture,Rt)),o.metalness=h.metallicFactor!==void 0?h.metallicFactor:1,o.roughness=h.roughnessFactor!==void 0?h.roughnessFactor:1,h.metallicRoughnessTexture!==void 0&&(c.push(t.assignTexture(o,"metalnessMap",h.metallicRoughnessTexture)),c.push(t.assignTexture(o,"roughnessMap",h.metallicRoughnessTexture))),a=this._invokeOne(function(d){return d.getMaterialType&&d.getMaterialType(e)}),c.push(Promise.all(this._invokeAll(function(d){return d.extendMaterialParams&&d.extendMaterialParams(e,o)})))}s.doubleSided===!0&&(o.side=2);const u=s.alphaMode||va.OPAQUE;if(u===va.BLEND?(o.transparent=!0,o.depthWrite=!1):(o.transparent=!1,u===va.MASK&&(o.alphaTest=s.alphaCutoff!==void 0?s.alphaCutoff:.5)),s.normalTexture!==void 0&&a!==An&&(c.push(t.assignTexture(o,"normalMap",s.normalTexture)),o.normalScale=new ke(1,1),s.normalTexture.scale!==void 0)){const h=s.normalTexture.scale;o.normalScale.set(h,h)}if(s.occlusionTexture!==void 0&&a!==An&&(c.push(t.assignTexture(o,"aoMap",s.occlusionTexture)),s.occlusionTexture.strength!==void 0&&(o.aoMapIntensity=s.occlusionTexture.strength)),s.emissiveFactor!==void 0&&a!==An){const h=s.emissiveFactor;o.emissive=new Te().setRGB(h[0],h[1],h[2],Bt)}return s.emissiveTexture!==void 0&&a!==An&&c.push(t.assignTexture(o,"emissiveMap",s.emissiveTexture,Rt)),Promise.all(c).then(function(){const h=new a(o);return s.name&&(h.name=s.name),mn(h,s),t.associations.set(h,{materials:e}),s.extensions&&Jn(r,h,s),h})}createUniqueName(e){const t=nt.sanitizeNodeName(e||"");return t in this.nodeNamesUsed?t+"_"+ ++this.nodeNamesUsed[t]:(this.nodeNamesUsed[t]=0,t)}loadGeometries(e){const t=this,n=this.extensions,r=this.primitiveCache;function s(o){return n[We.KHR_DRACO_MESH_COMPRESSION].decodePrimitive(o,t).then(function(l){return kl(l,o,t)})}const a=[];for(let o=0,l=e.length;o<l;o++){const c=e[o],u=Sg(c),h=r[u];if(h)a.push(h.promise);else{let d;c.extensions&&c.extensions[We.KHR_DRACO_MESH_COMPRESSION]?d=s(c):d=kl(new gt,c,t),r[u]={primitive:c,promise:d},a.push(d)}}return Promise.all(a)}loadMesh(e){const t=this,n=this.json,r=this.extensions,s=n.meshes[e],a=s.primitives,o=[];for(let l=0,c=a.length;l<c;l++){const u=a[l].material===void 0?vg(this.cache):this.getDependency("material",a[l].material);o.push(u)}return o.push(t.loadGeometries(a)),Promise.all(o).then(function(l){const c=l.slice(0,l.length-1),u=l[l.length-1],h=[];for(let f=0,g=u.length;f<g;f++){const v=u[f],p=a[f];let m;const E=c[f];if(p.mode===qt.TRIANGLES||p.mode===qt.TRIANGLE_STRIP||p.mode===qt.TRIANGLE_FAN||p.mode===void 0)m=s.isSkinnedMesh===!0?new bo(v,E):new Ut(v,E),m.isSkinnedMesh===!0&&m.normalizeSkinWeights(),p.mode===qt.TRIANGLE_STRIP?m.geometry=Il(m.geometry,1):p.mode===qt.TRIANGLE_FAN&&(m.geometry=Il(m.geometry,2));else if(p.mode===qt.LINES)m=new er(v,E);else if(p.mode===qt.LINE_STRIP)m=new zr(v,E);else if(p.mode===qt.LINE_LOOP)m=new ku(v,E);else if(p.mode===qt.POINTS)m=new Hu(v,E);else throw new Error("THREE.GLTFLoader: Primitive mode unsupported: "+p.mode);Object.keys(m.geometry.morphAttributes).length>0&&Mg(m,s),m.name=t.createUniqueName(s.name||"mesh_"+e),mn(m,s),p.extensions&&Jn(r,m,p),t.assignFinalMaterial(m),h.push(m)}for(let f=0,g=h.length;f<g;f++)t.associations.set(h[f],{meshes:e,primitives:f});if(h.length===1)return s.extensions&&Jn(r,h[0],s),h[0];const d=new kt;s.extensions&&Jn(r,d,s),t.associations.set(d,{meshes:e});for(let f=0,g=h.length;f<g;f++)d.add(h[f]);return d})}loadCamera(e){let t;const n=this.json.cameras[e],r=n[n.type];if(!r){console.warn("THREE.GLTFLoader: Missing camera parameters.");return}return n.type==="perspective"?t=new Ot(mt.radToDeg(r.yfov),r.aspectRatio||1,r.znear||1,r.zfar||2e6):n.type==="orthographic"&&(t=new jr(-r.xmag,r.xmag,r.ymag,-r.ymag,r.znear,r.zfar)),n.name&&(t.name=this.createUniqueName(n.name)),mn(t,n),Promise.resolve(t)}loadSkin(e){const t=this.json.skins[e],n=[];for(let r=0,s=t.joints.length;r<s;r++)n.push(this._loadNodeShallow(t.joints[r]));return t.inverseBindMatrices!==void 0?n.push(this.getDependency("accessor",t.inverseBindMatrices)):n.push(null),Promise.all(n).then(function(r){const s=r.pop(),a=r,o=[],l=[];for(let c=0,u=a.length;c<u;c++){const h=a[c];if(h){o.push(h);const d=new Ne;s!==null&&d.fromArray(s.array,c*16),l.push(d)}else console.warn('THREE.GLTFLoader: Joint "%s" could not be found.',t.joints[c])}return new xi(o,l)})}loadAnimation(e){const t=this.json,n=this,r=t.animations[e],s=r.name?r.name:"animation_"+e,a=[],o=[],l=[],c=[],u=[];for(let h=0,d=r.channels.length;h<d;h++){const f=r.channels[h],g=r.samplers[f.sampler],v=f.target,p=v.node,m=r.parameters!==void 0?r.parameters[g.input]:g.input,E=r.parameters!==void 0?r.parameters[g.output]:g.output;v.node!==void 0&&(a.push(this.getDependency("node",p)),o.push(this.getDependency("accessor",m)),l.push(this.getDependency("accessor",E)),c.push(g),u.push(v))}return Promise.all([Promise.all(a),Promise.all(o),Promise.all(l),Promise.all(c),Promise.all(u)]).then(function(h){const d=h[0],f=h[1],g=h[2],v=h[3],p=h[4],m=[];for(let R=0,M=d.length;R<M;R++){const T=d[R],y=f[R],w=g[R],x=v[R],b=p[R];if(T===void 0)continue;T.updateMatrix&&T.updateMatrix();const L=n._createAnimationTracks(T,y,w,x,b);if(L)for(let P=0;P<L.length;P++)m.push(L[P])}const E=new nh(s,void 0,m);return mn(E,r),E})}createNodeMesh(e){const t=this.json,n=this,r=t.nodes[e];return r.mesh===void 0?null:n.getDependency("mesh",r.mesh).then(function(s){const a=n._getNodeRef(n.meshCache,r.mesh,s);return r.weights!==void 0&&a.traverse(function(o){if(o.isMesh)for(let l=0,c=r.weights.length;l<c;l++)o.morphTargetInfluences[l]=r.weights[l]}),a})}loadNode(e){const t=this.json,n=this,r=t.nodes[e],s=n._loadNodeShallow(e),a=[],o=r.children||[];for(let c=0,u=o.length;c<u;c++)a.push(n.getDependency("node",o[c]));const l=r.skin===void 0?Promise.resolve(null):n.getDependency("skin",r.skin);return Promise.all([s,Promise.all(a),l]).then(function(c){const u=c[0],h=c[1],d=c[2];d!==null&&u.traverse(function(f){f.isSkinnedMesh&&f.bind(d,Tg)});for(let f=0,g=h.length;f<g;f++)u.add(h[f]);if(u.userData.pivot!==void 0&&h.length>0){const f=u.userData.pivot,g=h[0];u.pivot=new C().fromArray(f),u.position.x-=f[0],u.position.y-=f[1],u.position.z-=f[2],g.position.set(0,0,0),delete u.userData.pivot}return u})}_loadNodeShallow(e){const t=this.json,n=this.extensions,r=this;if(this.nodeCache[e]!==void 0)return this.nodeCache[e];const s=t.nodes[e],a=s.name?r.createUniqueName(s.name):"",o=[],l=r._invokeOne(function(c){return c.createNodeMesh&&c.createNodeMesh(e)});return l&&o.push(l),s.camera!==void 0&&o.push(r.getDependency("camera",s.camera).then(function(c){return r._getNodeRef(r.cameraCache,s.camera,c)})),r._invokeAll(function(c){return c.createNodeAttachment&&c.createNodeAttachment(e)}).forEach(function(c){o.push(c)}),this.nodeCache[e]=Promise.all(o).then(function(c){let u;if(s.isBone===!0?u=new Ao:c.length>1?u=new kt:c.length===1?u=c[0]:u=new st,u!==c[0])for(let h=0,d=c.length;h<d;h++)u.add(c[h]);if(s.name&&(u.userData.name=s.name,u.name=a),mn(u,s),s.extensions&&Jn(n,u,s),s.matrix!==void 0){const h=new Ne;h.fromArray(s.matrix),u.applyMatrix4(h)}else s.translation!==void 0&&u.position.fromArray(s.translation),s.rotation!==void 0&&u.quaternion.fromArray(s.rotation),s.scale!==void 0&&u.scale.fromArray(s.scale);if(!r.associations.has(u))r.associations.set(u,{});else if(s.mesh!==void 0&&r.meshCache.refs[s.mesh]>1){const h=r.associations.get(u);r.associations.set(u,{...h})}return r.associations.get(u).nodes=e,u}),this.nodeCache[e]}loadScene(e){const t=this.extensions,n=this.json.scenes[e],r=this,s=new kt;n.name&&(s.name=r.createUniqueName(n.name)),mn(s,n),n.extensions&&Jn(t,s,n);const a=n.nodes||[],o=[];for(let l=0,c=a.length;l<c;l++)o.push(r.getDependency("node",a[l]));return Promise.all(o).then(function(l){for(let u=0,h=l.length;u<h;u++){const d=l[u];d.parent!==null?s.add(Xm(d)):s.add(d)}const c=u=>{const h=new Map;for(const[d,f]of r.associations)(d instanceof rn||d instanceof wt)&&h.set(d,f);return u.traverse(d=>{const f=r.associations.get(d);f!=null&&h.set(d,f)}),h};return r.associations=c(s),s})}_createAnimationTracks(e,t,n,r,s){const a=[],o=e.name?e.name:e.uuid,l=[];function c(f){f.morphTargetInfluences&&l.push(f.name?f.name:f.uuid)}Fn[s.path]===Fn.weights?(c(e),e.isGroup&&e.children.forEach(c)):l.push(o);let u;switch(Fn[s.path]){case Fn.weights:u=nr;break;case Fn.rotation:u=ir;break;case Fn.translation:case Fn.scale:u=$r;break;default:switch(n.itemSize){case 1:u=nr;break;case 2:case 3:default:u=$r;break}break}const h=r.interpolation!==void 0?_g[r.interpolation]:2301,d=this._getArrayFromAccessor(n);for(let f=0,g=l.length;f<g;f++){const v=new u(l[f]+"."+Fn[s.path],t.array,d,h);r.interpolation==="CUBICSPLINE"&&this._createCubicSplineTrackInterpolant(v),a.push(v)}return a}_getArrayFromAccessor(e){let t=e.array;if(e.normalized){const n=Ma(t.constructor),r=new Float32Array(t.length);for(let s=0,a=t.length;s<a;s++)r[s]=t[s]*n;t=r}return t}_createCubicSplineTrackInterpolant(e){e.createInterpolant=function(n){const r=this instanceof ir?gg:Ol;return new r(this.times,this.values,this.getValueSize()/3,n)},e.createInterpolant.isInterpolantFactoryMethodGLTFCubicSpline=!0}}function bg(i,e,t){const n=e.attributes,r=new cn;if(n.POSITION!==void 0){const o=t.json.accessors[n.POSITION],l=o.min,c=o.max;if(l!==void 0&&c!==void 0){if(r.set(new C(l[0],l[1],l[2]),new C(c[0],c[1],c[2])),o.normalized){const u=Ma(Ii[o.componentType]);r.min.multiplyScalar(u),r.max.multiplyScalar(u)}}else{console.warn("THREE.GLTFLoader: Missing min/max properties for accessor POSITION.");return}}else return;const s=e.targets;if(s!==void 0){const o=new C,l=new C;for(let c=0,u=s.length;c<u;c++){const h=s[c];if(h.POSITION!==void 0){const d=t.json.accessors[h.POSITION],f=d.min,g=d.max;if(f!==void 0&&g!==void 0){if(l.setX(Math.max(Math.abs(f[0]),Math.abs(g[0]))),l.setY(Math.max(Math.abs(f[1]),Math.abs(g[1]))),l.setZ(Math.max(Math.abs(f[2]),Math.abs(g[2]))),d.normalized){const v=Ma(Ii[d.componentType]);l.multiplyScalar(v)}o.max(l)}else console.warn("THREE.GLTFLoader: Missing min/max properties for accessor POSITION.")}}r.expandByVector(o)}i.boundingBox=r;const a=new un;r.getCenter(a.center),a.radius=r.min.distanceTo(r.max)/2,i.boundingSphere=a}function kl(i,e,t){const n=e.attributes,r=[];function s(a,o){return t.getDependency("accessor",a).then(function(l){i.setAttribute(o,l)})}for(const a in n){const o=_a[a]||a.toLowerCase();o in i.attributes||r.push(s(n[a],o))}if(e.indices!==void 0&&!i.index){const a=t.getDependency("accessor",e.indices).then(function(o){i.setIndex(o)});r.push(a)}return Ye.workingColorSpace!==Bt&&"COLOR_0"in n&&console.warn(`THREE.GLTFLoader: Converting vertex colors from "srgb-linear" to "${Ye.workingColorSpace}" not supported.`),mn(i,e),bg(i,e,t),Promise.all(r).then(function(){return e.targets!==void 0?xg(i,e.targets,t):i})}/*!
 ...
 * https://github.com/pixiv/three-vrm/blob/release/LICENSE
 */const ni=document.getElementById("nanako3DCanvas"),ii=document.getElementById("nanakoAvatar"),on=document.getElementById("nanako3DStatus");if(ni&&ii){let w=function(H,Z){try{s?.expressionManager?.setValue(H,Math.max(0,Math.min(1,Z)))}catch{}},x=function(H,Z){const j=Math.max(0,Math.min(1,Z));for(const te of f){const ne=te.morphTargetDictionary?.[H];ne!==void 0&&te.morphTargetInfluences?.[ne]!==void 0&&(te.morphTargetInfluences[ne]=j)}},b=function(H){if(!s?.expressionManager)return;for(const Ee of M)w(Ee,0);for(const Ee of T)x(Ee,0);const Z=String(H.emotion||"neutral").toLowerCase(),j=y[Z];j?.brow&&x(j.brow,j.strength),j?.eye&&x(j.eye,j.strength);const te=String(H.eyes||"open").toLowerCase();te==="closed"||te==="close"?w("blink",1):te==="half"?w("blink",.46):te==="wink"&&w("blinkRight",1);const ne=String(H.mouth||"closed").toLowerCase();ne==="closed"||ne==="close"||ne==="none"?x("Fcl_MTH_Close",1):ne==="small"?w("ih",.34):ne==="medium"||ne==="half"?w("aa",.48):ne==="wide"||ne==="open"||ne==="full"?w("aa",.82):ne==="round"?w("ou",.78):ne==="teeth"&&w("ee",.38)},L=function(H){if(!H)return;u={...u,...H},c=String(u.emotion||"neutral").toLowerCase();const Z=R[c]?.[1]||"neutral";g=p[Z]||p.neutral,b(u)},P=function(){for(const H of["hips","spine","chest","neck","head","leftShoulder","rightShoulder","leftUpperArm","rightUpperArm","leftLowerArm","rightLowerArm","leftHand","rightHand"]){const Z=s.humanoid?.getNormalizedBoneNode(H);Z&&(h.set(H,Z.quaternion.clone()),d.set(H,Z.position.clone()))}L(window.__nanakoPending3DFrame||u)},U=function(){s.scene.updateMatrixWorld(!0);const H=new cn().setFromObject(s.scene),Z=H.getSize(new C),j=H.getCenter(new C),ne=s.humanoid?.getNormalizedBoneNode("hips")?.getWorldPosition(new C),Ee=Number.isFinite(ne?.y)?ne.y:H.max.y-Z.y*.54,De=H.max.y,Oe=Math.max(.55,De-Ee),K=Ee-Oe*.12,re=De+Oe*.07,ie=re-K,Ce=(re+K)*.5,Ie=mt.degToRad(t.fov),be=ie/(2*Math.tan(Ie/2)),Ve=Math.min(Z.x,Oe*.92)/(2*Math.tan(Ie/2)*t.aspect),$e=Math.max(be,Ve)*1.02;t.position.set(j.x,Ce,H.max.z+$e),t.lookAt(j.x,Ce,j.z)},q=function(H=!1){const Z=Math.max(1,ni.clientWidth),j=Math.max(1,ni.clientHeight);!H&&Z===a&&j===o||(a=Z,o=j,i.setSize(Z,j,!1),t.aspect=Z/j,t.updateProjectionMatrix(),s&&U())},$=function(H,Z){const j=1-Math.exp(-Z*8),te=H/1e3;for(const[De,Oe]of h){const K=s.humanoid?.getNormalizedBoneNode(De);if(!K)continue;let re=[...g[De]||[0,0,0]];if(String(u.action||"idle").toLowerCase()==="congratulating"&&m[De]&&E[De]){const Xe=Math.max(0,Math.min(1,Number(u.clap_amount||0)));re=m[De].map((ut,ft)=>ut+(E[De][ft]-ut)*Xe)}const Ce=Number(u.head_pitch||0),Ie=Number(u.head_yaw||0);De==="head"?(re[0]+=Ce*.72,re[1]+=Ie*.72):De==="neck"&&(re[0]+=Ce*.28,re[1]+=Ie*.28);const be=De==="chest"?Math.sin(te*1.55)*.012:0,ot=De==="head"?Math.sin(te*.48)*.012:0,Ve=De==="head"&&c==="laughing"?Number(u.head_translate_y||0)*.002:0,$e=new Be().setFromEuler(new Wt(re[0]+be,re[1],re[2]+ot,"XYZ"));K.quaternion.slerp(Oe.clone().multiply($e),j);const Ke=d.get(De);Ke&&(K.position.copy(Ke),De==="head"&&(K.position.y+=Ve),(De==="leftShoulder"||De==="rightShoulder")&&Number(u.shoulder_lift||0)&&(K.position.y+=Number(u.shoulder_lift||0)))}const ne=s.humanoid?.getNormalizedBoneNode("hips"),Ee=d.get("hips");ne&&Ee&&(ne.position.y=Ee.y+Math.sin(te*1.5)*.004)},O=function(H){requestAnimationFrame(O);const Z=Math.min(.05,Math.max(0,(H-v)/1e3));v=H,l&&(q(),s&&($(H,Z),s.update(Z)),i.render(e,t))};const i=new Wm({canvas:ni,antialias:!0,alpha:!0,powerPreference:"high-performance"});i.setPixelRatio(Math.min(window.devicePixelRatio||1,1.5)),i.outputColorSpace=Rt,i.setClearColor(0,0);const e=new Ru,t=new Ot(28,1,.1,20);e.add(new ch(16313087,3154236,1.45));const n=new ra(16777215,1.35);n.position.set(1.8,2.8,2.5),e.add(n);const r=new ra(12937727,.55);r.position.set(-2,2,-1.5),e.add(r);let s=null,a=0,o=0,l=!0,c="neutral",u={emotion:"neutral",action:"idle",eyes:"open",mouth:"closed"};const h=new Map,d=new Map,f=[];let g={},v=performance.now();const p={neutral:{leftUpperArm:[.08,.02,-1.3],rightUpperArm:[.08,-.02,1.3],leftLowerArm:[.02,.04,-.12],rightLowerArm:[.02,-.04,.12]},happy:{leftUpperArm:[-.12,.04,-1.03],rightUpperArm:[-.12,-.04,1.03],leftLowerArm:[-.34,.12,-.48],rightLowerArm:[-.34,-.12,.48],chest:[-.035,0,0],head:[-.05,0,.035]},laughing:{leftUpperArm:[-.42,.12,-.54],rightUpperArm:[-.42,-.12,.54],leftLowerArm:[-.94,.18,-.66],rightLowerArm:[-.94,-.18,.66],leftHand:[.02,.12,-.08],rightHand:[.02,-.12,.08],chest:[-.055,0,0],head:[-.055,0,0]},sad:{leftUpperArm:[.16,.09,-1.38],rightUpperArm:[.16,-.09,1.38],leftLowerArm:[.06,.05,-.18],rightLowerArm:[.06,-.05,.18],chest:[.13,0,0],neck:[.1,0,0],head:[.15,0,-.025]},angry:{leftUpperArm:[.03,.18,-1.12],rightUpperArm:[.03,-.18,1.12],leftLowerArm:[-.1,.3,-.72],rightLowerArm:[-.1,-.3,.72],chest:[-.025,0,0]},surprised:{leftUpperArm:[-.32,.1,-.75],rightUpperArm:[-.32,-.1,.75],leftLowerArm:[-.72,.18,-.82],rightLowerArm:[-.72,-.18,.82],chest:[-.06,0,0],head:[-.08,0,0]},relaxed:{leftUpperArm:[.12,.02,-1.36],rightUpperArm:[.12,-.02,1.36],leftLowerArm:[.04,.05,-.08],rightLowerArm:[.04,-.05,.08],chest:[.025,0,0],head:[-.015,0,-.035]},confused:{leftUpperArm:[.08,.05,-1.22],rightUpperArm:[-.1,-.12,.88],leftLowerArm:[.04,.06,-.15],rightLowerArm:[-.48,-.18,.72],head:[0,0,-.12]},embarrassed:{leftUpperArm:[-.08,.08,-1.02],rightUpperArm:[-.08,-.08,1.02],leftLowerArm:[-.45,.16,-.62],rightLowerArm:[-.45,-.16,.62],head:[.06,0,-.06]},thinking:{leftUpperArm:[.1,.04,-1.34],rightUpperArm:[-.12,-.12,.92],leftLowerArm:[.02,.04,-.1],rightLowerArm:[-.58,-.16,.78],head:[0,0,-.1]},disgust:{leftUpperArm:[.1,.08,-1.25],rightUpperArm:[.1,-.08,1.25],leftLowerArm:[.04,.05,-.12],rightLowerArm:[.04,-.05,.12],chest:[.04,0,0],head:[.03,0,.08]}},m={leftUpperArm:[-.34,.1,-.82],rightUpperArm:[-.34,-.1,.82],leftLowerArm:[-.76,.1,-.58],rightLowerArm:[-.76,-.1,.58],leftHand:[.02,.1,-.1],rightHand:[.02,-.1,.1]},E={leftUpperArm:[-.48,.22,-.56],rightUpperArm:[-.48,-.22,.56],leftLowerArm:[-1.05,.2,-.86],rightLowerArm:[-1.05,-.2,.86],leftHand:[.02,.28,-.22],rightHand:[.02,-.28,.22]},R={neutral:["neutral","neutral"],happy:["neutral","happy"],laughing:["neutral","laughing"],cheeky:["neutral","happy"],angry:["neutral","angry"],disgust:["neutral","disgust"],sad:["neutral","sad"],scared:["neutral","surprised"],embarrassed:["neutral","embarrassed"],thinking:["neutral","thinking"],confused:["neutral","confused"]},M=["happy","angry","sad","relaxed","surprised","aa","ih","ou","ee","oh","blink","blinkLeft","blinkRight"],T=["Fcl_BRW_Angry","Fcl_BRW_Fun","Fcl_BRW_Joy","Fcl_BRW_Sorrow","Fcl_BRW_Surprised","Fcl_EYE_Angry","Fcl_EYE_Fun","Fcl_EYE_Sorrow","Fcl_EYE_Surprised","Fcl_MTH_Close"],y={happy:{brow:"Fcl_BRW_Joy",strength:.78},laughing:{brow:"Fcl_BRW_Joy",strength:.92},cheeky:{brow:"Fcl_BRW_Joy",strength:.68},angry:{brow:"Fcl_BRW_Angry",eye:"Fcl_EYE_Angry",strength:.86},disgust:{brow:"Fcl_BRW_Angry",eye:"Fcl_EYE_Angry",strength:.58},sad:{brow:"Fcl_BRW_Sorrow",eye:"Fcl_EYE_Sorrow",strength:.82},scared:{brow:"Fcl_BRW_Surprised",eye:"Fcl_EYE_Surprised",strength:.88},embarrassed:{brow:"Fcl_BRW_Fun",strength:.5},thinking:{brow:"Fcl_BRW_Fun",eye:"Fcl_EYE_Fun",strength:.42},confused:{brow:"Fcl_BRW_Surprised",strength:.44}},W={applyFrame:L,ready:!1,rendererContract:"nanako-vrm-1.0-python-plan"};window.nanako3DRenderer=W,window.dispatchEvent(new CustomEvent("nanako3d-api-ready")),ni.addEventListener("webglcontextlost",H=>{H.preventDefault(),ii.classList.remove("vrm-ready"),on&&(on.hidden=!1,on.textContent="3D paused — restoring…")}),ni.addEventListener("webglcontextrestored",()=>location.reload()),document.addEventListener("visibilitychange",()=>{l=document.visibilityState==="visible",v=performance.now()});const G=(H,Z=!1)=>{const j=new qm;j.register(te=>new f0(te)),j.load(H,te=>{if(s=te.userData.vrm,!s)throw new Error("The model loaded but did not contain VRM data.");try{Bn.removeUnnecessaryVertices(te.scene)}catch(Ee){console.warn("[Nanako 3D] vertex optimisation skipped",Ee)}try{Bn.combineSkeletons(te.scene)}catch(Ee){console.warn("[Nanako 3D] skeleton optimisation skipped",Ee)}s.scene.traverse(Ee=>{Ee.frustumCulled=!1,Ee.isMesh&&Ee.morphTargetDictionary&&Ee.morphTargetInfluences&&f.push(Ee)}),e.add(s.scene),q(!0),P(),U(),W.ready=!0,ii.classList.remove("vrm-loading"),ii.classList.add("vrm-ready"),on&&(on.hidden=!0);const ne=document.getElementById("startupEnterButton");ne&&(ne.disabled=!1,ne.textContent="Enter"),window.dispatchEvent(new CustomEvent("nanako3d-ready"))},te=>{const ne=Number(te?.total||0),Ee=Number(te?.loaded||0),De=ne>0?Math.max(1,Math.min(99,Math.round(Ee/ne*100))):0;on&&(on.hidden=!1,on.textContent=De?`Loading Nanako 3D… ${De}%`:"Loading Nanako 3D…");const Oe=document.getElementById("startupEnterButton");Oe&&(Oe.disabled=!0,Oe.textContent=De?`Loading Nanako 3D… ${De}%`:"Loading Nanako 3D…")},te=>{if(!Z){const Ee=H.includes("?")?"&":"?";G(`${H}${Ee}reload=${Date.now()}`,!0);return}console.error("[Nanako 3D] VRM load failed",te),ii.classList.remove("vrm-loading"),ii.classList.remove("vrm-ready"),ii.classList.add("vrm-error"),on&&(on.hidden=!1,on.textContent="Nanako 3D could not load. Check that nanako.glb was uploaded.");const ne=document.getElementById("startupEnterButton");ne&&(ne.disabled=!0,ne.textContent="3D load failed — reload"),window.dispatchEvent(new CustomEvent("nanako3d-error"))})};G(ni.dataset.modelUrl||"./static/models/nanako.glb"),requestAnimationFrame(O)}})();
